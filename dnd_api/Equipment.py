entries = ['abacus', 'acid_vial', 'alchemists_fire_flask', 'alchemists_supplies', 'alms_box', 'amulet', 'animal_feed_1_day', 'antitoxin_vial', 'arrow', 'backpack', 'bagpipes', 'ball_bearings_bag_of_1000', 'barding_breastplate', 'barding_chain_mail', 'barding_chain_shirt', 'barding_half_plate', 'barding_hide', 'barding_leather', 'barding_padded', 'barding_plate', 'barding_ring_mail', 'barding_scale_mail', 'barding_splint', 'barding_studded_leather', 'barrel', 'basket', 'battleaxe', 'bedroll', 'bell', 'bit_and_bridle', 'blanket', 'block_and_tackle', 'block_of_incense', 'blowgun_needle', 'blowgun', 'book', 'bottle_glass', 'breastplate', 'brewers_supplies', 'bucket', 'burglars_pack', 'calligraphers_supplies', 'caltrops', 'camel', 'candle', 'carpenters_tools', 'carriage', 'cart', 'cartographers_tools', 'case_crossbow_bolt', 'case_map_or_scroll', 'censer', 'chain_10_feet', 'chain_mail', 'chain_shirt', 'chalk_1_piece', 'chariot', 'chest', 'climbers_kit', 'clothes_common', 'clothes_costume', 'clothes_fine', 'clothes_travelers', 'club', 'cobblers_tools', 'component_pouch', 'cooks_utensils', 'crossbow_bolt', 'crossbow_hand', 'crossbow_heavy', 'crossbow_light', 'crowbar', 'crystal', 'dagger', 'dart', 'dice_set', 'diplomats_pack', 'disguise_kit', 'donkey', 'drum', 'dulcimer', 'dungeoneers_pack', 'elephant', 'emblem', 'entertainers_pack', 'explorers_pack', 'fishing_tackle', 'flail', 'flask_or_tankard', 'flute', 'forgery_kit', 'galley', 'glaive', 'glassblowers_tools', 'grappling_hook', 'greataxe', 'greatclub', 'greatsword', 'halberd', 'half_plate_armor', 'hammer_sledge', 'hammer', 'handaxe', 'healers_kit', 'herbalism_kit', 'hide_armor', 'holy_water_flask', 'horn', 'horse_draft', 'horse_riding', 'hourglass', 'hunting_trap', 'ink_1_ounce_bottle', 'ink_pen', 'javelin', 'jewelers_tools', 'jug_or_pitcher', 'keelboat', 'ladder_10_foot', 'lamp', 'lance', 'lantern_bullseye', 'lantern_hooded', 'leather_armor', 'leatherworkers_tools', 'light_hammer', 'little_bag_of_sand', 'lock', 'longbow', 'longship', 'longsword', 'lute', 'lyre', 'mace', 'magnifying_glass', 'manacles', 'masons_tools', 'mastiff', 'maul', 'mess_kit', 'mirror_steel', 'morningstar', 'mule', 'navigators_tools', 'net', 'oil_flask', 'orb', 'padded_armor', 'painters_supplies', 'pan_flute', 'paper_one_sheet', 'parchment_one_sheet', 'perfume_vial', 'pick_miners', 'pike', 'piton', 'plate_armor', 'playing_card_set', 'poison_basic_vial', 'poisoners_kit', 'pole_10_foot', 'pony', 'pot_iron', 'potters_tools', 'pouch', 'priests_pack', 'quarterstaff', 'quiver', 'ram_portable', 'rapier', 'rations_1_day', 'reliquary', 'ring_mail', 'robes', 'rod', 'rope_hempen_50_feet', 'rope_silk_50_feet', 'rowboat', 'sack', 'saddle_exotic', 'saddle_military', 'saddle_pack', 'saddle_riding', 'saddlebags', 'sailing_ship', 'scale_mail', 'scale_merchants', 'scholars_pack', 'scimitar', 'sealing_wax', 'shawm', 'shield', 'shortbow', 'shortsword', 'shovel', 'sickle', 'signal_whistle', 'signet_ring', 'sled', 'sling_bullet', 'sling', 'small_knife', 'smiths_tools', 'soap', 'spear', 'spellbook', 'spike_iron', 'splint_armor', 'sprig_of_mistletoe', 'spyglass', 'stabling_1_day', 'staff', 'string_10_feet', 'studded_leather_armor', 'tent_two_person', 'thieves_tools', 'tinderbox', 'tinkers_tools', 'torch', 'totem', 'trident', 'vestments', 'vial', 'viol', 'wagon', 'wand', 'war_pick', 'warhammer', 'warhorse', 'warship', 'waterskin', 'weavers_tools', 'whetstone', 'whip', 'woodcarvers_tools', 'wooden_staff', 'yew_wand']
attributes = ['desc', 'special', 'index', 'name', 'equipment_category', 'gear_category', 'cost', 'weight', 'url', 'contents', 'properties', 'tool_category', 'vehicle_category', 'quantity', 'weapon_category', 'weapon_range', 'category_range', 'damage', 'range', 'two_handed_damage', 'armor_category', 'armor_class', 'str_minimum', 'stealth_disadvantage', 'speed', 'capacity', 'throw_range']
class abacus():
    desc = []
    special = []
    index = 'abacus'
...
class alchemists_fire_flask():
    ...
    contents = []
    properties = []
class alchemists_supplies():
    special = []
    index = 'alchemists-supplies'
    name = 'Alchemist\'s Supplies'
    equipment_category = {'index': 'tools', 'name': 'Tools', 'url': '/api/equipment-categories/tools'}
...
class amulet():
    ...
    name = 'Amulet'
    equipment_category = {'index': 'adventuring-gear', 'name': 'Adventuring Gear', 'url': '/api/equipment-categories/adventuring-gear'}
    gear_category = {'index': 'holy-symbols', 'name': 'Holy Symbols', 'url': '/api/equipment-categories/holy-symbols'}
    ...
    contents = []
    properties = []
class animal_feed_1_day():
    desc = []
    special = []
    index = 'animal-feed-1-day'
    name = 'Animal Feed (1 day)'
    equipment_category = {'index': 'mounts-and-vehicles', 'name': 'Mounts and Vehicles', 'url': '/api/equipment-categories/mounts-and-vehicles'}
...
class arrow():
    ...
    name = 'Arrow'
    equipment_category = {'index': 'adventuring-gear', 'name': 'Adventuring Gear', 'url': '/api/equipment-categories/adventuring-gear'}
    gear_category = {'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/equipment-categories/ammunition'}
    quantity = 20
...
class bagpipes():
    ...
    contents = []
    properties = []
class ball_bearings_bag_of_1000():
    special = []
...
class blowgun():
    ...
    cost = {'quantity': 10, 'unit': 'gp'}
    damage = {'damage_dice': '1', 'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}}
    range = {'normal': 25, 'long': 100}
    weight = 1
    properties = [{'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/weapon-properties/ammunition'}, {'index': 'loading', 'name': 'Loading', 'url': '/api/weapon-properties/loading'}]
...
class burglars_pack():
    ...
    contents = [{'item': {'index': 'backpack', 'name': 'Backpack', 'url': '/api/equipment/backpack'}, 'quantity': 1}, {'item': {'index': 'ball-bearings-bag-of-1000', 'name': 'Ball bearings (bag of 1,000)', 'url': '/api/equipment/ball-bearings-bag-of-1000'}, 'quantity': 1}, {'item': {'index': 'string-10-feet', 'name': 'String (10 feet)', 'url': '/api/equipment/string-10-feet'}, 'quantity': 1}, {'item': {'index': 'bell', 'name': 'Bell', 'url': '/api/equipment/bell'}, 'quantity': 1}, {'item': {'index': 'candle', 'name': 'Candle', 'url': '/api/equipment/candle'}, 'quantity': 5}, {'item': {'index': 'crowbar', 'name': 'Crowbar', 'url': '/api/equipment/crowbar'}, 'quantity': 1}, {'item': {'index': 'hammer', 'name': 'Hammer', 'url': '/api/equipment/hammer'}, 'quantity': 1}, {'item': {'index': 'piton', 'name': 'Piton', 'url': '/api/equipment/piton'}, 'quantity': 10}, {'item': {'index': 'lantern-hooded', 'name': 'Lantern, hooded', 'url': '/api/equipment/lantern-hooded'}, 'quantity': 1}, {'item': {'index': 'oil-flask', 'name': 'Oil (flask)', 'url': '/api/equipment/oil-flask'}, 'quantity': 2}, {'item': {'index': 'rations-1-day', 'name': 'Rations (1 day)', 'url': '/api/equipment/rations-1-day'}, 'quantity': 5}, {'item': {'index': 'tinderbox', 'name': 'Tinderbox', 'url': '/api/equipment/tinderbox'}, 'quantity': 1}, {'item': {'index': 'waterskin', 'name': 'Waterskin', 'url': '/api/equipment/waterskin'}, 'quantity': 1}, {'item': {'index': 'rope-hempen-50-feet', 'name': 'Rope, hempen (50 feet)', 'url': '/api/equipment/rope-hempen-50-feet'}, 'quantity': 1}]
    url = '/api/equipment/burglars-pack'
    properties = []
class calligraphers_supplies():
    special = []
...
class climbers_kit():
    ...
    name = 'Climber\'s Kit'
    equipment_category = {'index': 'adventuring-gear', 'name': 'Adventuring Gear', 'url': '/api/equipment-categories/adventuring-gear'}
    gear_category = {'index': 'kits', 'name': 'Kits', 'url': '/api/equipment-categories/kits'}
    cost = {'quantity': 25, 'unit': 'gp'}
    weight = 12
...
class club():
    ...
    damage = {'damage_dice': '1d4', 'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}}
    range = {'normal': 5}
    weight = 2
    properties = [{'index': 'light', 'name': 'Light', 'url': '/api/weapon-properties/light'}, {'index': 'monk', 'name': 'Monk', 'url': '/api/weapon-properties/monk'}]
    url = '/api/equipment/club'
    contents = []
class cobblers_tools():
    special = []
...
class crossbow_hand():
    ...
    category_range = 'Martial Ranged'
    cost = {'quantity': 75, 'unit': 'gp'}
    damage = {'damage_dice': '1d6', 'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}}
    range = {'normal': 30, 'long': 120}
    weight = 3
    properties = [{'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/weapon-properties/ammunition'}, {'index': 'light', 'name': 'Light', 'url': '/api/weapon-properties/light'}, {'index': 'loading', 'name': 'Loading', 'url': '/api/weapon-properties/loading'}]
    url = '/api/equipment/crossbow-hand'
    contents = []
class crossbow_heavy():
    desc = []
    special = []
    ...
    category_range = 'Martial Ranged'
    cost = {'quantity': 50, 'unit': 'gp'}
    damage = {'damage_dice': '1d10', 'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}}
    range = {'normal': 100, 'long': 400}
    weight = 18
    properties = [{'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/weapon-properties/ammunition'}, {'index': 'heavy', 'name': 'Heavy', 'url': '/api/weapon-properties/heavy'}, {'index': 'loading', 'name': 'Loading', 'url': '/api/weapon-properties/loading'}, {'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
    url = '/api/equipment/crossbow-heavy'
    contents = []
class crossbow_light():
    desc = []
    special = []
    ...
    cost = {'quantity': 25, 'unit': 'gp'}
    damage = {'damage_dice': '1d8', 'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}}
    range = {'normal': 80, 'long': 320}
    weight = 5
    properties = [{'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/weapon-properties/ammunition'}, {'index': 'loading', 'name': 'Loading', 'url': '/api/weapon-properties/loading'}, {'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
...
class crystal():
    ...
    name = 'Crystal'
    equipment_category = {'index': 'adventuring-gear', 'name': 'Adventuring Gear', 'url': '/api/equipment-categories/adventuring-gear'}
    gear_category = {'index': 'arcane-foci', 'name': 'Arcane Foci', 'url': '/api/equipment-categories/arcane-foci'}
    cost = {'quantity': 10, 'unit': 'gp'}
    weight = 1
...
class dagger():
    ...
    category_range = 'Simple Melee'
    cost = {'quantity': 2, 'unit': 'gp'}
    damage = {'damage_dice': '1d4', 'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}}
    range = {'normal': 5}
    weight = 1
    properties = [{'index': 'finesse', 'name': 'Finesse', 'url': '/api/weapon-properties/finesse'}, {'index': 'light', 'name': 'Light', 'url': '/api/weapon-properties/light'}, {'index': 'thrown', 'name': 'Thrown', 'url': '/api/weapon-properties/thrown'}, {'index': 'monk', 'name': 'Monk', 'url': '/api/weapon-properties/monk'}]
...
class dart():
    ...
    weight = 0.25
    properties = [{'index': 'finesse', 'name': 'Finesse', 'url': '/api/weapon-properties/finesse'}, {'index': 'thrown', 'name': 'Thrown', 'url': '/api/weapon-properties/thrown'}]
    throw_range = {'normal': 20, 'long': 60}
...
class diplomats_pack():
    ...
    contents = [{'item': {'index': 'chest', 'name': 'Chest', 'url': '/api/equipment/chest'}, 'quantity': 1}, {'item': {'index': 'case-map-or-scroll', 'name': 'Case, map or scroll', 'url': '/api/equipment/case-map-or-scroll'}, 'quantity': 2}, {'item': {'index': 'clothes-fine', 'name': 'Clothes, fine', 'url': '/api/equipment/clothes-fine'}, 'quantity': 1}, {'item': {'index': 'ink-1-ounce-bottle', 'name': 'Ink (1 ounce bottle)', 'url': '/api/equipment/ink-1-ounce-bottle'}, 'quantity': 1}, {'item': {'index': 'ink-pen', 'name': 'Ink pen', 'url': '/api/equipment/ink-pen'}, 'quantity': 1}, {'item': {'index': 'lamp', 'name': 'Lamp', 'url': '/api/equipment/lamp'}, 'quantity': 1}, {'item': {'index': 'oil-flask', 'name': 'Oil (flask)', 'url': '/api/equipment/oil-flask'}, 'quantity': 2}, {'item': {'index': 'paper-one-sheet', 'name': 'Paper (one sheet)', 'url': '/api/equipment/paper-one-sheet'}, 'quantity': 5}, {'item': {'index': 'perfume-vial', 'name': 'Perfume (vial)', 'url': '/api/equipment/perfume-vial'}, 'quantity': 1}, {'item': {'index': 'sealing-wax', 'name': 'Sealing wax', 'url': '/api/equipment/sealing-wax'}, 'quantity': 1}, {'item': {'index': 'soap', 'name': 'Soap', 'url': '/api/equipment/soap'}, 'quantity': 1}]
...
class donkey():
    ...
    vehicle_category = 'Mounts and Other Animals'
    cost = {'quantity': 8, 'unit': 'gp'}
    speed = {'quantity': 40, 'unit': 'ft/round'}
    capacity = '420 lb.'
...
class dungeoneers_pack():
    ...
    gear_category = {'index': 'equipment-packs', 'name': 'Equipment Packs', 'url': '/api/equipment-categories/equipment-packs'}
    cost = {'quantity': 12, 'unit': 'gp'}
    contents = [{'item': {'index': 'backpack', 'name': 'Backpack', 'url': '/api/equipment/backpack'}, 'quantity': 1}, {'item': {'index': 'crowbar', 'name': 'Crowbar', 'url': '/api/equipment/crowbar'}, 'quantity': 1}, {'item': {'index': 'hammer', 'name': 'Hammer', 'url': '/api/equipment/hammer'}, 'quantity': 1}, {'item': {'index': 'piton', 'name': 'Piton', 'url': '/api/equipment/piton'}, 'quantity': 10}, {'item': {'index': 'torch', 'name': 'Torch', 'url': '/api/equipment/torch'}, 'quantity': 10}, {'item': {'index': 'tinderbox', 'name': 'Tinderbox', 'url': '/api/equipment/tinderbox'}, 'quantity': 1}, {'item': {'index': 'rations-1-day', 'name': 'Rations (1 day)', 'url': '/api/equipment/rations-1-day'}, 'quantity': 10}, {'item': {'index': 'waterskin', 'name': 'Waterskin', 'url': '/api/equipment/waterskin'}, 'quantity': 1}, {'item': {'index': 'rope-hempen-50-feet', 'name': 'Rope, hempen (50 feet)', 'url': '/api/equipment/rope-hempen-50-feet'}, 'quantity': 1}]
...
class entertainers_pack():
    ...
    gear_category = {'index': 'equipment-packs', 'name': 'Equipment Packs', 'url': '/api/equipment-categories/equipment-packs'}
    cost = {'quantity': 40, 'unit': 'gp'}
    contents = [{'item': {'index': 'backpack', 'name': 'Backpack', 'url': '/api/equipment/backpack'}, 'quantity': 1}, {'item': {'index': 'bedroll', 'name': 'Bedroll', 'url': '/api/equipment/bedroll'}, 'quantity': 1}, {'item': {'index': 'clothes-costume', 'name': 'Clothes, costume', 'url': '/api/equipment/clothes-costume'}, 'quantity': 2}, {'item': {'index': 'candle', 'name': 'Candle', 'url': '/api/equipment/candle'}, 'quantity': 5}, {'item': {'index': 'rations-1-day', 'name': 'Rations (1 day)', 'url': '/api/equipment/rations-1-day'}, 'quantity': 5}, {'item': {'index': 'waterskin', 'name': 'Waterskin', 'url': '/api/equipment/waterskin'}, 'quantity': 1}, {'item': {'index': 'disguise-kit', 'name': 'Disguise Kit', 'url': '/api/equipment/disguise-kit'}, 'quantity': 1}]
    url = '/api/equipment/entertainers-pack'
    properties = []
class explorers_pack():
    desc = []
    special = []
    ...
    gear_category = {'index': 'equipment-packs', 'name': 'Equipment Packs', 'url': '/api/equipment-categories/equipment-packs'}
    cost = {'quantity': 10, 'unit': 'gp'}
    contents = [{'item': {'index': 'backpack', 'name': 'Backpack', 'url': '/api/equipment/backpack'}, 'quantity': 1}, {'item': {'index': 'bedroll', 'name': 'Bedroll', 'url': '/api/equipment/bedroll'}, 'quantity': 1}, {'item': {'index': 'mess-kit', 'name': 'Mess Kit', 'url': '/api/equipment/mess-kit'}, 'quantity': 1}, {'item': {'index': 'tinderbox', 'name': 'Tinderbox', 'url': '/api/equipment/tinderbox'}, 'quantity': 1}, {'item': {'index': 'torch', 'name': 'Torch', 'url': '/api/equipment/torch'}, 'quantity': 10}, {'item': {'index': 'rations-1-day', 'name': 'Rations (1 day)', 'url': '/api/equipment/rations-1-day'}, 'quantity': 10}, {'item': {'index': 'waterskin', 'name': 'Waterskin', 'url': '/api/equipment/waterskin'}, 'quantity': 1}, {'item': {'index': 'rope-hempen-50-feet', 'name': 'Rope, hempen (50 feet)', 'url': '/api/equipment/rope-hempen-50-feet'}, 'quantity': 1}]
    url = '/api/equipment/explorers-pack'
    properties = []
class fishing_tackle():
    special = []
...
class flail():
    ...
    category_range = 'Martial Melee'
    cost = {'quantity': 10, 'unit': 'gp'}
    damage = {'damage_dice': '1d8', 'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}}
    range = {'normal': 5}
    weight = 2
    properties = []
    url = '/api/equipment/flail'
    contents = []
class flask_or_tankard():
    desc = []
    special = []
...
class glaive():
    ...
    category_range = 'Martial Melee'
    cost = {'quantity': 20, 'unit': 'gp'}
    damage = {'damage_dice': '1d10', 'damage_type': {'index': 'slashing', 'name': 'Slashing', 'url': '/api/damage-types/slashing'}}
    range = {'normal': 5}
    weight = 6
    properties = [{'index': 'heavy', 'name': 'Heavy', 'url': '/api/weapon-properties/heavy'}, {'index': 'reach', 'name': 'Reach', 'url': '/api/weapon-properties/reach'}, {'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
    url = '/api/equipment/glaive'
    contents = []
class glassblowers_tools():
    special = []
...
class greataxe():
    ...
    category_range = 'Martial Melee'
    cost = {'quantity': 30, 'unit': 'gp'}
    damage = {'damage_dice': '1d12', 'damage_type': {'index': 'slashing', 'name': 'Slashing', 'url': '/api/damage-types/slashing'}}
    range = {'normal': 5}
    weight = 7
    properties = [{'index': 'heavy', 'name': 'Heavy', 'url': '/api/weapon-properties/heavy'}, {'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
...
class greatclub():
    ...
    range = {'normal': 5}
    weight = 10
    properties = [{'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
...
class greatsword():
    ...
    category_range = 'Martial Melee'
    cost = {'quantity': 50, 'unit': 'gp'}
    damage = {'damage_dice': '2d6', 'damage_type': {'index': 'slashing', 'name': 'Slashing', 'url': '/api/damage-types/slashing'}}
    range = {'normal': 5}
    weight = 6
    properties = [{'index': 'heavy', 'name': 'Heavy', 'url': '/api/weapon-properties/heavy'}, {'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
...
class handaxe():
    ...
    category_range = 'Simple Melee'
    cost = {'quantity': 5, 'unit': 'gp'}
    damage = {'damage_dice': '1d6', 'damage_type': {'index': 'slashing', 'name': 'Slashing', 'url': '/api/damage-types/slashing'}}
    range = {'normal': 5}
    weight = 2
    properties = [{'index': 'light', 'name': 'Light', 'url': '/api/weapon-properties/light'}, {'index': 'thrown', 'name': 'Thrown', 'url': '/api/weapon-properties/thrown'}, {'index': 'monk', 'name': 'Monk', 'url': '/api/weapon-properties/monk'}]
    throw_range = {'normal': 20, 'long': 60}
...
class horse_riding():
    ...
    vehicle_category = 'Mounts and Other Animals'
    cost = {'quantity': 75, 'unit': 'gp'}
    speed = {'quantity': 60, 'unit': 'ft/round'}
    capacity = '480 lb.'
...
class javelin():
    ...
    range = {'normal': 5}
    weight = 2
    properties = [{'index': 'thrown', 'name': 'Thrown', 'url': '/api/weapon-properties/thrown'}, {'index': 'monk', 'name': 'Monk', 'url': '/api/weapon-properties/monk'}]
    throw_range = {'normal': 30, 'long': 120}
    url = '/api/equipment/javelin'
    contents = []
class jewelers_tools():
    special = []
...
class lance():
    ...
    category_range = 'Martial Melee'
    cost = {'quantity': 10, 'unit': 'gp'}
    damage = {'damage_dice': '1d12', 'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}}
    range = {'normal': 5}
    weight = 6
    properties = [{'index': 'reach', 'name': 'Reach', 'url': '/api/weapon-properties/reach'}, {'index': 'special', 'name': 'Special', 'url': '/api/weapon-properties/special'}]
...
class longbow():
    ...
    weight = 2
    properties = [{'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/weapon-properties/ammunition'}, {'index': 'heavy', 'name': 'Heavy', 'url': '/api/weapon-properties/heavy'}, {'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
...
class mace():
    ...
    category_range = 'Simple Melee'
    cost = {'quantity': 5, 'unit': 'gp'}
    damage = {'damage_dice': '1d6', 'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}}
    range = {'normal': 5}
    weight = 4
...
class maul():
    ...
    category_range = 'Martial Melee'
    cost = {'quantity': 10, 'unit': 'gp'}
    damage = {'damage_dice': '2d6', 'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}}
    range = {'normal': 5}
    weight = 10
    properties = [{'index': 'heavy', 'name': 'Heavy', 'url': '/api/weapon-properties/heavy'}, {'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
...
class net():
    ...
    weight = 3
    properties = [{'index': 'thrown', 'name': 'Thrown', 'url': '/api/weapon-properties/thrown'}, {'index': 'special', 'name': 'Special', 'url': '/api/weapon-properties/special'}]
...
class priests_pack():
    ...
    contents = [{'item': {'index': 'backpack', 'name': 'Backpack', 'url': '/api/equipment/backpack'}, 'quantity': 1}, {'item': {'index': 'blanket', 'name': 'Blanket', 'url': '/api/equipment/blanket'}, 'quantity': 1}, {'item': {'index': 'candle', 'name': 'Candle', 'url': '/api/equipment/candle'}, 'quantity': 10}, {'item': {'index': 'tinderbox', 'name': 'Tinderbox', 'url': '/api/equipment/tinderbox'}, 'quantity': 1}, {'item': {'index': 'rations-1-day', 'name': 'Rations (1 day)', 'url': '/api/equipment/rations-1-day'}, 'quantity': 2}, {'item': {'index': 'waterskin', 'name': 'Waterskin', 'url': '/api/equipment/waterskin'}, 'quantity': 1}, {'item': {'index': 'alms-box', 'name': 'Alms box', 'url': '/api/equipment/alms-box'}, 'quantity': 1}, {'item': {'index': 'block-of-incense', 'name': 'Block of incense', 'url': '/api/equipment/block-of-incense'}, 'quantity': 2}, {'item': {'index': 'censer', 'name': 'Censer', 'url': '/api/equipment/censer'}, 'quantity': 1}, {'item': {'index': 'vestments', 'name': 'Vestments', 'url': '/api/equipment/vestments'}, 'quantity': 1}]
...
class quarterstaff():
    ...
    range = {'normal': 5}
    weight = 4
    properties = [{'index': 'versatile', 'name': 'Versatile', 'url': '/api/weapon-properties/versatile'}, {'index': 'monk', 'name': 'Monk', 'url': '/api/weapon-properties/monk'}]
    two_handed_damage = {'damage_dice': '1d8', 'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}}
...
class rapier():
    ...
    range = {'normal': 5}
    weight = 2
    properties = [{'index': 'finesse', 'name': 'Finesse', 'url': '/api/weapon-properties/finesse'}]
...
class scholars_pack():
    ...
    gear_category = {'index': 'equipment-packs', 'name': 'Equipment Packs', 'url': '/api/equipment-categories/equipment-packs'}
    cost = {'quantity': 40, 'unit': 'gp'}
    contents = [{'item': {'index': 'backpack', 'name': 'Backpack', 'url': '/api/equipment/backpack'}, 'quantity': 1}, {'item': {'index': 'book', 'name': 'Book', 'url': '/api/equipment/book'}, 'quantity': 1}, {'item': {'index': 'ink-1-ounce-bottle', 'name': 'Ink (1 ounce bottle)', 'url': '/api/equipment/ink-1-ounce-bottle'}, 'quantity': 1}, {'item': {'index': 'ink-pen', 'name': 'Ink pen', 'url': '/api/equipment/ink-pen'}, 'quantity': 1}, {'item': {'index': 'parchment-one-sheet', 'name': 'Parchment (one sheet)', 'url': '/api/equipment/parchment-one-sheet'}, 'quantity': 10}, {'item': {'index': 'little-bag-of-sand', 'name': 'Little bag of sand', 'url': '/api/equipment/little-bag-of-sand'}, 'quantity': 1}, {'item': {'index': 'small-knife', 'name': 'Small knife', 'url': '/api/equipment/small-knife'}, 'quantity': 1}]
...
class scimitar():
    ...
    range = {'normal': 5}
    weight = 3
    properties = [{'index': 'finesse', 'name': 'Finesse', 'url': '/api/weapon-properties/finesse'}, {'index': 'light', 'name': 'Light', 'url': '/api/weapon-properties/light'}]
...
class shortbow():
    ...
    range = {'normal': 80, 'long': 320}
    weight = 2
    properties = [{'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/weapon-properties/ammunition'}, {'index': 'two-handed', 'name': 'Two-Handed', 'url': '/api/weapon-properties/two-handed'}]
...
class shortsword():
    ...
    range = {'normal': 5}
    weight = 2
    properties = [{'index': 'finesse', 'name': 'Finesse', 'url': '/api/weapon-properties/finesse'}, {'index': 'light', 'name': 'Light', 'url': '/api/weapon-properties/light'}, {'index': 'monk', 'name': 'Monk', 'url': '/api/weapon-properties/monk'}]
...
class sickle():
    ...
    category_range = 'Simple Melee'
    cost = {'quantity': 1, 'unit': 'gp'}
    damage = {'damage_dice': '1d4', 'damage_type': {'index': 'slashing', 'name': 'Slashing', 'url': '/api/damage-types/slashing'}}
    range = {'normal': 5}
    weight = 2
    properties = [{'index': 'light', 'name': 'Light', 'url': '/api/weapon-properties/light'}, {'index': 'monk', 'name': 'Monk', 'url': '/api/weapon-properties/monk'}]
    url = '/api/equipment/sickle'
    contents = []
class signal_whistle():
    desc = []
    special = []
...
class sling():
    ...
    range = {'normal': 30, 'long': 120}
    weight = 0
    properties = [{'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/weapon-properties/ammunition'}]
...
class spear():
    ...
    range = {'normal': 5}
    weight = 3
    properties = [{'index': 'thrown', 'name': 'Thrown', 'url': '/api/weapon-properties/thrown'}, {'index': 'versatile', 'name': 'Versatile', 'url': '/api/weapon-properties/versatile'}, {'index': 'monk', 'name': 'Monk', 'url': '/api/weapon-properties/monk'}]
    throw_range = {'normal': 20, 'long': 60}
    two_handed_damage = {'damage_dice': '1d8', 'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}}
...
class splint_armor():
    ...
    contents = []
    properties = []
class sprig_of_mistletoe():
    special = []
    index = 'sprig-of-mistletoe'
    name = 'Sprig of mistletoe'
    equipment_category = {'index': 'adventuring-gear', 'name': 'Adventuring Gear', 'url': '/api/equipment-categories/adventuring-gear'}
    gear_category = {'index': 'druidic-foci', 'name': 'Druidic Foci', 'url': '/api/equipment-categories/druidic-foci'}
    cost = {'quantity': 1, 'unit': 'gp'}
    weight = 0
...
class trident():
    ...
    range = {'normal': 5}
    weight = 4
    properties = [{'index': 'thrown', 'name': 'Thrown', 'url': '/api/weapon-properties/thrown'}, {'index': 'versatile', 'name': 'Versatile', 'url': '/api/weapon-properties/versatile'}]
    throw_range = {'normal': 20, 'long': 60}
    two_handed_damage = {'damage_dice': '1d8', 'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}}
...
class warhammer():
    ...
    weight = 2
    properties = [{'index': 'versatile', 'name': 'Versatile', 'url': '/api/weapon-properties/versatile'}]
    two_handed_damage = {'damage_dice': '1d10', 'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}}
...
class whip():
    ...
    range = {'normal': 5}
    weight = 3
    properties = [{'index': 'finesse', 'name': 'Finesse', 'url': '/api/weapon-properties/finesse'}, {'index': 'reach', 'name': 'Reach', 'url': '/api/weapon-properties/reach'}]
    url = '/api/equipment/whip'
    contents = []
class woodcarvers_tools():
    special = []
