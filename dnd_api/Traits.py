entries = ['artificers_lore', 'brave', 'breath_weapon', 'damage_resistance', 'darkvision', 'draconic_ancestry_black', 'draconic_ancestry_blue', 'draconic_ancestry_brass', 'draconic_ancestry_bronze', 'draconic_ancestry_copper', 'draconic_ancestry_gold', 'draconic_ancestry_green', 'draconic_ancestry_red', 'draconic_ancestry_silver', 'draconic_ancestry_white', 'draconic_ancestry', 'dwarven_combat_training', 'dwarven_resilience', 'dwarven_toughness', 'elf_weapon_training', 'extra_language', 'fey_ancestry', 'gnome_cunning', 'halfling_nimbleness', 'hellish_resistance', 'high_elf_cantrip', 'infernal_legacy', 'keen_senses', 'lucky', 'menacing', 'naturally_stealthy', 'relentless_endurance', 'savage_attacks', 'skill_versatility', 'stonecunning', 'tinker', 'tool_proficiency', 'trance']
attributes = ['index', 'races', 'subraces', 'name', 'desc', 'proficiencies', 'url', 'parent', 'trait_specific', 'language_options', 'proficiency_choices']
class artificers_lore():
    index = 'artificers-lore'
    races = []
    subraces = [{'index': 'rock-gnome', 'name': 'Rock Gnome', 'url': '/api/subraces/rock-gnome'}]
...
class brave():
    index = 'brave'
    races = [{'index': 'halfling', 'name': 'Halfling', 'url': '/api/races/halfling'}]
    subraces = []
    name = 'Brave'
...
class breath_weapon():
    index = 'breath-weapon'
    races = [{'index': 'dragonborn', 'name': 'Dragonborn', 'url': '/api/races/dragonborn'}]
    subraces = []
    name = 'Breath Weapon'
...
class darkvision():
    index = 'darkvision'
    races = [{'index': 'dwarf', 'name': 'Dwarf', 'url': '/api/races/dwarf'}, {'index': 'elf', 'name': 'Elf', 'url': '/api/races/elf'}, {'index': 'gnome', 'name': 'Gnome', 'url': '/api/races/gnome'}, {'index': 'half-elf', 'name': 'Half-Elf', 'url': '/api/races/half-elf'}, {'index': 'half-orc', 'name': 'Half-Orc', 'url': '/api/races/half-orc'}, {'index': 'tiefling', 'name': 'Tiefling', 'url': '/api/races/tiefling'}]
    subraces = []
    name = 'Darkvision'
...
class draconic_ancestry_blue():
    ...
    parent = {'index': 'draconic-ancestry', 'name': 'Draconic Ancestry', 'url': '/api/traits/draconic-ancestry'}
    proficiencies = []
    trait_specific = {'damage_type': {'index': 'lightning', 'name': 'Lightning', 'url': '/api/damage-types/lightning'}, 'breath_weapon': {'name': 'Breath Weapon', 'desc': "You can use your action to exhale destructive energy. Your draconic ancestry determines the size, shape, and damage type of the exhalation. When you use your breath weapon, each creature in the area of the exhalation must make a saving throw, the type of which is determined by your draconic ancestry. The DC for this saving throw equals 8 + your Constitution modifier + your proficiency bonus. A creature takes 2d6 damage on a failed save, and half as much damage on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level. After you use your breath weapon, you can't use it again until you complete a short or long rest.", 'area_of_effect': {'size': 30, 'type': 'line'}, 'usage': {'type': 'per rest', 'times': 1}, 'dc': {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'success_type': 'half'}, 'damage': [{'damage_type': {'index': 'lightning', 'name': 'Lightning', 'url': '/api/damage-types/lightning'}, 'damage_at_character_level': {'1': '2d6', '6': '3d6', '11': '4d6', '16': '5d6'}}]}}
...
class draconic_ancestry_brass():
    ...
    parent = {'index': 'draconic-ancestry', 'name': 'Draconic Ancestry', 'url': '/api/traits/draconic-ancestry'}
    proficiencies = []
    trait_specific = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'breath_weapon': {'name': 'Breath Weapon', 'desc': "You can use your action to exhale destructive energy. Your draconic ancestry determines the size, shape, and damage type of the exhalation. When you use your breath weapon, each creature in the area of the exhalation must make a saving throw, the type of which is determined by your draconic ancestry. The DC for this saving throw equals 8 + your Constitution modifier + your proficiency bonus. A creature takes 2d6 damage on a failed save, and half as much damage on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level. After you use your breath weapon, you can't use it again until you complete a short or long rest.", 'area_of_effect': {'size': 30, 'type': 'line'}, 'usage': {'type': 'per rest', 'times': 1}, 'dc': {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'success_type': 'half'}, 'damage': [{'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_character_level': {'1': '2d6', '6': '3d6', '11': '4d6', '16': '5d6'}}]}}
...
class dwarven_combat_training():
    ...
    proficiencies = [{'index': 'battleaxes', 'name': 'Battleaxes', 'url': '/api/proficiencies/battleaxes'}, {'index': 'handaxes', 'name': 'Handaxes', 'url': '/api/proficiencies/handaxes'}, {'index': 'light-hammers', 'name': 'Light hammers', 'url': '/api/proficiencies/light-hammers'}, {'index': 'warhammers', 'name': 'Warhammers', 'url': '/api/proficiencies/warhammers'}]
...
class dwarven_toughness():
    ...
    races = []
    subraces = [{'index': 'hill-dwarf', 'name': 'Hill Dwarf', 'url': '/api/subraces/hill-dwarf'}]
...
class elf_weapon_training():
    ...
    proficiencies = [{'index': 'longswords', 'name': 'Longswords', 'url': '/api/proficiencies/longswords'}, {'index': 'shortswords', 'name': 'Shortswords', 'url': '/api/proficiencies/shortswords'}, {'index': 'shortbows', 'name': 'Shortbows', 'url': '/api/proficiencies/shortbows'}, {'index': 'longbows', 'name': 'Longbows', 'url': '/api/proficiencies/longbows'}]
...
class fey_ancestry():
    index = 'fey-ancestry'
    races = [{'index': 'elf', 'name': 'Elf', 'url': '/api/races/elf'}, {'index': 'half-elf', 'name': 'Half-Elf', 'url': '/api/races/half-elf'}]
    subraces = []
    name = 'Fey Ancestry'
...
class gnome_cunning():
    index = 'gnome-cunning'
    races = [{'index': 'gnome', 'name': 'Gnome', 'url': '/api/races/gnome'}]
    subraces = []
    name = 'Gnome Cunning'
...
class hellish_resistance():
    ...
    races = [{'index': 'tiefling', 'name': 'Tiefling', 'url': '/api/races/tiefling'}]
    subraces = []
    name = 'Hellish Resistance'
    desc = ['You have resistance to fire damage.']
    proficiencies = []
    url = '/api/traits/hellish-resistance'
class high_elf_cantrip():
    ...
    proficiencies = []
    trait_specific = {'spell_options': {'choose': 1, 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'light', 'name': 'Light', 'url': '/api/spells/light'}}, {'option_type': 'reference', 'item': {'index': 'mage-hand', 'name': 'Mage Hand', 'url': '/api/spells/mage-hand'}}, {'option_type': 'reference', 'item': {'index': 'mending', 'name': 'Mending', 'url': '/api/spells/mending'}}, {'option_type': 'reference', 'item': {'index': 'message', 'name': 'Message', 'url': '/api/spells/message'}}, {'option_type': 'reference', 'item': {'index': 'minor-illusion', 'name': 'Minor Illusion', 'url': '/api/spells/minor-illusion'}}, {'option_type': 'reference', 'item': {'index': 'acid-splash', 'name': 'Acid Splash', 'url': '/api/spells/acid-splash'}}, {'option_type': 'reference', 'item': {'index': 'prestidigitation', 'name': 'Prestidigitation', 'url': '/api/spells/prestidigitation'}}, {'option_type': 'reference', 'item': {'index': 'ray-of-frost', 'name': 'Ray of Frost', 'url': '/api/spells/ray-of-frost'}}, {'option_type': 'reference', 'item': {'index': 'shocking-grasp', 'name': 'Shocking Grasp', 'url': '/api/spells/shocking-grasp'}}, {'option_type': 'reference', 'item': {'index': 'true-strike', 'name': 'True Strike', 'url': '/api/spells/true-strike'}}, {'option_type': 'reference', 'item': {'index': 'chill-touch', 'name': 'Chill Touch', 'url': '/api/spells/chill-touch'}}, {'option_type': 'reference', 'item': {'index': 'dancing-lights', 'name': 'Dancing Lights', 'url': '/api/spells/dancing-lights'}}, {'option_type': 'reference', 'item': {'index': 'fire-bolt', 'name': 'Fire Bolt', 'url': '/api/spells/fire-bolt'}}, {'option_type': 'reference', 'item': {'index': 'poison-spray', 'name': 'Poison Spray', 'url': '/api/spells/poison-spray'}}]}, 'type': 'spell'}}
...
class keen_senses():
    index = 'keen-senses'
    races = [{'index': 'elf', 'name': 'Elf', 'url': '/api/races/elf'}]
    subraces = []
    name = 'Keen Senses'
    desc = ['You have proficiency in the Perception skill.']
    proficiencies = [{'index': 'skill-perception', 'name': 'Skill: Perception', 'url': '/api/proficiencies/skill-perception'}]
...
class menacing():
    index = 'menacing'
    races = [{'index': 'half-orc', 'name': 'Half-Orc', 'url': '/api/races/half-orc'}]
    subraces = []
    name = 'Menacing'
    desc = ['You gain proficiency in the Intimidation skill.']
    proficiencies = [{'index': 'skill-intimidation', 'name': 'Skill: Intimidation', 'url': '/api/proficiencies/skill-intimidation'}]
    url = '/api/traits/menacing'
class naturally_stealthy():
    index = 'naturally-stealthy'
    races = []
    subraces = [{'index': 'lightfoot-halfling', 'name': 'Lightfoot Halfling', 'url': '/api/subraces/lightfoot-halfling'}]
...
class tinker():
    ...
    proficiencies = [{'index': 'tinkers-tools', 'name': "Tinker's Tools", 'url': '/api/proficiencies/tinkers-tools'}]
    url = '/api/traits/tinker'
class tool_proficiency():
    ...
    proficiencies = []
    proficiency_choices = {'choose': 1, 'type': 'proficiencies', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'smiths-tools', 'name': "Smith's Tools", 'url': '/api/proficiencies/smiths-tools'}}, {'option_type': 'reference', 'item': {'index': 'brewers-supplies', 'name': "Brewer's Supplies", 'url': '/api/proficiencies/brewers-supplies'}}, {'option_type': 'reference', 'item': {'index': 'masons-tools', 'name': "Mason's Tools", 'url': '/api/proficiencies/masons-tools'}}]}}
