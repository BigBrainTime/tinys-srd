entries = ['cha', 'dex', 'int', 'str', 'wis']
attributes = ['index', 'name', 'full_name', 'desc', 'skills', 'url']
class cha():
    index = 'cha'
    name = 'CHA'
    full_name = 'Charisma'
    ...
    skills = [{'name': 'Deception', 'index': 'deception', 'url': '/api/skills/deception'}, {'name': 'Intimidation', 'index': 'intimidation', 'url': '/api/skills/intimidation'}, {'name': 'Performance', 'index': 'performance', 'url': '/api/skills/performance'}, {'name': 'Persuasion', 'index': 'persuasion', 'url': '/api/skills/persuasion'}]
...
class dex():
    ...
    skills = [{'name': 'Acrobatics', 'index': 'acrobatics', 'url': '/api/skills/acrobatics'}, {'name': 'Sleight of Hand', 'index': 'sleight-of-hand', 'url': '/api/skills/sleight-of-hand'}, {'name': 'Stealth', 'index': 'stealth', 'url': '/api/skills/stealth'}]
...
class int():
    ...
    skills = [{'name': 'Arcana', 'index': 'arcana', 'url': '/api/skills/arcana'}, {'name': 'History', 'index': 'history', 'url': '/api/skills/history'}, {'name': 'Investigation', 'index': 'investigation', 'url': '/api/skills/investigation'}, {'name': 'Nature', 'index': 'nature', 'url': '/api/skills/nature'}, {'name': 'Religion', 'index': 'religion', 'url': '/api/skills/religion'}]
...
class str():
    ...
    skills = [{'name': 'Athletics', 'index': 'athletics', 'url': '/api/skills/athletics'}]
...
class wis():
    ...
    skills = [{'name': 'Animal Handling', 'index': 'animal-handling', 'url': '/api/skills/animal-handling'}, {'name': 'Insight', 'index': 'insight', 'url': '/api/skills/insight'}, {'name': 'Medicine', 'index': 'medicine', 'url': '/api/skills/medicine'}, {'name': 'Perception', 'index': 'perception', 'url': '/api/skills/perception'}, {'name': 'Survival', 'index': 'survival', 'url': '/api/skills/survival'}]
