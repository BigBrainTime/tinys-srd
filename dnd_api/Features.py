entries = ['action_surge_1_use', 'action_surge_2_uses', 'additional_fighting_style', 'additional_magical_secrets', 'arcane_recovery', 'arcane_tradition', 'archdruid', 'aura_improvements', 'aura_of_courage', 'aura_of_devotion', 'aura_of_protection', 'barbarian_ability_score_improvement_1', 'barbarian_ability_score_improvement_2', 'barbarian_ability_score_improvement_3', 'barbarian_ability_score_improvement_4', 'barbarian_ability_score_improvement_5', 'barbarian_extra_attack', 'barbarian_unarmored_defense', 'bard_ability_score_improvement_1', 'bard_ability_score_improvement_2', 'bard_ability_score_improvement_3', 'bard_ability_score_improvement_4', 'bard_ability_score_improvement_5', 'bard_college', 'bard_expertise_1', 'bard_expertise_2', 'bardic_inspiration_d10', 'bardic_inspiration_d12', 'bardic_inspiration_d6', 'bardic_inspiration_d8', 'beast_spells', 'blessed_healer', 'blindsense', 'bonus_cantrip', 'bonus_proficiencies', 'bonus_proficiency', 'brutal_critical_1_die', 'brutal_critical_2_dice', 'brutal_critical_3_dice', 'channel_divinity_1_rest', 'channel_divinity_2_rest', 'channel_divinity_3_rest', 'channel_divinity_preserve_life', 'channel_divinity_sacred_weapon', 'channel_divinity_turn_the_unholy', 'channel_divinity_turn_undead', 'channel_divinity', 'circle_of_the_land_arctic', 'circle_of_the_land_coast', 'circle_of_the_land_desert', 'circle_of_the_land_forest', 'circle_of_the_land_grassland', 'circle_of_the_land_mountain', 'circle_of_the_land_swamp', 'circle_of_the_land', 'circle_spells_1', 'circle_spells_2', 'circle_spells_3', 'circle_spells_4', 'cleansing_touch', 'cleric_ability_score_improvement_1', 'cleric_ability_score_improvement_2', 'cleric_ability_score_improvement_3', 'cleric_ability_score_improvement_4', 'cleric_ability_score_improvement_5', 'countercharm', 'cunning_action', 'cutting_words', 'danger_sense', 'dark_ones_blessing', 'dark_ones_own_luck', 'defensive_tactics_escape_the_horde', 'defensive_tactics_multiattack_defense', 'defensive_tactics_steel_will', 'defensive_tactics', 'deflect_missiles', 'destroy_undead_cr_1_2_or_below', 'destroy_undead_cr_1_or_below', 'destroy_undead_cr_2_or_below', 'destroy_undead_cr_3_or_below', 'destroy_undead_cr_4_or_below', 'diamond_soul', 'disciple_of_life', 'divine_domain', 'divine_health', 'divine_intervention_improvement', 'divine_intervention', 'divine_sense', 'divine_smite', 'divine_strike', 'domain_spells_1', 'domain_spells_2', 'domain_spells_3', 'domain_spells_4', 'domain_spells_5', 'draconic_presence', 'draconic_resilience', 'dragon_ancestor_black___acid_damage', 'dragon_ancestor_blue___lightning_damage', 'dragon_ancestor_brass___fire_damage', 'dragon_ancestor_bronze___lightning_damage', 'dragon_ancestor_copper___acid_damage', 'dragon_ancestor_gold___fire_damage', 'dragon_ancestor_green___poison_damage', 'dragon_ancestor_red___fire_damage', 'dragon_ancestor_silver___cold_damage', 'dragon_ancestor_white___cold_damage', 'dragon_ancestor', 'dragon_wings', 'druid_ability_score_improvement_1', 'druid_ability_score_improvement_2', 'druid_ability_score_improvement_3', 'druid_ability_score_improvement_4', 'druid_ability_score_improvement_5', 'druid_circle', 'druid_lands_stride', 'druid_timeless_body', 'druidic', 'eldritch_invocation_agonizing_blast', 'eldritch_invocation_armor_of_shadows', 'eldritch_invocation_ascendant_step', 'eldritch_invocation_beast_speech', 'eldritch_invocation_beguiling_influence', 'eldritch_invocation_bewitching_whispers', 'eldritch_invocation_book_of_ancient_secrets', 'eldritch_invocation_chains_of_carceri', 'eldritch_invocation_devils_sight', 'eldritch_invocation_dreadful_word', 'eldritch_invocation_eldritch_sight', 'eldritch_invocation_eldritch_spear', 'eldritch_invocation_eyes_of_the_rune_keeper', 'eldritch_invocation_fiendish_vigor', 'eldritch_invocation_gaze_of_two_minds', 'eldritch_invocation_lifedrinker', 'eldritch_invocation_mask_of_many_faces', 'eldritch_invocation_master_of_myriad_forms', 'eldritch_invocation_minions_of_chaos', 'eldritch_invocation_mire_the_mind', 'eldritch_invocation_misty_visions', 'eldritch_invocation_one_with_shadows', 'eldritch_invocation_otherworldly_leap', 'eldritch_invocation_repelling_blast', 'eldritch_invocation_sculptor_of_flesh', 'eldritch_invocation_sign_of_ill_omen', 'eldritch_invocation_thief_of_five_fates', 'eldritch_invocation_thirsting_blade', 'eldritch_invocation_visions_of_distant_realms', 'eldritch_invocation_voice_of_the_chain_master', 'eldritch_invocation_whispers_of_the_grave', 'eldritch_invocation_witch_sight', 'eldritch_invocations', 'eldritch_master', 'elemental_affinity', 'elusive', 'empowered_evocation', 'empty_body', 'evocation_savant', 'extra_attack_1', 'extra_attack_2', 'extra_attack_3', 'fast_hands', 'fast_movement', 'favored_enemy_1_type', 'favored_enemy_2_types', 'favored_enemy_3_enemies', 'feral_instinct', 'feral_senses', 'fiendish_resilience', 'fighter_ability_score_improvement_1', 'fighter_ability_score_improvement_2', 'fighter_ability_score_improvement_3', 'fighter_ability_score_improvement_4', 'fighter_ability_score_improvement_5', 'fighter_ability_score_improvement_6', 'fighter_ability_score_improvement_7', 'fighter_fighting_style_archery', 'fighter_fighting_style_defense', 'fighter_fighting_style_dueling', 'fighter_fighting_style_great_weapon_fighting', 'fighter_fighting_style_protection', 'fighter_fighting_style_two_weapon_fighting', 'fighter_fighting_style', 'fighting_style_defense', 'fighting_style_dueling', 'fighting_style_great_weapon_fighting', 'fighting_style_protection', 'flexible_casting_converting_spell_slot', 'flexible_casting_creating_spell_slots', 'flurry_of_blows', 'foe_slayer', 'font_of_inspiration', 'font_of_magic', 'frenzy', 'hide_in_plain_sight', 'holy_nimbus', 'hunters_prey_colossus_slayer', 'hunters_prey_giant_killer', 'hunters_prey_horde_breaker', 'hunters_prey', 'hurl_through_hell', 'improved_critical', 'improved_divine_smite', 'indomitable_1_use', 'indomitable_2_uses', 'indomitable_3_uses', 'indomitable_might', 'intimidating_presence', 'jack_of_all_trades', 'ki_empowered_strikes', 'ki', 'lay_on_hands', 'magical_secrets_1', 'magical_secrets_2', 'magical_secrets_3', 'martial_archetype', 'martial_arts', 'metamagic_1', 'metamagic_2', 'metamagic_3', 'metamagic_careful_spell', 'metamagic_distant_spell', 'metamagic_empowered_spell', 'metamagic_extended_spell', 'metamagic_heightened_spell', 'metamagic_quickened_spell', 'metamagic_subtle_spell', 'metamagic_twinned_spell', 'mindless_rage', 'monastic_tradition', 'monk_ability_score_improvement_1', 'monk_ability_score_improvement_2', 'monk_ability_score_improvement_3', 'monk_ability_score_improvement_4', 'monk_ability_score_improvement_5', 'monk_evasion', 'monk_extra_attack', 'monk_timeless_body', 'monk_unarmored_defense', 'multiattack_volley', 'multiattack_whirlwind_attack', 'multiattack', 'mystic_arcanum_6th_level', 'mystic_arcanum_7th_level', 'mystic_arcanum_8th_level', 'mystic_arcanum_9th_level', 'natural_explorer_1_terrain_type', 'natural_explorer_2_terrain_types', 'natural_explorer_3_terrain_types', 'natural_recovery', 'natures_sanctuary', 'natures_ward', 'oath_spells', 'open_hand_technique', 'otherworldly_patron', 'overchannel', 'pact_boon', 'pact_magic', 'pact_of_the_blade', 'pact_of_the_chain', 'pact_of_the_tome', 'paladin_ability_score_improvement_1', 'paladin_ability_score_improvement_2', 'paladin_ability_score_improvement_3', 'paladin_ability_score_improvement_4', 'paladin_ability_score_improvement_5', 'paladin_extra_attack', 'paladin_fighting_style', 'patient_defense', 'peerless_skill', 'perfect_self', 'persistent_rage', 'potent_cantrip', 'primal_champion', 'primal_path', 'primeval_awareness', 'purity_of_body', 'purity_of_spirit', 'quivering_palm', 'rage', 'ranger_ability_score_improvement_1', 'ranger_ability_score_improvement_2', 'ranger_ability_score_improvement_3', 'ranger_ability_score_improvement_4', 'ranger_ability_score_improvement_5', 'ranger_archetype', 'ranger_extra_attack', 'ranger_fighting_style_archery', 'ranger_fighting_style_defense', 'ranger_fighting_style_dueling', 'ranger_fighting_style_two_weapon_fighting', 'ranger_fighting_style', 'ranger_lands_stride', 'reckless_attack', 'relentless_rage', 'reliable_talent', 'remarkable_athlete', 'retaliation', 'rogue_ability_score_improvement_1', 'rogue_ability_score_improvement_2', 'rogue_ability_score_improvement_3', 'rogue_ability_score_improvement_4', 'rogue_ability_score_improvement_5', 'rogue_ability_score_improvement_6', 'rogue_evasion', 'rogue_expertise_1', 'rogue_expertise_2', 'roguish_archetype', 'sacred_oath', 'sculpt_spells', 'second_story_work', 'second_wind', 'signature_spell', 'slippery_mind', 'slow_fall', 'sneak_attack', 'song_of_rest_d10', 'song_of_rest_d12', 'song_of_rest_d6', 'song_of_rest_d8', 'sorcerer_ability_score_improvement_1', 'sorcerer_ability_score_improvement_2', 'sorcerer_ability_score_improvement_3', 'sorcerer_ability_score_improvement_4', 'sorcerer_ability_score_improvement_5', 'sorcerous_origin', 'sorcerous_restoration', 'spell_mastery', 'spellcasting_bard', 'spellcasting_cleric', 'spellcasting_druid', 'spellcasting_paladin', 'spellcasting_ranger', 'spellcasting_sorcerer', 'spellcasting_wizard', 'step_of_the_wind', 'stillness_of_mind', 'stroke_of_luck', 'stunning_strike', 'superior_critical', 'superior_hunters_defense_evasion', 'superior_hunters_defense_stand_against_the_tide', 'superior_hunters_defense_uncanny_dodge', 'superior_hunters_defense', 'superior_inspiration', 'supreme_healing', 'supreme_sneak', 'survivor', 'thiefs_reflexes', 'thieves_cant', 'tongue_of_the_sun_and_moon', 'tranquility', 'unarmored_movement_1', 'unarmored_movement_2', 'uncanny_dodge', 'use_magic_device', 'vanish', 'warlock_ability_score_improvement_1', 'warlock_ability_score_improvement_2', 'warlock_ability_score_improvement_3', 'warlock_ability_score_improvement_4', 'warlock_ability_score_improvement_5', 'wholeness_of_body', 'wild_shape_cr_1_2_or_below_no_flying_speed', 'wild_shape_cr_1_4_or_below_no_flying_or_swim_speed', 'wild_shape_cr_1_or_below', 'wizard_ability_score_improvement_1', 'wizard_ability_score_improvement_2', 'wizard_ability_score_improvement_3', 'wizard_ability_score_improvement_4', 'wizard_ability_score_improvement_5']
attributes = ['index', 'class', 'name', 'level', 'prerequisites', 'desc', 'url', 'subclass', 'feature_specific', 'parent', 'reference']
class action_surge_1_use():
    index = 'action-surge-1-use'
    class_ = {'index': 'fighter', 'name': 'Fighter', 'url': '/api/classes/fighter'}
...
class additional_fighting_style():
    index = 'additional-fighting-style'
    class_ = {'index': 'fighter', 'name': 'Fighter', 'url': '/api/classes/fighter'}
    subclass = {'index': 'champion', 'name': 'Champion', 'url': '/api/subclasses/champion'}
    name = 'Additional Fighting Style'
    level = 10
    prerequisites = []
    desc = ['At 10th level, you can choose a second option from the Fighting Style class feature.']
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'fighter-fighting-style-archery', 'name': 'Fighting Style: Archery', 'url': '/api/features/fighter-fighting-style-archery'}}, {'option_type': 'reference', 'item': {'index': 'fighter-fighting-style-defense', 'name': 'Fighting Style: Defense', 'url': '/api/features/fighter-fighting-style-defense'}}, {'option_type': 'reference', 'item': {'index': 'fighter-fighting-style-dueling', 'name': 'Fighting Style: Dueling', 'url': '/api/features/fighter-fighting-style-dueling'}}, {'option_type': 'reference', 'item': {'index': 'fighter-fighting-style-great-weapon-fighting', 'name': 'Fighting Style: Great Weapon Fighting', 'url': '/api/features/fighter-fighting-style-great-weapon-fighting'}}, {'option_type': 'reference', 'item': {'index': 'fighter-fighting-style-protection', 'name': 'Fighting Style: Protection', 'url': '/api/features/fighter-fighting-style-protection'}}, {'option_type': 'reference', 'item': {'index': 'fighter-fighting-style-two-weapon-fighting', 'name': 'Fighting Style: Two-Weapon Fighting', 'url': '/api/features/fighter-fighting-style-two-weapon-fighting'}}]}}, 'invocations': []}
    url = '/api/features/additional-fighting-style'
class additional_magical_secrets():
    index = 'additional-magical-secrets'
    class_ = {'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}
    subclass = {'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}
...
class arcane_recovery():
    index = 'arcane-recovery'
    class_ = {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}
...
class arcane_tradition():
    index = 'arcane-tradition'
    class_ = {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}
    name = 'Arcane Tradition'
    level = 2
    prerequisites = []
    desc = ['When you reach 2nd level, you choose an arcane tradition, shaping your practice of magic through one of eight schools, such as Evocation.', 'Your choice grants you features at 2nd level and again at 6th, 10th, and 14th level.']
    url = '/api/features/arcane-tradition'
class archdruid():
    index = 'archdruid'
    class_ = {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}
    name = 'Archdruid'
    level = 20
    prerequisites = []
    desc = ['At 20th level, you can use your Wild Shape an unlimited number of times.', "Additionally, you can ignore the verbal and somatic components of your druid spells, as well as any material components that lack a cost and aren't consumed by a spell. You gain this benefit in both your normal shape and your beast shape from Wild Shape."]
    url = '/api/features/archdruid'
class aura_improvements():
    index = 'aura-improvements'
    class_ = {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}
    name = 'Aura improvements'
    level = 18
    prerequisites = []
    desc = ['At 18th level, the range of your auras increase to 30 feet.']
    url = '/api/features/aura-improvements'
class aura_of_courage():
...
class aura_of_devotion():
    index = 'aura-of-devotion'
    class_ = {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}
    subclass = {'index': 'devotion', 'name': 'Devotion', 'url': '/api/subclasses/devotion'}
...
class barbarian_ability_score_improvement_1():
    index = 'barbarian-ability-score-improvement-1'
    class_ = {'index': 'barbarian', 'name': 'Barbarian', 'url': '/api/classes/barbarian'}
...
class barbarian_ability_score_improvement_2():
...
class barbarian_ability_score_improvement_3():
...
class barbarian_ability_score_improvement_4():
...
class barbarian_ability_score_improvement_5():
...
class barbarian_unarmored_defense():
...
class bard_ability_score_improvement_1():
...
class bard_ability_score_improvement_2():
...
class bard_ability_score_improvement_3():
...
class bard_ability_score_improvement_4():
...
class bard_ability_score_improvement_5():
...
class bard_expertise_1():
    ...
    feature_specific = {'expertise_options': {'choose': 2, 'type': 'proficiency', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'skill-acrobatics', 'name': 'Skill: Acrobatics', 'url': '/api/proficiencies/skill-acrobatics'}}, {'option_type': 'reference', 'item': {'index': 'skill-animal-handling', 'name': 'Skill: Animal Handling', 'url': '/api/proficiencies/skill-animal-handling'}}, {'option_type': 'reference', 'item': {'index': 'skill-arcana', 'name': 'Skill: Arcana', 'url': '/api/proficiencies/skill-arcana'}}, {'option_type': 'reference', 'item': {'index': 'skill-athletics', 'name': 'Skill: Athletics', 'url': '/api/proficiencies/skill-athletics'}}, {'option_type': 'reference', 'item': {'index': 'skill-deception', 'name': 'Skill: Deception', 'url': '/api/proficiencies/skill-deception'}}, {'option_type': 'reference', 'item': {'index': 'skill-history', 'name': 'Skill: History', 'url': '/api/proficiencies/skill-history'}}, {'option_type': 'reference', 'item': {'index': 'skill-insight', 'name': 'Skill: Insight', 'url': '/api/proficiencies/skill-insight'}}, {'option_type': 'reference', 'item': {'index': 'skill-intimidation', 'name': 'Skill: Intimidation', 'url': '/api/proficiencies/skill-intimidation'}}, {'option_type': 'reference', 'item': {'index': 'skill-investigation', 'name': 'Skill: Investigation', 'url': '/api/proficiencies/skill-investigation'}}, {'option_type': 'reference', 'item': {'index': 'skill-medicine', 'name': 'Skill: Medicine', 'url': '/api/proficiencies/skill-medicine'}}, {'option_type': 'reference', 'item': {'index': 'skill-nature', 'name': 'Skill: Nature', 'url': '/api/proficiencies/skill-nature'}}, {'option_type': 'reference', 'item': {'index': 'skill-perception', 'name': 'Skill: Perception', 'url': '/api/proficiencies/skill-perception'}}, {'option_type': 'reference', 'item': {'index': 'skill-performance', 'name': 'Skill: Performance', 'url': '/api/proficiencies/skill-performance'}}, {'option_type': 'reference', 'item': {'index': 'skill-persuasion', 'name': 'Skill: Persuasion', 'url': '/api/proficiencies/skill-persuasion'}}, {'option_type': 'reference', 'item': {'index': 'skill-religion', 'name': 'Skill: Religion', 'url': '/api/proficiencies/skill-religion'}}, {'option_type': 'reference', 'item': {'index': 'skill-sleight-of-hand', 'name': 'Skill: Sleight of Hand', 'url': '/api/proficiencies/skill-sleight-of-hand'}}, {'option_type': 'reference', 'item': {'index': 'skill-stealth', 'name': 'Skill: Stealth', 'url': '/api/proficiencies/skill-stealth'}}, {'option_type': 'reference', 'item': {'index': 'skill-survival', 'name': 'Skill: Survival', 'url': '/api/proficiencies/skill-survival'}}]}}, 'invocations': []}
    url = '/api/features/bard-expertise-1'
class bard_expertise_2():
...
class blessed_healer():
    index = 'blessed-healer'
    class_ = {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}
    subclass = {'index': 'life', 'name': 'Life', 'url': '/api/subclasses/life'}
    name = 'Blessed Healer'
    level = 6
    prerequisites = []
...
class blindsense():
    index = 'blindsense'
    class_ = {'index': 'rogue', 'name': 'Rogue', 'url': '/api/classes/rogue'}
    name = 'Blindsense'
    level = 14
    prerequisites = []
...
class bonus_cantrip():
    index = 'bonus-cantrip'
    class_ = {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}
    subclass = {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}
    name = 'Bonus Cantrip'
    level = 2
    prerequisites = []
...
class channel_divinity_preserve_life():
...
class channel_divinity_sacred_weapon():
...
class channel_divinity_turn_the_unholy():
...
class channel_divinity_turn_undead():
...
class circle_of_the_land_arctic():
    ...
    parent = {'index': 'circle-of-the-land', 'name': 'Circle of the Land', 'url': '/api/features/circle-of-the-land'}
    url = '/api/features/circle-of-the-land-arctic'
class circle_of_the_land_coast():
...
class circle_of_the_land_desert():
...
class circle_of_the_land_forest():
...
class circle_of_the_land_grassland():
...
class circle_of_the_land_mountain():
...
class circle_of_the_land_swamp():
...
class circle_of_the_land():
    ...
    prerequisites = []
    desc = ["The Circle of the Land is made up of mystics and sages who safeguard ancient knowledge and rites through a vast oral tradition. These druids meet within sacred circles of trees or standing stones to whisper primal secrets in Druidic. The circle's wisest members preside as the chief priests of communities that hold to the Old Faith and serve as advisors to the rulers of those folk. As a member of this circle, your magic is influenced by the land where you were initiated into the circle's mysterious rites."]
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'circle-of-the-land-arctic', 'name': 'Circle of the Land: Arctic', 'url': '/api/features/circle-of-the-land-arctic'}}, {'option_type': 'reference', 'item': {'index': 'circle-of-the-land-coast', 'name': 'Circle of the Land: Coast', 'url': '/api/features/circle-of-the-land-coast'}}, {'option_type': 'reference', 'item': {'index': 'circle-of-the-land-desert', 'name': 'Circle of the Land: Desert', 'url': '/api/features/circle-of-the-land-desert'}}, {'option_type': 'reference', 'item': {'index': 'circle-of-the-land-forest', 'name': 'Circle of the Land: Forest', 'url': '/api/features/circle-of-the-land-forest'}}, {'option_type': 'reference', 'item': {'index': 'circle-of-the-land-grassland', 'name': 'Circle of the Land: Grassland', 'url': '/api/features/circle-of-the-land-grassland'}}, {'option_type': 'reference', 'item': {'index': 'circle-of-the-land-mountain', 'name': 'Circle of the Land: Mountain', 'url': '/api/features/circle-of-the-land-mountain'}}, {'option_type': 'reference', 'item': {'index': 'circle-of-the-land-swamp', 'name': 'Circle of the Land: Swamp', 'url': '/api/features/circle-of-the-land-swamp'}}]}}, 'invocations': []}
    url = '/api/features/circle-of-the-land'
class circle_spells_1():
...
class cleansing_touch():
    index = 'cleansing-touch'
    class_ = {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}
    name = 'Cleansing Touch'
    level = 14
    prerequisites = []
    desc = ['Beginning at 14th level, you can use your action to end one spell on yourself or on one willing creature that you touch.', 'You can use this feature a number of times equal to your Charisma modifier (a minimum of once). You regain expended uses when you finish a long rest.']
    url = '/api/features/cleansing-touch'
class cleric_ability_score_improvement_1():
...
class cleric_ability_score_improvement_2():
...
class cleric_ability_score_improvement_3():
...
class cleric_ability_score_improvement_4():
...
class cleric_ability_score_improvement_5():
...
class dark_ones_blessing():
    index = 'dark-ones-blessing'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    subclass = {'index': 'fiend', 'name': 'Fiend', 'url': '/api/subclasses/fiend'}
...
class defensive_tactics_escape_the_horde():
    index = 'defensive-tactics-escape-the-horde'
    class_ = {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}
    subclass = {'index': 'hunter', 'name': 'Hunter', 'url': '/api/subclasses/hunter'}
    name = 'Defensive Tactics: Escape the Horde'
    level = 7
    prerequisites = []
    desc = ['Opportunity attacks against you are made with disadvantage.']
    parent = {'index': 'defensive-tactics', 'name': 'Defensive Tactics', 'url': '/api/features/defensive-tactics'}
    url = '/api/features/defensive-tactics-escape-the-horde'
class defensive_tactics_multiattack_defense():
...
class defensive_tactics_steel_will():
...
class defensive_tactics():
    ...
    level = 7
    prerequisites = []
    desc = ['At 7th level, you gain one of the following features of your choice.', 'Escape the Horde', 'Multiattack Defense', 'Steel Will']
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'defensive-tactics-escape-the-horde', 'name': 'Defensive Tactics: Escape the Horde', 'url': '/api/features/defensive-tactics-escape-the-horde'}}, {'option_type': 'reference', 'item': {'index': 'defensive-tactics-multiattack-defense', 'name': 'Defensive Tactics: Multiattack Defense', 'url': '/api/features/defensive-tactics-multiattack-defense'}}, {'option_type': 'reference', 'item': {'index': 'defensive-tactics-steel-will', 'name': 'Defensive Tactics: Steel Will', 'url': '/api/features/defensive-tactics-steel-will'}}]}}, 'invocations': []}
    url = '/api/features/defensive-tactics'
class deflect_missiles():
    index = 'deflect-missiles'
    class_ = {'index': 'monk', 'name': 'Monk', 'url': '/api/classes/monk'}
...
class destroy_undead_cr_1_2_or_below():
...
class destroy_undead_cr_1_or_below():
...
class destroy_undead_cr_2_or_below():
...
class destroy_undead_cr_3_or_below():
...
class destroy_undead_cr_4_or_below():
...
class divine_intervention_improvement():
...
class draconic_presence():
    index = 'draconic-presence'
    class_ = {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}
    subclass = {'index': 'draconic', 'name': 'Draconic', 'url': '/api/subclasses/draconic'}
...
class dragon_ancestor_black___acid_damage():
    ...
    parent = {'index': 'dragon-ancestor', 'name': 'Dragon Ancestor', 'url': '/api/features/dragon-ancestor'}
    url = '/api/features/dragon-ancestor-black---acid-damage'
class dragon_ancestor_blue___lightning_damage():
...
class dragon_ancestor_brass___fire_damage():
...
class dragon_ancestor_bronze___lightning_damage():
...
class dragon_ancestor_copper___acid_damage():
...
class dragon_ancestor_gold___fire_damage():
...
class dragon_ancestor_green___poison_damage():
...
class dragon_ancestor_red___fire_damage():
...
class dragon_ancestor_silver___cold_damage():
...
class dragon_ancestor_white___cold_damage():
...
class dragon_ancestor():
    ...
    prerequisites = []
    desc = ['At 1st level, you choose one type of dragon as your ancestor. The damage type associated with each dragon is used by features you gain later.', 'You can speak, read, and write Draconic. Additionally, whenever you make a Charisma check when interacting with dragons, your proficiency bonus is doubled if it applies to the check.']
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'dragon-ancestor-black---acid-damage', 'name': 'Dragon Ancestor: Black - Acid Damage', 'url': '/api/features/dragon-ancestor-black---acid-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-blue---lightning-damage', 'name': 'Dragon Ancestor: Blue - Lightning Damage', 'url': '/api/features/dragon-ancestor-blue---lightning-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-brass---fire-damage', 'name': 'Dragon Ancestor: Brass - Fire Damage', 'url': '/api/features/dragon-ancestor-brass---fire-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-bronze---lightning-damage', 'name': 'Dragon Ancestor: Bronze - Lightning Damage', 'url': '/api/features/dragon-ancestor-bronze---lightning-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-copper---acid-damage', 'name': 'Dragon Ancestor: Copper - Acid Damage', 'url': '/api/features/dragon-ancestor-copper---acid-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-gold---fire-damage', 'name': 'Dragon Ancestor: Gold - Fire Damage', 'url': '/api/features/dragon-ancestor-gold---fire-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-green---poison-damage', 'name': 'Dragon Ancestor: Green - Poison Damage', 'url': '/api/features/dragon-ancestor-green---poison-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-red---fire-damage', 'name': 'Dragon Ancestor: Red - Fire Damage', 'url': '/api/features/dragon-ancestor-red---fire-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-silver---cold-damage', 'name': 'Dragon Ancestor: Silver - Cold Damage', 'url': '/api/features/dragon-ancestor-silver---cold-damage'}}, {'option_type': 'reference', 'item': {'index': 'dragon-ancestor-white---cold-damage', 'name': 'Dragon Ancestor: White - Cold Damage', 'url': '/api/features/dragon-ancestor-white---cold-damage'}}]}}, 'invocations': []}
...
class druid_ability_score_improvement_1():
...
class druid_ability_score_improvement_2():
...
class druid_ability_score_improvement_3():
...
class druid_ability_score_improvement_4():
...
class druid_ability_score_improvement_5():
...
class eldritch_invocation_agonizing_blast():
    index = 'eldritch-invocation-agonizing-blast'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Agonizing Blast'
    level = 2
    prerequisites = [{'type': 'spell', 'spell': '/api/spells/eldritch-blast'}]
    desc = ['When you cast eldritch blast, add your Charisma modifier to the damage it deals on a hit.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-agonizing-blast'
class eldritch_invocation_armor_of_shadows():
    index = 'eldritch-invocation-armor-of-shadows'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Armor of Shadows'
    level = 2
    prerequisites = []
    desc = ['You can cast mage armor on yourself at will, without expending a spell slot or material components.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-armor-of-shadows'
class eldritch_invocation_ascendant_step():
    index = 'eldritch-invocation-ascendant-step'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Ascendant Step'
    level = 9
    prerequisites = [{'type': 'level', 'level': 9}]
    desc = ['You can cast levitate on yourself at will, without expending a spell slot or material components.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-ascendant-step'
class eldritch_invocation_beast_speech():
...
class eldritch_invocation_beguiling_influence():
...
class eldritch_invocation_bewitching_whispers():
    ...
    desc = ["You can cast compulsion once using a warlock spell slot. You can't do so again until you finish a long rest."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-bewitching-whispers'
class eldritch_invocation_book_of_ancient_secrets():
    index = 'eldritch-invocation-book-of-ancient-secrets'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Book of Ancient Secrets'
    level = 2
    prerequisites = [{'type': 'feature', 'feature': '/api/features/pact-of-the-tome'}]
    desc = ["You can now inscribe magical rituals in your Book of Shadows. Choose two 1st-level spells that have the ritual tag from any class's spell list (the two needn't be from the same list). The spells appear in the book and don't count against the number of spells you know. With your Book of Shadows in hand, you can cast the chosen spells as rituals. You can't cast the spells except as rituals, unless you've learned them by some other means. You can also cast a warlock spell you know as a ritual if it has the ritual tag.", "On your adventures, you can add other ritual spells to your Book of Shadows. When you find such a spell, you can add it to the book if the spell's level is equal to or less than half your warlock level (rounded up) and if you can spare the time to transcribe the spell. For each level of the spell, the transcription process takes 2 hours and costs 50 gp for the rare inks needed to inscribe it."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-book-of-ancient-secrets'
class eldritch_invocation_chains_of_carceri():
    index = 'eldritch-invocation-chains-of-carceri'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Chains of Carceri'
    level = 15
    prerequisites = [{'type': 'level', 'level': 15}, {'type': 'feature', 'feature': '/api/features/pact-of-the-chain'}]
    desc = ['You can cast hold monster at will--targeting a celestial, fiend, or elemental--without expending a spell slot or material components. You must finish a long rest before you can use this invocation on the same creature again.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-chains-of-carceri'
class eldritch_invocation_devils_sight():
...
class eldritch_invocation_dreadful_word():
    index = 'eldritch-invocation-dreadful-word'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Dreadful Word'
    level = 7
    prerequisites = [{'type': 'level', 'level': 7}]
    desc = ["You can cast confusion once using a warlock spell slot. You can't do so again until you finish a long rest."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-dreadful-word'
class eldritch_invocation_eldritch_sight():
...
class eldritch_invocation_eldritch_spear():
...
class eldritch_invocation_eyes_of_the_rune_keeper():
...
class eldritch_invocation_fiendish_vigor():
    index = 'eldritch-invocation-fiendish-vigor'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Fiendish Vigor'
    level = 2
    prerequisites = []
    desc = ['You can cast false life on yourself at will as a 1st-level spell, without expending a spell slot or material components.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-fiendish-vigor'
class eldritch_invocation_gaze_of_two_minds():
    index = 'eldritch-invocation-gaze-of-two-minds'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Gaze of Two Minds'
    level = 2
    prerequisites = []
    desc = ["You can use your action to touch a willing humanoid and perceive through its senses until the end of your next turn. As long as the creature is on the same plane of existence as you, you can use your action on subsequent turns to maintain this connection, extending the duration until the end of your next turn. While perceiving through the other creature's senses, you benefit from any special senses possessed by that creature, and you are blinded and deafened to your own surroundings."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-gaze-of-two-minds'
class eldritch_invocation_lifedrinker():
    index = 'eldritch-invocation-lifedrinker'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Lifedrinker'
    level = 12
    prerequisites = [{'type': 'level', 'level': 12}, {'type': 'feature', 'feature': '/api/features/pact-of-the-blade'}]
    desc = ['When you hit a creature with your pact weapon, the creature takes extra necrotic damage equal to your Charisma modifier (minimum 1).']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-lifedrinker'
class eldritch_invocation_mask_of_many_faces():
...
class eldritch_invocation_minions_of_chaos():
    index = 'eldritch-invocation-minions-of-chaos'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Minions of Chaos'
    level = 9
    prerequisites = [{'type': 'level', 'level': 9}]
    desc = ["You can cast conjure elemental once using a warlock spell slot. You can't do so again until you finish a long rest."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-minions-of-chaos'
class eldritch_invocation_mire_the_mind():
    index = 'eldritch-invocation-mire-the-mind'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Mire the Mind'
    level = 5
    prerequisites = [{'type': 'level', 'level': 5}]
    desc = ["You can cast slow once using a warlock spell slot. You can't do so again until you finish a long rest."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-mire-the-mind'
class eldritch_invocation_misty_visions():
    index = 'eldritch-invocation-misty-visions'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Misty Visions'
    level = 2
    prerequisites = []
    desc = ['You can cast silent image at will, without expending a spell slot or material components.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-misty-visions'
class eldritch_invocation_one_with_shadows():
    index = 'eldritch-invocation-one-with-shadows'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: One with Shadows'
    level = 5
    prerequisites = [{'type': 'level', 'level': 5}]
    desc = ['When you are in an area of dim light or darkness, you can use your action to become invisible until you move or take an action or a reaction.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-one-with-shadows'
class eldritch_invocation_otherworldly_leap():
    index = 'eldritch-invocation-otherworldly-leap'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Otherworldly Leap'
    level = 9
    prerequisites = [{'type': 'level', 'level': 9}]
    desc = ['You can cast jump on yourself at will, without expending a spell slot or material components.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-otherworldly-leap'
class eldritch_invocation_repelling_blast():
    index = 'eldritch-invocation-repelling-blast'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Repelling Blast'
    level = 2
    prerequisites = [{'type': 'spell', 'spell': '/api/spells/eldritch-blast'}]
    desc = ['When you hit a creature with eldritch blast, you can push the creature up to 10 feet away from you in a straight line.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-repelling-blast'
class eldritch_invocation_sculptor_of_flesh():
    index = 'eldritch-invocation-sculptor-of-flesh'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Sculptor of Flesh'
    level = 7
    prerequisites = [{'type': 'level', 'level': 7}]
    desc = ["You can cast polymorph once using a warlock spell slot. You can't do so again until you finish a long rest."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-sculptor-of-flesh'
class eldritch_invocation_sign_of_ill_omen():
    index = 'eldritch-invocation-sign-of-ill-omen'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Sign of Ill Omen'
    level = 5
    prerequisites = [{'type': 'level', 'level': 5}]
    desc = ["You can cast bestow curse once using a warlock spell slot. You can't do so again until you finish a long rest."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-sign-of-ill-omen'
class eldritch_invocation_thief_of_five_fates():
    index = 'eldritch-invocation-thief-of-five-fates'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Thief of Five Fates'
    level = 2
    prerequisites = []
    desc = ["You can cast bane once using a warlock spell slot. You can't do so again until you finish a long rest."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-thief-of-five-fates'
class eldritch_invocation_thirsting_blade():
    index = 'eldritch-invocation-thirsting-blade'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Thirsting Blade'
    level = 5
    prerequisites = [{'type': 'level', 'level': 5}, {'type': 'feature', 'feature': '/api/features/pact-of-the-blade'}]
    desc = ['You can attack with your pact weapon twice, instead of once, whenever you take the Attack action on your turn.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-thirsting-blade'
class eldritch_invocation_visions_of_distant_realms():
...
class eldritch_invocation_voice_of_the_chain_master():
    index = 'eldritch-invocation-voice-of-the-chain-master'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Voice of the Chain Master'
    level = 2
    prerequisites = [{'type': 'feature', 'feature': '/api/features/pact-of-the-chain'}]
    desc = ["You can communicate telepathically with your familiar and perceive through your familiar's senses as long as you are on the same plane of existence.", "Additionally, while perceiving through your familiar's senses, you can also speak through your familiar in your own voice, even if your familiar is normally incapable of speech."]
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-voice-of-the-chain-master'
class eldritch_invocation_whispers_of_the_grave():
...
class eldritch_invocation_witch_sight():
    index = 'eldritch-invocation-witch-sight'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Eldritch Invocation: Witch Sight'
    level = 15
    prerequisites = [{'type': 'level', 'level': 15}]
    desc = ['You can see the true form of any shapechanger or creature concealed by illusion or transmutation magic while the creature is within 30 feet of you and within line of sight.']
    parent = {'index': 'eldritch-invocations', 'name': 'Eldritch Invocations', 'url': '/api/features/eldritch-invocations'}
    url = '/api/features/eldritch-invocation-witch-sight'
class eldritch_invocations():
    ...
    feature_specific = {'invocations': [{'index': 'eldritch-invocation-agonizing-blast', 'name': 'Eldritch Invocation: Agonizing Blast', 'url': '/api/features/eldritch-invocation-agonizing-blast'}, {'index': 'eldritch-invocation-armor-of-shadows', 'name': 'Eldritch Invocation: Armor of Shadows', 'url': '/api/features/eldritch-invocation-armor-of-shadows'}, {'index': 'eldritch-invocation-beast-speech', 'name': 'Eldritch Invocation: Beast Speech', 'url': '/api/features/eldritch-invocation-beast-speech'}, {'index': 'eldritch-invocation-beguiling-influence', 'name': 'Eldritch Invocation: Beguiling Influence', 'url': '/api/features/eldritch-invocation-beguiling-influence'}, {'index': 'eldritch-invocation-book-of-ancient-secrets', 'name': 'Eldritch Invocation: Book of Ancient Secrets', 'url': '/api/features/eldritch-invocation-book-of-ancient-secrets'}, {'index': 'eldritch-invocation-devils-sight', 'name': "Eldritch Invocation: Devil's Sight", 'url': '/api/features/eldritch-invocation-devils-sight'}, {'index': 'eldritch-invocation-eldritch-sight', 'name': 'Eldritch Invocation: Eldritch Sight', 'url': '/api/features/eldritch-invocation-eldritch-sight'}, {'index': 'eldritch-invocation-eldritch-spear', 'name': 'Eldritch Invocation: Eldritch Spear', 'url': '/api/features/eldritch-invocation-eldritch-spear'}, {'index': 'eldritch-invocation-eyes-of-the-rune-keeper', 'name': 'Eldritch Invocation: Eyes of the Rune Keeper', 'url': '/api/features/eldritch-invocation-eyes-of-the-rune-keeper'}, {'index': 'eldritch-invocation-fiendish-vigor', 'name': 'Eldritch Invocation: Fiendish Vigor', 'url': '/api/features/eldritch-invocation-fiendish-vigor'}, {'index': 'eldritch-invocation-gaze-of-two-minds', 'name': 'Eldritch Invocation: Gaze of Two Minds', 'url': '/api/features/eldritch-invocation-gaze-of-two-minds'}, {'index': 'eldritch-invocation-mask-of-many-faces', 'name': 'Eldritch Invocation: Mask of Many Faces', 'url': '/api/features/eldritch-invocation-mask-of-many-faces'}, {'index': 'eldritch-invocation-misty-visions', 'name': 'Eldritch Invocation: Misty Visions', 'url': '/api/features/eldritch-invocation-misty-visions'}, {'index': 'eldritch-invocation-repelling-blast', 'name': 'Eldritch Invocation: Repelling Blast', 'url': '/api/features/eldritch-invocation-repelling-blast'}, {'index': 'eldritch-invocation-thief-of-five-fates', 'name': 'Eldritch Invocation: Thief of Five Fates', 'url': '/api/features/eldritch-invocation-thief-of-five-fates'}, {'index': 'eldritch-invocation-voice-of-the-chain-master', 'name': 'Eldritch Invocation: Voice of the Chain Master', 'url': '/api/features/eldritch-invocation-voice-of-the-chain-master'}, {'index': 'eldritch-invocation-mire-the-mind', 'name': 'Eldritch Invocation: Mire the Mind', 'url': '/api/features/eldritch-invocation-mire-the-mind'}, {'index': 'eldritch-invocation-one-with-shadows', 'name': 'Eldritch Invocation: One with Shadows', 'url': '/api/features/eldritch-invocation-one-with-shadows'}, {'index': 'eldritch-invocation-sign-of-ill-omen', 'name': 'Eldritch Invocation: Sign of Ill Omen', 'url': '/api/features/eldritch-invocation-sign-of-ill-omen'}, {'index': 'eldritch-invocation-thirsting-blade', 'name': 'Eldritch Invocation: Thirsting Blade', 'url': '/api/features/eldritch-invocation-thirsting-blade'}, {'index': 'eldritch-invocation-bewitching-whispers', 'name': 'Eldritch Invocation: Bewitching Whispers', 'url': '/api/features/eldritch-invocation-bewitching-whispers'}, {'index': 'eldritch-invocation-dreadful-word', 'name': 'Eldritch Invocation: Dreadful Word', 'url': '/api/features/eldritch-invocation-dreadful-word'}, {'index': 'eldritch-invocation-sculptor-of-flesh', 'name': 'Eldritch Invocation: Sculptor of Flesh', 'url': '/api/features/eldritch-invocation-sculptor-of-flesh'}, {'index': 'eldritch-invocation-ascendant-step', 'name': 'Eldritch Invocation: Ascendant Step', 'url': '/api/features/eldritch-invocation-ascendant-step'}, {'index': 'eldritch-invocation-minions-of-chaos', 'name': 'Eldritch Invocation: Minions of Chaos', 'url': '/api/features/eldritch-invocation-minions-of-chaos'}, {'index': 'eldritch-invocation-otherworldly-leap', 'name': 'Eldritch Invocation: Otherworldly Leap', 'url': '/api/features/eldritch-invocation-otherworldly-leap'}, {'index': 'eldritch-invocation-whispers-of-the-grave', 'name': 'Eldritch Invocation: Whispers of the Grave', 'url': '/api/features/eldritch-invocation-whispers-of-the-grave'}, {'index': 'eldritch-invocation-lifedrinker', 'name': 'Eldritch Invocation: Lifedrinker', 'url': '/api/features/eldritch-invocation-lifedrinker'}, {'index': 'eldritch-invocation-chains-of-carceri', 'name': 'Eldritch Invocation: Chains of Carceri', 'url': '/api/features/eldritch-invocation-chains-of-carceri'}, {'index': 'eldritch-invocation-master-of-myriad-forms', 'name': 'Eldritch Invocation: Master of Myriad Forms', 'url': '/api/features/eldritch-invocation-master-of-myriad-forms'}, {'index': 'eldritch-invocation-visions-of-distant-realms', 'name': 'Eldritch Invocation: Visions of Distant Realms', 'url': '/api/features/eldritch-invocation-visions-of-distant-realms'}, {'index': 'eldritch-invocation-witch-sight', 'name': 'Eldritch Invocation: Witch Sight', 'url': '/api/features/eldritch-invocation-witch-sight'}]}
    url = '/api/features/eldritch-invocations'
class eldritch_master():
...
class empowered_evocation():
    index = 'empowered-evocation'
    class_ = {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}
    subclass = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/subclasses/evocation'}
...
class fast_hands():
    index = 'fast-hands'
    class_ = {'index': 'rogue', 'name': 'Rogue', 'url': '/api/classes/rogue'}
    subclass = {'index': 'thief', 'name': 'Thief', 'url': '/api/subclasses/thief'}
    name = 'Fast Hands'
    level = 3
    prerequisites = []
...
class feral_instinct():
    index = 'feral-instinct'
    class_ = {'index': 'barbarian', 'name': 'Barbarian', 'url': '/api/classes/barbarian'}
    name = 'Feral Instinct'
    level = 7
    prerequisites = []
    desc = ['By 7th level, your instincts are so honed that you have advantage on initiative rolls.', "Additionally, if you are surprised at the beginning of combat and aren't incapacitated, you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn."]
...
class fighter_ability_score_improvement_1():
...
class fighter_ability_score_improvement_2():
...
class fighter_ability_score_improvement_3():
...
class fighter_ability_score_improvement_4():
...
class fighter_ability_score_improvement_5():
...
class fighter_ability_score_improvement_6():
...
class fighter_ability_score_improvement_7():
...
class fighter_fighting_style_archery():
    ...
    parent = {'index': 'fighter-fighting-style', 'name': 'Fighting Style', 'url': '/api/features/fighter-fighting-style'}
    url = '/api/features/fighter-fighting-style-archery'
class fighter_fighting_style_defense():
...
class fighter_fighting_style_dueling():
...
class fighter_fighting_style_great_weapon_fighting():
...
class fighter_fighting_style_protection():
...
class fighter_fighting_style_two_weapon_fighting():
...
class fighting_style_defense():
    ...
    prerequisites = []
    desc = ['While you are wearing armor, you gain a +1 bonus to AC.']
    parent = {'index': 'paladin-fighting-style', 'name': 'Fighting Style', 'url': '/api/features/paladin-fighting-style'}
    url = '/api/features/fighting-style-defense'
class fighting_style_dueling():
...
class fighting_style_great_weapon_fighting():
...
class fighting_style_protection():
...
class flexible_casting_converting_spell_slot():
...
class hunters_prey_colossus_slayer():
    ...
    parent = {'index': 'hunters-prey', 'name': "Hunter's Prey", 'url': '/api/features/hunters-prey'}
    url = '/api/features/hunters-prey-colossus-slayer'
class hunters_prey_giant_killer():
...
class hunters_prey_horde_breaker():
...
class hunters_prey():
    ...
    level = 3
    prerequisites = []
    desc = ['At 3rd level, you gain one of the following features of your choice.', 'Colossus Slayer', 'Giant Killer', 'Horde Breaker']
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'hunters-prey-colossus-slayer', 'name': "Hunter's Prey: Colossus Slayer", 'url': '/api/features/hunters-prey-colossus-slayer'}}, {'option_type': 'reference', 'item': {'index': 'hunters-prey-giant-killer', 'name': "Hunter's Prey: Giant Killer", 'url': '/api/features/hunters-prey-giant-killer'}}, {'option_type': 'reference', 'item': {'index': 'hunters-prey-horde-breaker', 'name': "Hunter's Prey: Horde Breaker", 'url': '/api/features/hunters-prey-horde-breaker'}}]}}, 'invocations': []}
    url = '/api/features/hunters-prey'
class hurl_through_hell():
...
class ki():
    ...
    level = 2
    prerequisites = []
    desc = ['Starting at 2nd level, your training allows you to harness the mystic energy of ki. Your access to this energy is represented by a number of ki points. Your monk level determines the number of points you have, as shown in the Ki Points column of Table: The Monk.', 'You can spend these points to fuel various ki features. You start knowing three such features: Flurry of Blows, Patient Defense, and Step of the Wind. You learn more ki features as you gain levels in this class.', 'When you spend a ki point, it is unavailable until you finish a short or long rest, at the end of which you draw all of your expended ki back into yourself. You must spend at least 30 minutes of the rest meditating to regain your ki points.', "Some of your ki features require your target to make a saving throw to resist the feature's effects. The saving throw DC is calculated as follows:", 'Ki save DC = 8 + your proficiency bonus + your Wisdom modifier']
    url = '/api/features/ki'
class lay_on_hands():
    index = 'lay-on-hands'
    class_ = {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}
    ...
    level = 1
    prerequisites = []
    desc = ['Your blessed touch can heal wounds. You have a pool of healing power that replenishes when you take a long rest. With that pool, you can restore a total number of hit points equal to your paladin level x 5.', 'As an action, you can touch a creature and draw power from the pool to restore a number of hit points to that creature, up to the maximum amount remaining in your pool.', 'Alternatively, you can expend 5 hit points from your pool of healing to cure the target of one disease or neutralize one poison affecting it. You can cure multiple diseases and neutralize multiple poisons with a single use of Lay on Hands, expending hit points separately for each one.', 'This feature has no effect on undead and constructs.']
    url = '/api/features/lay-on-hands'
class magical_secrets_1():
...
class metamagic_1():
    ...
    level = 3
    prerequisites = []
    desc = ['At 3rd level, you gain the ability to twist your spells to suit your needs. You gain two of the following Metamagic options of your choice. You gain another one at 10th and 17th level.', 'You can use only one Metamagic option on a spell when you cast it, unless otherwise noted.']
    feature_specific = {'subfeature_options': {'choose': 2, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'metamagic-careful-spell', 'name': 'Metamagic: Careful Spell', 'url': '/api/features/metamagic-careful-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-distant-spell', 'name': 'Metamagic: Distant Spell', 'url': '/api/features/metamagic-distant-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-empowered-spell', 'name': 'Metamagic: Empowered Spell', 'url': '/api/features/metamagic-empowered-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-extended-spell', 'name': 'Metamagic: Extended Spell', 'url': '/api/features/metamagic-extended-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-heightened-spell', 'name': 'Metamagic: Heightened Spell', 'url': '/api/features/metamagic-heightened-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-quickened-spell', 'name': 'Metamagic: Quickened Spell', 'url': '/api/features/metamagic-quickened-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-subtle-spell', 'name': 'Metamagic: Subtle Spell', 'url': '/api/features/metamagic-subtle-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-twinned-spell', 'name': 'Metamagic: Twinned Spell', 'url': '/api/features/metamagic-twinned-spell'}}]}}, 'invocations': []}
...
class metamagic_2():
    ...
    prerequisites = []
    desc = ['At 3rd level, you gain the ability to twist your spells to suit your needs. You gain two of the following Metamagic options of your choice. You gain another one at 10th and 17th level.', 'You can use only one Metamagic option on a spell when you cast it, unless otherwise noted.']
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'metamagic-careful-spell', 'name': 'Metamagic: Careful Spell', 'url': '/api/features/metamagic-careful-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-distant-spell', 'name': 'Metamagic: Distant Spell', 'url': '/api/features/metamagic-distant-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-empowered-spell', 'name': 'Metamagic: Empowered Spell', 'url': '/api/features/metamagic-empowered-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-extended-spell', 'name': 'Metamagic: Extended Spell', 'url': '/api/features/metamagic-extended-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-heightened-spell', 'name': 'Metamagic: Heightened Spell', 'url': '/api/features/metamagic-heightened-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-quickened-spell', 'name': 'Metamagic: Quickened Spell', 'url': '/api/features/metamagic-quickened-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-subtle-spell', 'name': 'Metamagic: Subtle Spell', 'url': '/api/features/metamagic-subtle-spell'}}, {'option_type': 'reference', 'item': {'index': 'metamagic-twinned-spell', 'name': 'Metamagic: Twinned Spell', 'url': '/api/features/metamagic-twinned-spell'}}]}}, 'invocations': []}
...
class metamagic_careful_spell():
    ...
    parent = {'index': 'metamagic-1', 'name': 'Metamagic', 'url': '/api/features/metamagic-1'}
    url = '/api/features/metamagic-careful-spell'
class metamagic_distant_spell():
    index = 'metamagic-distant-spell'
    class_ = {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}
    name = 'Metamagic: Distant Spell'
    level = 3
    prerequisites = []
    desc = ['When you cast a spell that has a range of 5 feet or greater, you can spend 1 sorcery point to double the range of the spell.', 'When you cast a spell that has a range of touch, you can spend 1 sorcery point to make the range of the spell 30 feet.']
    parent = {'index': 'metamagic-1', 'name': 'Metamagic', 'url': '/api/features/metamagic-1'}
    url = '/api/features/metamagic-distant-spell'
class metamagic_empowered_spell():
    index = 'metamagic-empowered-spell'
    class_ = {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}
    name = 'Metamagic: Empowered Spell'
    level = 3
    prerequisites = []
    desc = ['When you roll damage for a spell, you can spend 1 sorcery point to reroll a number of the damage dice up to your Charisma modifier (minimum of one). You must use the new rolls.', 'You can use Empowered Spell even if you have already used a different Metamagic option during the casting of the spell.']
    parent = {'index': 'metamagic-1', 'name': 'Metamagic', 'url': '/api/features/metamagic-1'}
    url = '/api/features/metamagic-empowered-spell'
class metamagic_extended_spell():
...
class metamagic_heightened_spell():
    index = 'metamagic-heightened-spell'
    class_ = {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}
    name = 'Metamagic: Heightened Spell'
    level = 3
    prerequisites = []
    desc = ['When you cast a spell that forces a creature to make a saving throw to resist its effects, you can spend 3 sorcery points to give one target of the spell disadvantage on its first saving throw made against the spell.']
    parent = {'index': 'metamagic-1', 'name': 'Metamagic', 'url': '/api/features/metamagic-1'}
    url = '/api/features/metamagic-heightened-spell'
class metamagic_quickened_spell():
    index = 'metamagic-quickened-spell'
    class_ = {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}
    name = 'Metamagic: Quickened Spell'
    level = 3
    prerequisites = []
    desc = ['When you cast a spell that has a casting time of 1 action, you can spend 2 sorcery points to change the casting time to 1 bonus action for this casting.']
    parent = {'index': 'metamagic-1', 'name': 'Metamagic', 'url': '/api/features/metamagic-1'}
    url = '/api/features/metamagic-quickened-spell'
class metamagic_subtle_spell():
    index = 'metamagic-subtle-spell'
    class_ = {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}
    name = 'Metamagic: Subtle Spell'
    level = 3
    prerequisites = []
    desc = ['When you cast a spell, you can spend 1 sorcery point to cast it without any somatic or verbal components.']
    parent = {'index': 'metamagic-1', 'name': 'Metamagic', 'url': '/api/features/metamagic-1'}
    url = '/api/features/metamagic-subtle-spell'
class metamagic_twinned_spell():
...
class monk_ability_score_improvement_1():
...
class monk_ability_score_improvement_2():
...
class monk_ability_score_improvement_3():
...
class monk_ability_score_improvement_4():
...
class monk_ability_score_improvement_5():
...
class multiattack_volley():
    ...
    parent = {'index': 'multiattack', 'name': 'Multiattack', 'url': '/api/features/multiattack'}
    url = '/api/features/multiattack-volley'
class multiattack_whirlwind_attack():
    ...
    level = 11
    prerequisites = []
    desc = ['You can use your action to make a melee attack against any number of creatures within 5 feet of you, with a separate attack roll for each target.']
    parent = {'index': 'multiattack', 'name': 'Multiattack', 'url': '/api/features/multiattack'}
...
class multiattack():
    ...
    level = 11
    prerequisites = []
    desc = ['At 11th level, you gain one of the following features of your choice.', 'Volley', 'Whirlwind Attack']
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'multiattack-volley', 'name': 'Multiattack: Volley', 'url': '/api/features/multiattack-volley'}}, {'option_type': 'reference', 'item': {'index': 'multiattack-whirlwind-attack', 'name': 'Multiattack: Whirlwind Attack', 'url': '/api/features/multiattack-whirlwind-attack'}}]}}, 'invocations': []}
    url = '/api/features/multiattack'
class mystic_arcanum_6th_level():
    index = 'mystic-arcanum-6th-level'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Mystic Arcanum (6th level)'
    level = 11
    prerequisites = []
    desc = ['At 11th level, your patron bestows upon you a magical secret called an arcanum. Choose one 6th- level spell from the warlock spell list as this arcanum.', 'You can cast your arcanum spell once without expending a spell slot. You must finish a long rest before you can do so again.', 'At higher levels, you gain more warlock spells of your choice that can be cast in this way: one 7th- level spell at 13th level, one 8th-level spell at 15th level, and one 9th-level spell at 17th level. You regain all uses of your Mystic Arcanum when you finish a long rest.']
    url = '/api/features/mystic-arcanum-6th-level'
class mystic_arcanum_7th_level():
...
class mystic_arcanum_8th_level():
...
class mystic_arcanum_9th_level():
...
class natural_explorer_1_terrain_type():
...
class natural_explorer_2_terrain_types():
...
class natural_explorer_3_terrain_types():
...
class pact_boon():
    ...
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'pact-of-the-chain', 'name': 'Pact of the Chain', 'url': '/api/features/pact-of-the-chain'}}, {'option_type': 'reference', 'item': {'index': 'pact-of-the-blade', 'name': 'Pact of the Blade', 'url': '/api/features/pact-of-the-blade'}}, {'option_type': 'reference', 'item': {'index': 'pact-of-the-tome', 'name': 'Pact of the Tome', 'url': '/api/features/pact-of-the-tome'}}]}}, 'invocations': []}
...
class pact_magic():
    ...
    reference = '/api/classes/warlock/spellcasting'
    url = '/api/features/pact-magic'
class pact_of_the_blade():
    index = 'pact-of-the-blade'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Pact of the Blade'
    level = 3
    prerequisites = []
    desc = ['You can use your action to create a pact weapon in your empty hand. You can choose the form that this melee weapon takes each time you create it. You are proficient with it while you wield it. This weapon counts as magical for the purpose of overcoming resistance and immunity to nonmagical attacks and damage.', 'Your pact weapon disappears if it is more than 5 feet away from you for 1 minute or more. It also disappears if you use this feature again, if you dismiss the weapon (no action required), or if you die.', "You can transform one magic weapon into your pact weapon by performing a special ritual while you hold the weapon. You perform the ritual over the course of 1 hour, which can be done during a short rest. You can then dismiss the weapon, shunting it into an extradimensional space, and it appears whenever you create your pact weapon thereafter. You can't affect an artifact or a sentient weapon in this way. The weapon ceases being your pact weapon if you die, if you perform the 1-hour ritual on a different weapon, or if you use a 1-hour ritual to break your bond to it. The weapon appears at your feet if it is in the extradimensional space when the bond breaks.", 'If you serve the Fiend, your weapon could be an axe made of black metal and adorned with decorative flames.']
    parent = {'index': 'pact-boon', 'name': 'Pact Boon', 'url': '/api/features/pact-boon'}
    url = '/api/features/pact-of-the-blade'
class pact_of_the_chain():
    index = 'pact-of-the-chain'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Pact of the Chain'
    level = 3
    prerequisites = []
    desc = ["You learn the find familiar spell and can cast it as a ritual. The spell doesn't count against your number of spells known.", 'When you cast the spell, you can choose one of the normal forms for your familiar or one of the following special forms: imp, pseudodragon, quasit, or sprite.', 'Additionally, when you take the Attack action, you can forgo one of your own attacks to allow your familiar to make one attack of its own with its reaction.', 'Your familiar is more cunning than a typical familiar. Its default form can be a reflection of your patron, with imps and quasits tied to the Fiend.']
    parent = {'index': 'pact-boon', 'name': 'Pact Boon', 'url': '/api/features/pact-boon'}
    url = '/api/features/pact-of-the-chain'
class pact_of_the_tome():
    index = 'pact-of-the-tome'
    class_ = {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}
    name = 'Pact of the Tome'
    level = 3
    prerequisites = []
    desc = ["Your patron gives you a grimoire called a Book of Shadows. When you gain this feature, choose three cantrips from any class's spell list (the three needn't be from the same list). While the book is on your person, you can cast those cantrips at will. They don't count against your number of cantrips known. If they don't appear on the warlock spell list, they are nonetheless warlock spells for you.", 'If you lose your Book of Shadows, you can perform a 1-hour ceremony to receive a replacement from your patron. This ceremony can be performed during a short or long rest, and it destroys the previous book. The book turns to ash when you die.', 'Your Book of Shadows could be a weighty tome bound in demon hide studded with iron, holding spells of conjuration and a wealth of forbidden lore about the sinister regions of the cosmos, a gift of the Fiend.']
    parent = {'index': 'pact-boon', 'name': 'Pact Boon', 'url': '/api/features/pact-boon'}
    url = '/api/features/pact-of-the-tome'
class paladin_ability_score_improvement_1():
...
class paladin_ability_score_improvement_2():
...
class paladin_ability_score_improvement_3():
...
class paladin_ability_score_improvement_4():
...
class paladin_ability_score_improvement_5():
...
class paladin_fighting_style():
    ...
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'fighting-style-defense', 'name': 'Fighting Style: Defense', 'url': '/api/features/fighting-style-defense'}}, {'option_type': 'reference', 'item': {'index': 'fighting-style-dueling', 'name': 'Fighting Style: Dueling', 'url': '/api/features/fighting-style-dueling'}}, {'option_type': 'reference', 'item': {'index': 'fighting-style-great-weapon-fighting', 'name': 'Fighting Style: Great Weapon Fighting', 'url': '/api/features/fighting-style-great-weapon-fighting'}}, {'option_type': 'reference', 'item': {'index': 'fighting-style-protection', 'name': 'Fighting Style: Protection', 'url': '/api/features/fighting-style-protection'}}]}}, 'invocations': []}
    url = '/api/features/paladin-fighting-style'
class patient_defense():
...
class ranger_ability_score_improvement_1():
...
class ranger_ability_score_improvement_2():
...
class ranger_ability_score_improvement_3():
...
class ranger_ability_score_improvement_4():
...
class ranger_ability_score_improvement_5():
...
class ranger_fighting_style_archery():
    ...
    prerequisites = []
    desc = ['You gain a +2 bonus to attack rolls you make with ranged weapons.']
    parent = {'index': 'ranger-fighting-style', 'name': 'Fighting Style', 'url': '/api/features/ranger-fighting-style'}
    url = '/api/features/ranger-fighting-style-archery'
class ranger_fighting_style_defense():
...
class ranger_fighting_style_dueling():
...
class ranger_fighting_style_two_weapon_fighting():
...
class ranger_fighting_style():
    ...
    feature_specific = {'subfeature_options': {'choose': 1, 'type': 'feature', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'ranger-fighting-style-archery', 'name': 'Fighting Style: Archery', 'url': '/api/features/ranger-fighting-style-archery'}}, {'option_type': 'reference', 'item': {'index': 'ranger-fighting-style-defense', 'name': 'Fighting Style: Defense', 'url': '/api/features/ranger-fighting-style-defense'}}, {'option_type': 'reference', 'item': {'index': 'ranger-fighting-style-dueling', 'name': 'Fighting Style: Dueling', 'url': '/api/features/ranger-fighting-style-dueling'}}, {'option_type': 'reference', 'item': {'index': 'ranger-fighting-style-two-weapon-fighting', 'name': 'Fighting Style: Two-Weapon Fighting', 'url': '/api/features/ranger-fighting-style-two-weapon-fighting'}}]}}, 'invocations': []}
    url = '/api/features/ranger-fighting-style'
class ranger_lands_stride():
    index = 'ranger-lands-stride'
    class_ = {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}
    name = 'Land\'s Stride'
    level = 8
    prerequisites = []
    desc = ['Starting at 8th level, moving through nonmagical difficult terrain costs you no extra movement. You can also pass through nonmagical plants without being slowed by them and without taking damage from them if they have thorns, spines, or a similar hazard.', 'In addition, you have advantage on saving throws against plants that are magically created or manipulated to impede movement, such those created by the entangle spell.']
...
class rogue_ability_score_improvement_1():
...
class rogue_ability_score_improvement_2():
...
class rogue_ability_score_improvement_3():
...
class rogue_ability_score_improvement_4():
...
class rogue_ability_score_improvement_5():
...
class rogue_ability_score_improvement_6():
...
class rogue_expertise_1():
    ...
    feature_specific = {'expertise_options': {'choose': 1, 'type': 'proficiency', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'choice', 'choice': {'choose': 2, 'type': 'proficiency', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'skill-acrobatics', 'name': 'Skill: Acrobatics', 'url': '/api/proficiencies/skill-acrobatics'}}, {'option_type': 'reference', 'item': {'index': 'skill-animal-handling', 'name': 'Skill: Animal Handling', 'url': '/api/proficiencies/skill-animal-handling'}}, {'option_type': 'reference', 'item': {'index': 'skill-arcana', 'name': 'Skill: Arcana', 'url': '/api/proficiencies/skill-arcana'}}, {'option_type': 'reference', 'item': {'index': 'skill-athletics', 'name': 'Skill: Athletics', 'url': '/api/proficiencies/skill-athletics'}}, {'option_type': 'reference', 'item': {'index': 'skill-deception', 'name': 'Skill: Deception', 'url': '/api/proficiencies/skill-deception'}}, {'option_type': 'reference', 'item': {'index': 'skill-history', 'name': 'Skill: History', 'url': '/api/proficiencies/skill-history'}}, {'option_type': 'reference', 'item': {'index': 'skill-insight', 'name': 'Skill: Insight', 'url': '/api/proficiencies/skill-insight'}}, {'option_type': 'reference', 'item': {'index': 'skill-intimidation', 'name': 'Skill: Intimidation', 'url': '/api/proficiencies/skill-intimidation'}}, {'option_type': 'reference', 'item': {'index': 'skill-investigation', 'name': 'Skill: Investigation', 'url': '/api/proficiencies/skill-investigation'}}, {'option_type': 'reference', 'item': {'index': 'skill-medicine', 'name': 'Skill: Medicine', 'url': '/api/proficiencies/skill-medicine'}}, {'option_type': 'reference', 'item': {'index': 'skill-nature', 'name': 'Skill: Nature', 'url': '/api/proficiencies/skill-nature'}}, {'option_type': 'reference', 'item': {'index': 'skill-perception', 'name': 'Skill: Perception', 'url': '/api/proficiencies/skill-perception'}}, {'option_type': 'reference', 'item': {'index': 'skill-performance', 'name': 'Skill: Performance', 'url': '/api/proficiencies/skill-performance'}}, {'option_type': 'reference', 'item': {'index': 'skill-persuasion', 'name': 'Skill: Persuasion', 'url': '/api/proficiencies/skill-persuasion'}}, {'option_type': 'reference', 'item': {'index': 'skill-religion', 'name': 'Skill: Religion', 'url': '/api/proficiencies/skill-religion'}}, {'option_type': 'reference', 'item': {'index': 'skill-sleight-of-hand', 'name': 'Skill: Sleight of Hand', 'url': '/api/proficiencies/skill-sleight-of-hand'}}, {'option_type': 'reference', 'item': {'index': 'skill-stealth', 'name': 'Skill: Stealth', 'url': '/api/proficiencies/skill-stealth'}}, {'option_type': 'reference', 'item': {'index': 'skill-survival', 'name': 'Skill: Survival', 'url': '/api/proficiencies/skill-survival'}}]}}}, {'option_type': 'multiple', 'items': [{'option_type': 'choice', 'choice': {'choose': 1, 'type': 'proficiency', 'from': {'option_set_type': 'options_array', 'options': [{'option_type': 'reference', 'item': {'index': 'skill-acrobatics', 'name': 'Skill: Acrobatics', 'url': '/api/proficiencies/skill-acrobatics'}}, {'option_type': 'reference', 'item': {'index': 'skill-animal-handling', 'name': 'Skill: Animal Handling', 'url': '/api/proficiencies/skill-animal-handling'}}, {'option_type': 'reference', 'item': {'index': 'skill-arcana', 'name': 'Skill: Arcana', 'url': '/api/proficiencies/skill-arcana'}}, {'option_type': 'reference', 'item': {'index': 'skill-athletics', 'name': 'Skill: Athletics', 'url': '/api/proficiencies/skill-athletics'}}, {'option_type': 'reference', 'item': {'index': 'skill-deception', 'name': 'Skill: Deception', 'url': '/api/proficiencies/skill-deception'}}, {'option_type': 'reference', 'item': {'index': 'skill-history', 'name': 'Skill: History', 'url': '/api/proficiencies/skill-history'}}, {'option_type': 'reference', 'item': {'index': 'skill-insight', 'name': 'Skill: Insight', 'url': '/api/proficiencies/skill-insight'}}, {'option_type': 'reference', 'item': {'index': 'skill-intimidation', 'name': 'Skill: Intimidation', 'url': '/api/proficiencies/skill-intimidation'}}, {'option_type': 'reference', 'item': {'index': 'skill-investigation', 'name': 'Skill: Investigation', 'url': '/api/proficiencies/skill-investigation'}}, {'option_type': 'reference', 'item': {'index': 'skill-medicine', 'name': 'Skill: Medicine', 'url': '/api/proficiencies/skill-medicine'}}, {'option_type': 'reference', 'item': {'index': 'skill-nature', 'name': 'Skill: Nature', 'url': '/api/proficiencies/skill-nature'}}, {'option_type': 'reference', 'item': {'index': 'skill-perception', 'name': 'Skill: Perception', 'url': '/api/proficiencies/skill-perception'}}, {'option_type': 'reference', 'item': {'index': 'skill-performance', 'name': 'Skill: Performance', 'url': '/api/proficiencies/skill-performance'}}, {'option_type': 'reference', 'item': {'index': 'skill-persuasion', 'name': 'Skill: Persuasion', 'url': '/api/proficiencies/skill-persuasion'}}, {'option_type': 'reference', 'item': {'index': 'skill-religion', 'name': 'Skill: Religion', 'url': '/api/proficiencies/skill-religion'}}, {'option_type': 'reference', 'item': {'index': 'skill-sleight-of-hand', 'name': 'Skill: Sleight of Hand', 'url': '/api/proficiencies/skill-sleight-of-hand'}}, {'option_type': 'reference', 'item': {'index': 'skill-stealth', 'name': 'Skill: Stealth', 'url': '/api/proficiencies/skill-stealth'}}, {'option_type': 'reference', 'item': {'index': 'skill-survival', 'name': 'Skill: Survival', 'url': '/api/proficiencies/skill-survival'}}]}}}, {'option_type': 'reference', 'item': {'index': 'thieves-tools', 'name': "Thieves' Tools", 'url': '/api/proficiencies/thieves-tools'}}]}]}}, 'invocations': []}
    url = '/api/features/rogue-expertise-1'
class rogue_expertise_2():
...
class sorcerer_ability_score_improvement_1():
...
class sorcerer_ability_score_improvement_2():
...
class sorcerer_ability_score_improvement_3():
...
class sorcerer_ability_score_improvement_4():
...
class sorcerer_ability_score_improvement_5():
...
class sorcerous_origin():
    index = 'sorcerous-origin'
    class_ = {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}
    name = 'Sorcerous Origin'
    level = 1
    prerequisites = []
    desc = ['Choose a sorcerous origin, which describes the source of your innate magical power, such as Draconic Bloodline.', 'Your choice grants you features when you choose it at 1st level and again at 6th, 14th, and 18th level.']
    url = '/api/features/sorcerous-origin'
class sorcerous_restoration():
...
class spellcasting_bard():
    ...
    reference = '/api/classes/bard/spellcasting'
    url = '/api/features/spellcasting-bard'
class spellcasting_cleric():
    ...
    reference = '/api/classes/cleric/spellcasting'
    url = '/api/features/spellcasting-cleric'
class spellcasting_druid():
    ...
    reference = '/api/classes/druid/spellcasting'
    url = '/api/features/spellcasting-druid'
class spellcasting_paladin():
    ...
    reference = '/api/classes/paladin/spellcasting'
    url = '/api/features/spellcasting-paladin'
class spellcasting_ranger():
    ...
    reference = '/api/classes/ranger/spellcasting'
    url = '/api/features/spellcasting-ranger'
class spellcasting_sorcerer():
    ...
    reference = '/api/classes/sorcerer/spellcasting'
    url = '/api/features/spellcasting-sorcerer'
class spellcasting_wizard():
    ...
    reference = '/api/classes/wizard/spellcasting'
    url = '/api/features/spellcasting-wizard'
class step_of_the_wind():
...
class superior_hunters_defense_evasion():
    ...
    parent = {'index': 'superior-hunters-defense', 'name': "Superior Hunter's Defense", 'url': '/api/features/superior-hunters-defense'}
    url = '/api/features/superior-hunters-defense-evasion'
class superior_hunters_defense_stand_against_the_tide():
...
class superior_hunters_defense_uncanny_dodge():
...
class superior_hunters_defense():
...
class tongue_of_the_sun_and_moon():
...
class warlock_ability_score_improvement_1():
...
class warlock_ability_score_improvement_2():
...
class warlock_ability_score_improvement_3():
...
class warlock_ability_score_improvement_4():
...
class warlock_ability_score_improvement_5():
...
class wild_shape_cr_1_2_or_below_no_flying_speed():
...
class wild_shape_cr_1_4_or_below_no_flying_or_swim_speed():
...
class wild_shape_cr_1_or_below():
...
class wizard_ability_score_improvement_1():
...
class wizard_ability_score_improvement_2():
...
class wizard_ability_score_improvement_3():
...
class wizard_ability_score_improvement_4():
...
class wizard_ability_score_improvement_5():
