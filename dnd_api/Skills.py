entries = ['acrobatics', 'animal_handling', 'arcana', 'athletics', 'deception', 'history', 'insight', 'intimidation', 'investigation', 'medicine', 'nature', 'perception', 'performance', 'persuasion', 'religion', 'sleight_of_hand', 'stealth', 'survival']
attributes = ['index', 'name', 'desc', 'ability_score', 'url']
class acrobatics():
    index = 'acrobatics'
    name = 'Acrobatics'
...
class animal_handling():
    ...
    ability_score = {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}
...
class arcana():
    ...
    ability_score = {'index': 'int', 'name': 'INT', 'url': '/api/ability-scores/int'}
