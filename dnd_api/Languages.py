entries = ['abyssal', 'celestial', 'common', 'deep_speech', 'draconic', 'dwarvish', 'elvish', 'giant', 'gnomish', 'goblin', 'halfling', 'infernal', 'orc', 'primordial', 'sylvan', 'undercommon']
attributes = ['index', 'name', 'type', 'typical_speakers', 'script', 'url', 'desc']
class abyssal():
    index = 'abyssal'
    name = 'Abyssal'
    type = 'Exotic'
