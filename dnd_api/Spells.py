...
class acid_arrow():
    ...
    level = 2
    attack_type = 'ranged'
    damage = {'damage_type': {'index': 'acid', 'name': 'Acid', 'url': '/api/damage-types/acid'}, 'damage_at_slot_level': {'2': '4d4', '3': '5d4', '4': '6d4', '5': '7d4', '6': '8d4', '7': '9d4', '8': '10d4', '9': '11d4'}}
    ...
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class acid_splash():
    ...
    casting_time = '1 action'
    level = 0
    damage = {'damage_type': {'index': 'acid', 'name': 'Acid', 'url': '/api/damage-types/acid'}, 'damage_at_character_level': {'1': '1d6', '5': '2d6', '11': '3d6', '17': '4d6'}}
    ...
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class aid():
    ...
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/aid'
class alarm():
    higher_level = []
    ...
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class alter_self():
    ...
    casting_time = '1 action'
    level = 2
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/alter-self'
class animal_friendship():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 1
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
...
class animate_dead():
    ...
    casting_time = '1 minute'
    level = 3
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/animate-dead'
class animate_objects():
    ...
    level = 5
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/animate-objects'
class antilife_shell():
    higher_level = []
...
class antipathy_sympathy():
    ...
    casting_time = '1 hour'
    level = 8
    area_of_effect = {'type': 'cube', 'size': 200}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class arcane_sword():
    ...
    level = 7
    attack_type = 'melee'
    damage = {'damage_type': {'index': 'force', 'name': 'Force', 'url': '/api/damage-types/force'}, 'damage_at_slot_level': {'7': '3d10'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/arcane-sword'
class arcanists_magic_aura():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 2
    school = {'index': 'illusion', 'name': 'Illusion', 'url': '/api/magic-schools/illusion'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/arcanists-magic-aura'
class astral_projection():
    higher_level = []
    ...
    level = 9
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class awaken():
    ...
    level = 5
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = []
...
class bane():
    ...
    casting_time = '1 action'
    level = 1
    dc = {'dc_type': {'index': 'cha', 'name': 'CHA', 'url': '/api/ability-scores/cha'}, 'dc_success': 'none'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/bane'
class banishment():
    index = 'banishment'
    ...
    dc = {'dc_type': {'index': 'cha', 'name': 'CHA', 'url': '/api/ability-scores/cha'}, 'dc_success': 'none'}
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class barkskin():
    ...
    level = 2
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
    url = '/api/spells/barkskin'
class beacon_of_hope():
    higher_level = []
    ...
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'life', 'name': 'Life', 'url': '/api/subclasses/life'}, {'index': 'devotion', 'name': 'Devotion', 'url': '/api/subclasses/devotion'}]
...
class bestow_curse():
    ...
    casting_time = '1 action'
    level = 3
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none', 'desc': 'On fail, become cursed for the duration of the spell.'}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/bestow-curse'
class black_tentacles():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}, 'damage_at_slot_level': {'4': '3d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'none', 'desc': 'A creature restrained by the tentacles can use its action to make a Strength or Dexterity check (its choice) against your spell save DC. On a success, it frees itself.'}
    area_of_effect = {'type': 'cube', 'size': 20}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class blade_barrier():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'slashing', 'name': 'Slashing', 'url': '/api/damage-types/slashing'}, 'damage_at_slot_level': {'6': '6d10'}}
...
class bless():
    ...
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'life', 'name': 'Life', 'url': '/api/subclasses/life'}]
...
class blight():
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'necrotic', 'name': 'Necrotic', 'url': '/api/damage-types/necrotic'}, 'damage_at_slot_level': {'4': '8d8', '5': '9d8', '6': '10d8', '7': '11d8', '8': '12d8', '9': '13d8'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
    url = '/api/spells/blight'
class blindness_deafness():
    ...
    casting_time = '1 action'
    level = 2
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'none'}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'fiend', 'name': 'Fiend', 'url': '/api/subclasses/fiend'}]
...
class branding_smite():
    ...
    level = 2
    damage = {'damage_type': {'index': 'radiant', 'name': 'Radiant', 'url': '/api/damage-types/radiant'}, 'damage_at_slot_level': {'2': '2d6', '3': '3d6', '4': '4d6', '5': '5d6', '6': '6d6', '7': '7d6', '8': '8d6', '9': '9d6'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
...
class burning_hands():
    ...
    casting_time = '1 action'
    level = 1
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'1': '3d6', '2': '4d6', '3': '5d6', '4': '6d6', '5': '7d6', '6': '8d6', '7': '9d6', '8': '10d6', '9': '11d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
...
class call_lightning():
    ...
    casting_time = '1 action'
    level = 3
    damage = {'damage_type': {'index': 'lightning', 'name': 'Lightning', 'url': '/api/damage-types/lightning'}, 'damage_at_slot_level': {'3': '3d10', '4': '4d10', '5': '5d10', '6': '6d10', '7': '7d10', '8': '8d10', '9': '9d10'}}
...
class chain_lightning():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'lightning', 'name': 'Lightning', 'url': '/api/damage-types/lightning'}, 'damage_at_slot_level': {'6': '10d8'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class charm_person():
    ...
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class chill_touch():
    ...
    level = 0
    attack_type = 'ranged'
    damage = {'damage_type': {'index': 'necrotic', 'name': 'Necrotic', 'url': '/api/damage-types/necrotic'}, 'damage_at_character_level': {'1': '1d8', '5': '2d8', '11': '3d8', '17': '4d8'}}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/chill-touch'
class circle_of_death():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'necrotic', 'name': 'Necrotic', 'url': '/api/damage-types/necrotic'}, 'damage_at_slot_level': {'6': '8d6', '7': '10d6', '8': '12d6', '9': '14d6'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 60}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class cloudkill():
    ...
    casting_time = '1 action'
    level = 5
    damage = {'damage_type': {'index': 'poison', 'name': 'Poison', 'url': '/api/damage-types/poison'}, 'damage_at_slot_level': {'5': '5d8', '6': '6d8', '7': '7d8', '8': '8d8', '9': '9d8'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half', 'desc': "Creatures are affected even if they hold their breath or don't need to breathe."}
    area_of_effect = {'type': 'sphere', 'size': 20}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class commune():
    ...
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'devotion', 'name': 'Devotion', 'url': '/api/subclasses/devotion'}]
    url = '/api/spells/commune'
class comprehend_languages():
    higher_level = []
    ...
    level = 1
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class cone_of_cold():
    ...
    casting_time = '1 action'
    level = 5
    damage = {'damage_type': {'index': 'cold', 'name': 'Cold', 'url': '/api/damage-types/cold'}, 'damage_at_slot_level': {'5': '8d8', '6': '9d8', '7': '10d8', '8': '11d8', '9': '12d8'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half', 'desc': 'A creature killed by this spell becomes a frozen statue until it thaws.'}
...
class confusion():
    ...
    area_of_effect = {'type': 'sphere', 'size': 10}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/confusion'
class conjure_animals():
...
class conjure_fey():
    ...
    level = 6
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}]
    subclasses = []
    url = '/api/spells/conjure-fey'
class conjure_minor_elementals():
...
class contact_other_plane():
    ...
    casting_time = '1 minute'
    level = 5
    dc = {'dc_type': {'index': 'int', 'name': 'INT', 'url': '/api/ability-scores/int'}, 'dc_success': 'other', 'desc': 'On a failure, you take 6d6 psychic damage and are insane until you finish a long rest.'}
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class contagion():
    ...
    level = 5
    attack_type = 'melee'
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'other', 'desc': 'After succeeding on three of these saving throws, the creature recovers from the disease, and the spell ends.'}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = []
...
class control_water():
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}, 'damage_at_slot_level': {'4': '2d8'}}
    dc = {'dc_type': {'index': 'str', 'name': 'STR', 'url': '/api/ability-scores/str'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'cube', 'size': 100}
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/control-water'
class control_weather():
    higher_level = []
...
class create_food_and_water():
    ...
    level = 3
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
    url = '/api/spells/create-food-and-water'
class create_or_destroy_water():
...
class cure_wounds():
    ...
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'life', 'name': 'Life', 'url': '/api/subclasses/life'}]
    url = '/api/spells/cure-wounds'
class dancing_lights():
    higher_level = []
...
class darkvision():
    ...
    level = 2
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class daylight():
    ...
    area_of_effect = {'type': 'sphere', 'size': 60}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class delayed_blast_fireball():
    ...
    casting_time = '1 action'
    level = 7
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'7': '12d6', '8': '13d6', '9': '14d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 20}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class detect_magic():
    ...
    area_of_effect = {'type': 'sphere', 'size': 30}
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/detect-magic'
class detect_poison_and_disease():
    higher_level = []
    ...
    area_of_effect = {'type': 'sphere', 'size': 30}
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/detect-poison-and-disease'
class detect_thoughts():
    higher_level = []
...
class dimension_door():
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'force', 'name': 'Force', 'url': '/api/damage-types/force'}, 'damage_at_slot_level': {'4': '4d6'}}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class disintegrate():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'force', 'name': 'Force', 'url': '/api/damage-types/force'}, 'damage_at_slot_level': {'6': '10d6 + 40'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'none'}
    area_of_effect = {'type': 'cube', 'size': 10}
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class dispel_evil_and_good():
    ...
    casting_time = '1 action'
    level = 5
    dc = {'dc_type': {'index': 'cha', 'name': 'CHA', 'url': '/api/ability-scores/cha'}, 'dc_success': 'other', 'desc': "The creature must succeed on a charisma saving throw or be sent back to its home plane (if it isn't there already)"}
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}]
    subclasses = []
...
class dispel_magic():
    ...
    level = 3
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'devotion', 'name': 'Devotion', 'url': '/api/subclasses/devotion'}]
...
class divine_favor():
    ...
    casting_time = '1 bonus action'
    level = 1
    damage = {'damage_type': {'index': 'radiant', 'name': 'Radiant', 'url': '/api/damage-types/radiant'}, 'damage_at_slot_level': {'1': '1d4'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class divine_word():
    ...
    index = 'divine-word'
    name = 'Divine Word'
    desc = ['You utter a divine word, imbued with the power that shaped the world at the dawn of creation. Choose any number of creatures you can see within range. Each creature that can hear you must make a Charisma saving throw. On a failed save, a creature suffers an effect based on its current hit points:', '- 50 hit points or fewer: deafened for 1 minute', '- 40 hit points or fewer: deafened and blinded for 10 minutes', '- 30 hit points or fewer: blinded, deafened, and stunned for 1 hour', '- 20 hit points or fewer: killed instantly', "Regardless of its current hit points, a celestial, an elemental, a fey, or a fiend that fails its save is forced back to its plane of origin (if it isn't there already) and can't return to your current plane for 24 hours by any means short of a wish spell."]
    range = '30 feet'
    components = ['V']
    ritual = False
    duration = 'Instantaneous'
    ...
    casting_time = '1 bonus action'
    level = 7
    dc = {'dc_type': {'index': 'cha', 'name': 'CHA', 'url': '/api/ability-scores/cha'}, 'dc_success': 'none', 'desc': 'On a failed save, a creature suffers an effect based on its current hit points.'}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = []
    url = '/api/spells/divine-word'
class dominate_beast():
    ...
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}]
    subclasses = []
    url = '/api/spells/dominate-beast'
class dominate_monster():
    ...
    casting_time = '1 action'
    level = 8
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none', 'desc': 'On failure, the creature is charmed by you for the duration.'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/dominate-monster'
class dominate_person():
    ...
    casting_time = '1 action'
    level = 5
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'other', 'desc': 'Each time the target takes damage, it makes a new wisdom saving throw against the spell. If the saving throw succeeds, the spell ends.'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class dream():
    ...
    casting_time = '1 minute'
    level = 5
    damage = {'damage_type': {'index': 'psychic', 'name': 'Psychic', 'url': '/api/damage-types/psychic'}, 'damage_at_slot_level': {'5': '3d6'}}
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none', 'desc': "On a failed save, echoes of the phantasmal monstrosity spawn a nightmare that lasts the duration of the target's sleep and prevents the target from gaining any benefit from that rest."}
    school = {'index': 'illusion', 'name': 'Illusion', 'url': '/api/magic-schools/illusion'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class earthquake():
    ...
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}]
    subclasses = []
    url = '/api/spells/earthquake'
class eldritch_blast():
    higher_level = []
    ...
    level = 0
    attack_type = 'ranged'
    damage = {'damage_type': {'index': 'force', 'name': 'Force', 'url': '/api/damage-types/force'}, 'damage_at_character_level': {'1': '1d10', '5': '1d10', '11': '1d10', '17': '1d10'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/eldritch-blast'
class enhance_ability():
    ...
    level = 2
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/enhance-ability'
class enlarge_reduce():
    higher_level = []
...
class entangle():
    ...
    casting_time = '1 action'
    level = 1
    dc = {'dc_type': {'index': 'str', 'name': 'STR', 'url': '/api/ability-scores/str'}, 'dc_success': 'none'}
    area_of_effect = {'type': 'cube', 'size': 20}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class enthrall():
    ...
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class etherealness():
    ...
    level = 7
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/etherealness'
class expeditious_retreat():
    higher_level = []
...
class faithful_hound():
    ...
    level = 4
    attack_type = 'melee'
    damage = {'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}, 'damage_at_slot_level': {'4': '4d8'}}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class false_life():
    ...
    casting_time = '1 action'
    level = 1
    heal_at_slot_level = {'1': '1d4 + 4', '2': '1d4 + 9', '3': '1d4 + 14', '4': '1d4 + 19', '5': '1d4 + 24', '6': '1d4 + 29', '7': '1d4 + 34', '8': '1d4 + 39', '9': '1d4 + 44'}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class fear():
    ...
    casting_time = '1 action'
    level = 3
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none', 'desc': 'On fail, A creature drop whatever it is holding and become frightened for the duration.'}
...
class feeblemind():
    ...
    casting_time = '1 action'
    level = 8
    damage = {'damage_type': {'index': 'psychic', 'name': 'Psychic', 'url': '/api/damage-types/psychic'}, 'damage_at_slot_level': {'8': '4d6'}}
    dc = {'dc_type': {'index': 'int', 'name': 'INT', 'url': '/api/ability-scores/int'}, 'dc_success': 'other', 'desc': "The target always takes the damage. On a failed save, the creature's Intelligence and Charisma scores become 1."}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class find_the_path():
    ...
    level = 6
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = []
...
class find_traps():
    ...
    level = 2
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/find-traps'
class finger_of_death():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 7
    damage = {'damage_type': {'index': 'necrotic', 'name': 'Necrotic', 'url': '/api/damage-types/necrotic'}, 'damage_at_slot_level': {'7': '7d8 + 30'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class fire_bolt():
    ...
    level = 0
    attack_type = 'ranged'
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_character_level': {'1': '1d10', '5': '2d10', '11': '3d10', '17': '4d10'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class fire_shield():
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'4': '2d8'}}
    area_of_effect = {'type': 'sphere', 'size': 5}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class fire_storm():
    ...
    casting_time = '1 action'
    level = 7
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'7': '7d10'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'cube', 'size': 100}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}]
...
class fireball():
    ...
    casting_time = '1 action'
    level = 3
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'3': '8d6', '4': '9d6', '5': '10d6', '6': '11d6', '7': '12d6', '8': '13d6', '9': '14d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 20}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class flame_blade():
    ...
    casting_time = '1 bonus action'
    level = 2
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'2': '3d6', '4': '4d6', '6': '5d6', '8': '6d6'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class flame_strike():
    ...
    casting_time = '1 action'
    level = 5
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'5': '4d6 + 4d6', '6': '4d6 + 5d6', '7': '4d6 + 6d6', '8': '4d6 + 7d6', '9': '4d6 + 8d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'cylinder', 'size': 40}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'devotion', 'name': 'Devotion', 'url': '/api/subclasses/devotion'}, {'index': 'fiend', 'name': 'Fiend', 'url': '/api/subclasses/fiend'}]
    url = '/api/spells/flame-strike'
class flaming_sphere():
    ...
    casting_time = '1 action'
    level = 2
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'2': '2d6', '3': '3d6', '4': '4d6', '5': '5d6', '6': '6d6', '7': '7d6', '8': '8d6', '9': '9d6'}}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/flaming-sphere'
class flesh_to_stone():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 6
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'none', 'desc': 'On a failed save, the target is restrained as its flesh begins to harden.'}
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class forbiddance():
    ...
    casting_time = '10 minutes'
    level = 6
    area_of_effect = {'type': 'cube', 'size': 40000}
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = []
...
class freedom_of_movement():
    ...
    level = 4
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}]
    subclasses = [{'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}, {'index': 'devotion', 'name': 'Devotion', 'url': '/api/subclasses/devotion'}]
    url = '/api/spells/freedom-of-movement'
class freezing_sphere():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'cold', 'name': 'Cold', 'url': '/api/damage-types/cold'}, 'damage_at_slot_level': {'6': '10d6'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 60}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class gate():
    ...
    level = 9
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/gate'
class geas():
    index = 'geas'
    ...
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/geas'
class gentle_repose():
    higher_level = []
...
class globe_of_invulnerability():
...
class guardian_of_faith():
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'radiant', 'name': 'Radiant', 'url': '/api/damage-types/radiant'}, 'damage_at_slot_level': {'4': '20'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
...
class guards_and_wards():
    ...
    casting_time = '10 minutes'
    level = 6
    area_of_effect = {'type': 'cube', 'size': 2500}
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class guiding_bolt():
    ...
    level = 1
    attack_type = 'ranged'
    damage = {'damage_type': {'index': 'radiant', 'name': 'Radiant', 'url': '/api/damage-types/radiant'}, 'damage_at_slot_level': {'1': '4d6', '2': '5d6', '3': '6d6', '4': '7d6', '5': '8d6', '6': '9d6', '7': '10d6', '8': '11d6', '9': '12d6'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class gust_of_wind():
    ...
    level = 2
    dc = {'dc_type': {'index': 'str', 'name': 'STR', 'url': '/api/ability-scores/str'}, 'dc_success': 'none'}
    area_of_effect = {'type': 'line', 'size': 60}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class hallucinatory_terrain():
    ...
    casting_time = '10 minutes'
    level = 4
    area_of_effect = {'type': 'cube', 'size': 150}
    school = {'index': 'illusion', 'name': 'Illusion', 'url': '/api/magic-schools/illusion'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class harm():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'necrotic', 'name': 'Necrotic', 'url': '/api/damage-types/necrotic'}, 'damage_at_slot_level': {'6': '14d6'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = []
...
class healing_word():
    ...
    casting_time = '1 bonus action'
    level = 1
    heal_at_slot_level = {'1': '1d4 + MOD', '2': '2d4 + MOD', '3': '3d4 + MOD', '4': '4d4 + MOD', '5': '5d4 + MOD', '6': '6d4 + MOD', '7': '7d4 + MOD', '8': '8d4 + MOD', '9': '9d4 + MOD'}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class heat_metal():
    ...
    casting_time = '1 action'
    level = 2
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'2': '2d8', '3': '3d8', '4': '4d8', '5': '5d8', '6': '6d8', '7': '7d8', '8': '8d8', '9': '9d8'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'other', 'desc': 'Can choose to not drop the object'}
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/heat-metal'
class hellish_rebuke():
    ...
    casting_time = '1 reaction'
    level = 1
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'1': '2d10', '2': '3d10', '3': '4d10', '4': '5d10', '5': '6d10', '6': '7d10', '7': '8d10', '8': '9d10', '9': '10d10'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}]
    subclasses = []
...
class heroism():
    ...
    level = 1
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/heroism'
class hideous_laughter():
    higher_level = []
...
class hold_person():
    ...
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class hunters_mark():
    ...
    level = 1
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}]
    subclasses = []
    url = '/api/spells/hunters-mark'
class hypnotic_pattern():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 3
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none', 'desc': 'On a failed save, the creature becomes charmed for the duration.'}
    school = {'index': 'illusion', 'name': 'Illusion', 'url': '/api/magic-schools/illusion'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class ice_storm():
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}, 'damage_at_slot_level': {'4': '2d8 + 4d6', '5': '3d8 + 4d6', '6': '4d8 + 4d6', '7': '5d8 + 4d6', '8': '6d8 + 4d6', '9': '7d8 + 4d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
...
class imprisonment():
    ...
    casting_time = '1 minute'
    level = 9
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none', 'desc': 'If the creature succeeds, it is immune to this spell if you cast it again'}
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/imprisonment'
class incendiary_cloud():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 8
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'8': '10d8'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 20}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class inflict_wounds():
    ...
    level = 1
    attack_type = 'melee'
    damage = {'damage_type': {'index': 'necrotic', 'name': 'Necrotic', 'url': '/api/damage-types/necrotic'}, 'damage_at_slot_level': {'1': '3d10', '2': '4d10', '3': '5d10', '4': '6d10', '5': '7d10', '6': '8d10', '7': '9d10', '8': '10d10', '9': '11d10'}}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class insect_plague():
    ...
    casting_time = '1 action'
    level = 5
    damage = {'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}, 'damage_at_slot_level': {'5': '4d10', '6': '5d10', '7': '6d10', '8': '7d10', '9': '8d10'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 20}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}]
...
class lightning_bolt():
    ...
    casting_time = '1 action'
    level = 3
    damage = {'damage_type': {'index': 'lightning', 'name': 'Lightning', 'url': '/api/damage-types/lightning'}, 'damage_at_slot_level': {'3': '8d6', '4': '9d6', '5': '10d6', '6': '11d6', '7': '12d6', '8': '13d6', '9': '14d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'line', 'size': 100}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class locate_animals_or_plants():
    higher_level = []
...
class locate_creature():
    ...
    level = 4
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class longstrider():
    ...
    level = 1
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class magic_circle():
    ...
    level = 3
    area_of_effect = {'type': 'cylinder', 'size': 10}
    dc = {'dc_type': {'index': 'cha', 'name': 'CHA', 'url': '/api/ability-scores/cha'}, 'dc_success': 'other', 'desc': 'If the creature tries to use teleportation or interplanar travel to do so, it must first succeed on a Charisma saving throw.'}
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class magic_jar():
    ...
    casting_time = '1 minute'
    level = 6
    dc = {'dc_type': {'index': 'cha', 'name': 'CHA', 'url': '/api/ability-scores/cha'}, 'dc_success': 'other', 'desc': "On a failure, your soul moves into the target's body, and the target's soul becomes trapped in the container. On a success, the target resists your efforts to possess it, and you can't attempt to possess it again for 24 hours."}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class magic_missile():
    ...
    casting_time = '1 action'
    level = 1
    damage = {'damage_type': {'index': 'force', 'name': 'Force', 'url': '/api/damage-types/force'}, 'damage_at_slot_level': {'1': '1d4 + 1', '2': '1d4 + 1', '3': '1d4 + 1', '4': '1d4 + 1', '5': '1d4 + 1', '6': '1d4 + 1', '7': '1d4 + 1', '8': '1d4 + 1', '9': '1d4 + 1'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class magic_weapon():
    ...
    level = 2
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/magic-weapon'
class magnificent_mansion():
    higher_level = []
...
class mass_healing_word():
    ...
    casting_time = '1 bonus action'
    level = 3
    heal_at_slot_level = {'3': '1d4 + MOD', '4': '2d4 + MOD', '5': '3d4 + MOD', '6': '4d4 + MOD', '7': '5d4 + MOD', '8': '6d4 + MOD', '9': '7d4 + MOD'}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/mass-healing-word'
class mass_suggestion():
...
class mending():
    ...
    level = 0
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class meteor_swarm():
    ...
    casting_time = '1 action'
    level = 9
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'9': '20d6 + 20d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 40}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class mirage_arcane():
    ...
    casting_time = '10 minutes'
    level = 7
    area_of_effect = {'type': 'cube', 'size': 5280}
    school = {'index': 'illusion', 'name': 'Illusion', 'url': '/api/magic-schools/illusion'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class moonbeam():
    ...
    higher_level = ['When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1dl0 for each slot level above 2nd.']
    range = '120 feet'
    components = ['V', 'S', 'M']
    ...
    casting_time = '1 action'
    level = 2
    damage = {'damage_type': {'index': 'radiant', 'name': 'Radiant', 'url': '/api/damage-types/radiant'}, 'damage_at_slot_level': {'2': '2d10', '3': '3d10', '4': '4d10', '5': '5d10', '6': '6d10', '7': '7d10', '8': '8d10', '9': '9d10'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
...
class move_earth():
    ...
    casting_time = '1 action'
    level = 6
    area_of_effect = {'type': 'cone', 'size': 40}
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class nondetection():
    ...
    level = 3
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/nondetection'
class pass_without_trace():
    higher_level = []
...
class phantasmal_killer():
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'psychic', 'name': 'Psychic', 'url': '/api/damage-types/psychic'}, 'damage_at_slot_level': {'4': '4d10'}}
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
    school = {'index': 'illusion', 'name': 'Illusion', 'url': '/api/magic-schools/illusion'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class planar_binding():
    ...
    dc = {'dc_type': {'index': 'cha', 'name': 'CHA', 'url': '/api/ability-scores/cha'}, 'dc_success': 'none'}
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class plane_shift():
    ...
    level = 7
    attack_type = 'melee'
    dc = {'dc_type': {'index': 'cha', 'name': 'CHA', 'url': '/api/ability-scores/cha'}, 'dc_success': 'none', 'desc': 'If the creature fails this save, it is transported to a random location on the plane of existence you specify. A creature so transported must find its own way back to your current plane of existence.'}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class poison_spray():
    ...
    casting_time = '1 action'
    level = 0
    damage = {'damage_type': {'index': 'poison', 'name': 'Poison', 'url': '/api/damage-types/poison'}, 'damage_at_character_level': {'1': '1d12', '5': '2d12', '11': '3d12', '17': '4d12'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'none'}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = []
...
class prayer_of_healing():
    ...
    casting_time = '10 minutes'
    level = 2
    heal_at_slot_level = {'2': '2d8 + MOD', '3': '3d8 + MOD', '4': '4d8 + MOD', '5': '5d8 + MOD', '6': '6d8 + MOD', '7': '7d8 + MOD', '8': '8d8 + MOD', '9': '9d8 + MOD'}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class prismatic_spray():
    ...
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'other', 'desc': 'For each target, roll a d8 to determine which color ray affects it.'}
    area_of_effect = {'type': 'cone', 'size': 60}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/prismatic-spray'
class prismatic_wall():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 9
    area_of_effect = {'type': 'line', 'size': 90}
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
    url = '/api/spells/prismatic-wall'
class private_sanctum():
...
class produce_flame():
    ...
    level = 0
    attack_type = 'ranged'
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_character_level': {'1': '1d8', '5': '2d8', '11': '3d8', '17': '4d8'}}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/produce-flame'
class programmed_illusion():
    higher_level = []
...
class protection_from_energy():
    ...
    level = 3
    school = {'index': 'abjuration', 'name': 'Abjuration', 'url': '/api/magic-schools/abjuration'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
    url = '/api/spells/protection-from-energy'
class protection_from_evil_and_good():
    higher_level = []
...
class raise_dead():
    ...
    level = 5
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'paladin', 'name': 'Paladin', 'url': '/api/classes/paladin'}]
    subclasses = [{'index': 'life', 'name': 'Life', 'url': '/api/subclasses/life'}]
    url = '/api/spells/raise-dead'
class ray_of_enfeeblement():
    higher_level = []
...
class ray_of_frost():
    ...
    level = 0
    attack_type = 'ranged'
    damage = {'damage_type': {'index': 'cold', 'name': 'Cold', 'url': '/api/damage-types/cold'}, 'damage_at_character_level': {'1': '1d8', '5': '2d8', '11': '3d8', '17': '4d8'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class reverse_gravity():
    ...
    casting_time = '1 action'
    level = 7
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'other', 'desc': 'A creature can make a dexterity saving throw to grab onto a fixed object it can reach, thus avoiding the fall.'}
    area_of_effect = {'type': 'cylinder', 'size': 50}
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class sacred_flame():
    ...
    casting_time = '1 action'
    level = 0
    damage = {'damage_type': {'index': 'radiant', 'name': 'Radiant', 'url': '/api/damage-types/radiant'}, 'damage_at_character_level': {'1': '1d8', '5': '2d8', '11': '3d8', '17': '4d8'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'none'}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class scorching_ray():
    ...
    casting_time = '1 action'
    level = 2
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'2': '2d6'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'fiend', 'name': 'Fiend', 'url': '/api/subclasses/fiend'}]
...
class scrying():
    ...
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
    school = {'index': 'divination', 'name': 'Divination', 'url': '/api/magic-schools/divination'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class shatter():
    ...
    casting_time = '1 action'
    level = 2
    damage = {'damage_type': {'index': 'thunder', 'name': 'Thunder', 'url': '/api/damage-types/thunder'}, 'damage_at_slot_level': {'2': '3d8', '3': '4d8', '4': '5d8', '5': '6d8', '6': '7d8', '7': '8d8', '8': '9d8', '9': '10d8'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 10}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class shocking_grasp():
    ...
    level = 0
    attack_type = 'melee'
    damage = {'damage_type': {'index': 'lightning', 'name': 'Lightning', 'url': '/api/damage-types/lightning'}, 'damage_at_character_level': {'1': '1d8', '5': '2d8', '11': '3d8', '17': '4d8'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
...
class silence():
    ...
    area_of_effect = {'type': 'sphere', 'size': 20}
    school = {'index': 'illusion', 'name': 'Illusion', 'url': '/api/magic-schools/illusion'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class slow():
    ...
    casting_time = '1 action'
    level = 3
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none', 'desc': 'On failed save, the creature is slowed.'}
    area_of_effect = {'type': 'cube', 'size': 40}
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
    url = '/api/spells/slow'
class spare_the_dying():
    higher_level = []
...
class spiritual_weapon():
    ...
    level = 2
    attack_type = 'melee'
    damage = {'damage_type': {'index': 'force', 'name': 'Force', 'url': '/api/damage-types/force'}, 'damage_at_slot_level': {'2': '1d8 + MOD', '3': '1d8 + MOD', '4': '2d8 + MOD', '5': '2d8 + MOD', '6': '3d8 + MOD', '7': '3d8 + MOD', '8': '4d8 + MOD', '9': '4d8 + MOD'}}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'life', 'name': 'Life', 'url': '/api/subclasses/life'}]
    url = '/api/spells/spiritual-weapon'
class stinking_cloud():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 3
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'none', 'desc': 'On a failed save, the creature spends its action that turn retching and reeling.'}
    area_of_effect = {'type': 'sphere', 'size': 20}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}, {'index': 'fiend', 'name': 'Fiend', 'url': '/api/subclasses/fiend'}]
...
class storm_of_vengeance():
    ...
    casting_time = '1 action'
    level = 9
    damage = {'damage_type': {'index': 'thunder', 'name': 'Thunder', 'url': '/api/damage-types/thunder'}, 'damage_at_slot_level': {'9': '2d6'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'none', 'desc': 'On a failed save, a creature takes 2d6 thunder damage and becomes deafened for 5 minutes.'}
    area_of_effect = {'type': 'sphere', 'size': 360}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
    subclasses = []
...
class sunbeam():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'radiant', 'name': 'Radiant', 'url': '/api/damage-types/radiant'}, 'damage_at_slot_level': {'6': '6d8'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half', 'desc': "On a failed save, the creature is blinded until your next turn. On a successful save, it isn't blinded by this spell."}
    area_of_effect = {'type': 'line', 'size': 60}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class sunburst():
    ...
    casting_time = '1 action'
    level = 8
    damage = {'damage_type': {'index': 'radiant', 'name': 'Radiant', 'url': '/api/damage-types/radiant'}, 'damage_at_slot_level': {'8': '12d6'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half', 'desc': 'On failure, the creature is also blinded for 1 minute.'}
    area_of_effect = {'type': 'cylinder', 'size': 60}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = []
...
class thunderwave():
    ...
    casting_time = '1 action'
    level = 1
    damage = {'damage_type': {'index': 'thunder', 'name': 'Thunder', 'url': '/api/damage-types/thunder'}, 'damage_at_slot_level': {'1': '2d8', '2': '3d8', '3': '4d8', '4': '5d8', '5': '6d8', '6': '7d8', '7': '8d8', '8': '9d8', '9': '10d8'}}
    dc = {'dc_type': {'index': 'con', 'name': 'CON', 'url': '/api/ability-scores/con'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'cube', 'size': 15}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class vampiric_touch():
    ...
    level = 3
    attack_type = 'melee'
    damage = {'damage_type': {'index': 'necrotic', 'name': 'Necrotic', 'url': '/api/damage-types/necrotic'}, 'damage_at_slot_level': {'3': '3d6', '4': '4d6', '5': '5d6', '6': '6d6', '7': '7d6', '8': '8d6', '9': '9d6'}}
    school = {'index': 'necromancy', 'name': 'Necromancy', 'url': '/api/magic-schools/necromancy'}
    classes = [{'index': 'warlock', 'name': 'Warlock', 'url': '/api/classes/warlock'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
    url = '/api/spells/vampiric-touch'
class vicious_mockery():
    higher_level = []
    ...
    casting_time = '1 action'
    level = 0
    damage = {'damage_type': {'index': 'psychic', 'name': 'Psychic', 'url': '/api/damage-types/psychic'}, 'damage_at_character_level': {'1': '1d4', '5': '2d4', '11': '3d4', '17': '4d4'}}
    dc = {'dc_type': {'index': 'wis', 'name': 'WIS', 'url': '/api/ability-scores/wis'}, 'dc_success': 'none'}
    school = {'index': 'enchantment', 'name': 'Enchantment', 'url': '/api/magic-schools/enchantment'}
    classes = [{'index': 'bard', 'name': 'Bard', 'url': '/api/classes/bard'}]
    subclasses = []
...
class wall_of_fire():
    index = 'wall-of-fire'
    name = 'Wall of Fire'
    desc = ['You create a wall of fire on a solid surface within range. You can make the wall up to 60 feet long, 20 feet high, and 1 foot thick, or a ringed wall up to 20 feet in diameter, 20 feet high, and 1 foot thick. The wall is opaque and lasts for the duration.', 'When the wall appears, each creature within its area must make a Dexterity saving throw. On a failed save, a creature takes 5d8 fire damage, or half as much damage on a successful save.', 'One side of the wall, selected by you when you cast this spell, deals 5d8 fire damage to each creature that ends its turn within 10 feet o f that side or inside the wall. A creature takes the same damage when it enters the wall for the first time on a turn or ends its turn there. The other side of the wall deals no damage.', 'The other side of the wall deals no damage.']
    ...
    casting_time = '1 action'
    level = 4
    damage = {'damage_type': {'index': 'fire', 'name': 'Fire', 'url': '/api/damage-types/fire'}, 'damage_at_slot_level': {'4': '5d8'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'line', 'size': 60}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}, {'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class wall_of_ice():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'cold', 'name': 'Cold', 'url': '/api/damage-types/cold'}, 'damage_at_slot_level': {'6': '10d6', '7': '12d6', '8': '14d6', '9': '16d6'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'sphere', 'size': 10}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'wizard', 'name': 'Wizard', 'url': '/api/classes/wizard'}]
...
class wall_of_thorns():
    ...
    casting_time = '1 action'
    level = 6
    damage = {'damage_type': {'index': 'piercing', 'name': 'Piercing', 'url': '/api/damage-types/piercing'}, 'damage_at_slot_level': {'6': '7d8', '7': '8d8', '8': '9d8', '9': '10d8'}}
    dc = {'dc_type': {'index': 'dex', 'name': 'DEX', 'url': '/api/ability-scores/dex'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'line', 'size': 60}
    school = {'index': 'conjuration', 'name': 'Conjuration', 'url': '/api/magic-schools/conjuration'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}]
...
class water_walk():
    ...
    level = 3
    school = {'index': 'transmutation', 'name': 'Transmutation', 'url': '/api/magic-schools/transmutation'}
    classes = [{'index': 'cleric', 'name': 'Cleric', 'url': '/api/classes/cleric'}, {'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}, {'index': 'sorcerer', 'name': 'Sorcerer', 'url': '/api/classes/sorcerer'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}, {'index': 'land', 'name': 'Land', 'url': '/api/subclasses/land'}]
...
class wind_wall():
    ...
    casting_time = '1 action'
    level = 3
    damage = {'damage_type': {'index': 'bludgeoning', 'name': 'Bludgeoning', 'url': '/api/damage-types/bludgeoning'}, 'damage_at_slot_level': {'3': '3d8'}}
    dc = {'dc_type': {'index': 'str', 'name': 'STR', 'url': '/api/ability-scores/str'}, 'dc_success': 'half'}
    area_of_effect = {'type': 'line', 'size': 50}
    school = {'index': 'evocation', 'name': 'Evocation', 'url': '/api/magic-schools/evocation'}
    classes = [{'index': 'druid', 'name': 'Druid', 'url': '/api/classes/druid'}, {'index': 'ranger', 'name': 'Ranger', 'url': '/api/classes/ranger'}]
    subclasses = [{'index': 'lore', 'name': 'Lore', 'url': '/api/subclasses/lore'}]
