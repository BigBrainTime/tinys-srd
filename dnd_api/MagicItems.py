entries = ['adamantine_armor', 'ammunition_1', 'ammunition_2', 'ammunition_3', 'ammunition', 'amulet_of_health', 'amulet_of_proof_against_detection_and_location', 'amulet_of_the_planes', 'animated_shield', 'apparatus_of_the_crab', 'armor_1', 'armor_2', 'armor_3', 'armor_of_invulnerability', 'armor_of_resistance', 'armor_of_vulnerability', 'armor', 'arrow_catching_shield', 'arrow_of_slaying', 'bag_of_beans', 'bag_of_devouring', 'bag_of_holding', 'bag_of_tricks_gray', 'bag_of_tricks_rust', 'bag_of_tricks_tan', 'bag_of_tricks', 'bead_of_force', 'belt_of_dwarvenkind', 'belt_of_giant_strength_cloud', 'belt_of_giant_strength_fire', 'belt_of_giant_strength_frost', 'belt_of_giant_strength_hill', 'belt_of_giant_strength_stone', 'belt_of_giant_strength_storm', 'belt_of_giant_strength', 'berserker_axe', 'boots_of_elvenkind', 'boots_of_levitation', 'boots_of_speed', 'boots_of_striding_and_springing', 'boots_of_the_winterlands', 'bowl_of_commanding_water_elementals', 'bracers_of_archery', 'bracers_of_defense', 'brazier_of_commanding_fire_elementals', 'brooch_of_shielding', 'broom_of_flying', 'candle_of_invocation', 'cape_of_the_mountebank', 'carpet_of_flying_3x5', 'carpet_of_flying_4x6', 'carpet_of_flying_5x7', 'carpet_of_flying_6x9', 'carpet_of_flying', 'censer_of_controlling_air_elementals', 'chime_of_opening', 'circlet_of_blasting', 'cloak_of_arachnida', 'cloak_of_displacement', 'cloak_of_elvenkind', 'cloak_of_protection', 'cloak_of_the_bat', 'cloak_of_the_manta_ray', 'crystal_ball_of_mind_reading', 'crystal_ball_of_telepathy', 'crystal_ball_of_true_seeing', 'crystal_ball', 'cube_of_force', 'cubic_gate', 'dagger_of_venom', 'dancing_sword', 'decanter_of_endless_water', 'deck_of_illusions', 'deck_of_many_things', 'defender', 'demon_armor', 'dimensional_shackles', 'dragon_scale_mail_black', 'dragon_scale_mail_blue', 'dragon_scale_mail_brass', 'dragon_scale_mail_bronze', 'dragon_scale_mail_copper', 'dragon_scale_mail_gold', 'dragon_scale_mail_green', 'dragon_scale_mail_red', 'dragon_scale_mail_silver', 'dragon_scale_mail_white', 'dragon_scale_mail', 'dragon_slayer', 'dust_of_disappearance', 'dust_of_dryness', 'dust_of_sneezing_and_choking', 'dwarven_plate', 'dwarven_thrower', 'efficient_quiver', 'efreeti_bottle', 'elemental_gem_air', 'elemental_gem_earth', 'elemental_gem_fire', 'elemental_gem_water', 'elemental_gem', 'elven_chain', 'eversmoking_bottle', 'eyes_of_charming', 'eyes_of_minute_seeing', 'eyes_of_the_eagle', 'feather_token_anchor', 'feather_token_bird', 'feather_token_fan', 'feather_token_swan_boat', 'feather_token_tree', 'feather_token_whip', 'feather_token', 'figurine_of_wondrous_power_bronze_griffon', 'figurine_of_wondrous_power_ebony_fly', 'figurine_of_wondrous_power_golden_lions', 'figurine_of_wondrous_power_ivory_goats', 'figurine_of_wondrous_power_marble_elephant', 'figurine_of_wondrous_power_obsidian_steed', 'figurine_of_wondrous_power_onyx_dog', 'figurine_of_wondrous_power_serpentine_owl', 'figurine_of_wondrous_power_silver_raven', 'figurine_of_wondrous_power', 'flame_tongue', 'folding_boat', 'frost_brand', 'gauntlets_of_ogre_power', 'gem_of_brightness', 'gem_of_seeing', 'giant_slayer', 'glamoured_studded_leather_armor', 'gloves_of_missile_snaring', 'gloves_of_swimming_and_climbing', 'goggles_of_night', 'hammer_of_thunderbolts', 'handy_haversack', 'hat_of_disguise', 'headband_of_intellect', 'helm_of_brilliance', 'helm_of_comprehending_languages', 'helm_of_telepathy', 'helm_of_teleportation', 'holy_avenger', 'horn_of_blasting', 'horn_of_valhalla_brass', 'horn_of_valhalla_bronze', 'horn_of_valhalla_iron', 'horn_of_valhalla_silver', 'horn_of_valhalla', 'horseshoes_of_a_zephyr', 'horseshoes_of_speed', 'immovable_rod', 'instant_fortress', 'ioun_stone_of_absorption', 'ioun_stone_of_agility', 'ioun_stone_of_awareness', 'ioun_stone_of_fortitude', 'ioun_stone_of_greater_absorption', 'ioun_stone_of_insight', 'ioun_stone_of_intellect', 'ioun_stone_of_leadership', 'ioun_stone_of_mastery', 'ioun_stone_of_protection', 'ioun_stone_of_regeneration', 'ioun_stone_of_reserve', 'ioun_stone_of_strength', 'ioun_stone_of_sustenance', 'ioun_stone', 'iron_bands_of_binding', 'iron_flask', 'javelin_of_lightning', 'lantern_of_revealing', 'luck_blade', 'mace_of_disruption', 'mace_of_smiting', 'mace_of_terror', 'mantle_of_spell_resistance', 'manual_of_bodily_health', 'manual_of_gainful_exercise', 'manual_of_golems_clay', 'manual_of_golems_flesh', 'manual_of_golems_iron', 'manual_of_golems_stone', 'manual_of_golems', 'manual_of_quickness_of_action', 'marvelous_pigments', 'medallion_of_thoughts', 'mirror_of_life_trapping', 'mithral_armor', 'necklace_of_adaptation', 'necklace_of_fireballs', 'necklace_of_prayer_beads', 'nine_lives_stealer', 'oathbow', 'oil_of_etherealness', 'oil_of_sharpness', 'oil_of_slipperiness', 'orb_of_dragonkind', 'pearl_of_power', 'periapt_of_health', 'periapt_of_proof_against_poison', 'periapt_of_wound_closure', 'philter_of_love', 'pipes_of_haunting', 'pipes_of_the_sewers', 'plate_armor_of_etherealness', 'portable_hole', 'potion_of_animal_friendship', 'potion_of_clairvoyance', 'potion_of_climbing', 'potion_of_diminution', 'potion_of_flying', 'potion_of_gaseous_form', 'potion_of_giant_strength_cloud', 'potion_of_giant_strength_fire', 'potion_of_giant_strength_frost', 'potion_of_giant_strength_hill', 'potion_of_giant_strength_stone', 'potion_of_giant_strength_storm', 'potion_of_giant_strength', 'potion_of_growth', 'potion_of_healing_common', 'potion_of_healing_greater', 'potion_of_healing_superior', 'potion_of_healing_supreme', 'potion_of_healing', 'potion_of_heroism', 'potion_of_invisibility', 'potion_of_mind_reading', 'potion_of_poison', 'potion_of_resistance_acid', 'potion_of_resistance_cold', 'potion_of_resistance_fire', 'potion_of_resistance_force', 'potion_of_resistance_lightning', 'potion_of_resistance_necrotic', 'potion_of_resistance_poison', 'potion_of_resistance_psychic', 'potion_of_resistance_radiant', 'potion_of_resistance_thunder', 'potion_of_resistance', 'potion_of_speed', 'potion_of_water_breathing', 'restorative_ointment', 'ring_of_animal_influence', 'ring_of_djinni_summoning', 'ring_of_elemental_command_air', 'ring_of_elemental_command_earth', 'ring_of_elemental_command_fire', 'ring_of_elemental_command_water', 'ring_of_elemental_command', 'ring_of_evasion', 'ring_of_feather_falling', 'ring_of_free_action', 'ring_of_invisibility', 'ring_of_jumping', 'ring_of_mind_shielding', 'ring_of_protection', 'ring_of_regeneration', 'ring_of_resistance_acid', 'ring_of_resistance_cold', 'ring_of_resistance_fire', 'ring_of_resistance_force', 'ring_of_resistance_lightning', 'ring_of_resistance_necrotic', 'ring_of_resistance_poison', 'ring_of_resistance_psychic', 'ring_of_resistance_radiant', 'ring_of_resistance_thunder', 'ring_of_resistance', 'ring_of_shooting_stars', 'ring_of_spell_storing', 'ring_of_spell_turning', 'ring_of_swimming', 'ring_of_telekinesis', 'ring_of_the_ram', 'ring_of_three_wishes', 'ring_of_warmth', 'ring_of_water_walking', 'ring_of_x_ray_vision', 'robe_of_eyes', 'robe_of_scintillating_colors', 'robe_of_stars', 'robe_of_the_archmagi', 'robe_of_useful_items', 'rod_of_absorption', 'rod_of_alertness', 'rod_of_lordly_might', 'rod_of_rulership', 'rod_of_security', 'rope_of_climbing', 'rope_of_entanglement', 'scarab_of_protection', 'scimitar_of_speed', 'shield_of_missile_attraction', 'slippers_of_spider_climbing', 'sovereign_glue', 'spell_scroll_1st', 'spell_scroll_2nd', 'spell_scroll_3rd', 'spell_scroll_4th', 'spell_scroll_5th', 'spell_scroll_6th', 'spell_scroll_7th', 'spell_scroll_8th', 'spell_scroll_9th', 'spell_scroll_cantrip', 'spell_scroll', 'spellguard_shield', 'sphere_of_annihilation', 'staff_of_charming', 'staff_of_fire', 'staff_of_frost', 'staff_of_healing', 'staff_of_power', 'staff_of_striking', 'staff_of_swarming_insects', 'staff_of_the_magi', 'staff_of_the_python', 'staff_of_the_woodlands', 'staff_of_thunder_and_lightning', 'staff_of_withering', 'stone_of_controlling_earth_elementals', 'stone_of_good_luck_luckstone', 'sun_blade', 'sword_of_life_stealing', 'sword_of_sharpness', 'sword_of_wounding', 'talisman_of_pure_good', 'talisman_of_the_sphere', 'talisman_of_ultimate_evil', 'tome_of_clear_thought', 'tome_of_leadership_and_influence', 'tome_of_understanding', 'trident_of_fish_command', 'universal_solvent', 'vicious_weapon', 'vorpal_sword', 'wand_of_binding', 'wand_of_enemy_detection', 'wand_of_fear', 'wand_of_fireballs', 'wand_of_lightning_bolts', 'wand_of_magic_detection', 'wand_of_magic_missiles', 'wand_of_paralysis', 'wand_of_polymorph', 'wand_of_secrets', 'wand_of_the_war_mage_1', 'wand_of_the_war_mage_2', 'wand_of_the_war_mage_3', 'wand_of_the_war_mage', 'wand_of_web', 'wand_of_wonder', 'weapon_1', 'weapon_2', 'weapon_3', 'weapon', 'well_of_many_worlds', 'wind_fan', 'winged_boots', 'wings_of_flying']
attributes = ['index', 'name', 'equipment_category', 'rarity', 'variants', 'variant', 'desc', 'url']
class adamantine_armor():
...
class ammunition_1():
    index = 'ammunition-1'
    name = 'Ammunition, +1'
    equipment_category = {'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/equipment-categories/ammunition'}
    rarity = {'name': 'Uncommon'}
    variants = []
    variant = True
    desc = ['Weapon (any ammunition), uncommon', 'You have a +1 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.']
...
class ammunition_2():
    ...
    variants = []
    variant = True
    desc = ['Weapon (any ammunition), rare', 'You have a +2 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.']
...
class ammunition_3():
    ...
    variants = []
    variant = True
    desc = ['Weapon (any ammunition), very rare', 'You have a +3 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.']
...
class ammunition():
    ...
    equipment_category = {'index': 'ammunition', 'name': 'Ammunition', 'url': '/api/equipment-categories/ammunition'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'ammunition-1', 'name': 'Ammunition, +1', 'url': '/api/magic-items/ammunition-1'}, {'index': 'ammunition-2', 'name': 'Ammunition, +2', 'url': '/api/magic-items/ammunition-2'}, {'index': 'ammunition-3', 'name': 'Ammunition, +3', 'url': '/api/magic-items/ammunition-3'}]
    variant = False
    desc = ['Weapon (any ammunition), uncommon (+1), rare (+2), or very rare (+3)', 'You have a bonus to attack and damage rolls made with this piece of magic ammunition. The bonus is determined by the rarity of the ammunition. Once it hits a target, the ammunition is no longer magical.']
    url = '/api/magic-items/ammunition'
class amulet_of_health():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare (requires attunement)', 'Your Constitution score is 19 while you wear this amulet. It has no effect on you if your Constitution is already 19 or higher']
    url = '/api/magic-items/amulet-of-health'
class amulet_of_proof_against_detection_and_location():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', "While wearing this amulet, you are hidden from divination magic. You can't be targeted by such magic or perceived through magical scrying sensors."]
    url = '/api/magic-items/amulet-of-proof-against-detection-and-location'
class amulet_of_the_planes():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, very rare (requires attunement)', 'While wearing this amulet, you can use an action to name a location that you are familiar with on another plane of existence. Then make a DC 15 Intelligence check. On a successful check, you cast the plane shift spell. On a failure, you and each creature and object within 15 feet of you travel to a random destination. Roll a d100. On a 1-60, you travel to a random location on the plane you named. On a 61-100, you travel to a randomly determined plane of existence.']
    url = '/api/magic-items/amulet-of-the-planes'
class animated_shield():
    ...
    variants = []
    variant = False
    desc = ['Armor (shield), very rare (requires attunement)', 'While holding this shield, you can speak its command word as a bonus action to cause it to animate. The shield leaps into the air and hovers in your space to protect you as if you were wielding it, leaving your hands free. The shield remains animated for 1 minute, until you use a bonus action to end this effect, or until you are incapacitated or die, at which point the shield falls to the ground or into your hand if you have one free.']
    url = '/api/magic-items/animated-shield'
class apparatus_of_the_crab():
...
class armor_1():
    ...
    variants = []
    variant = True
    desc = ['Armor (light, medium, or heavy), rare', 'You have a +1 bonus to AC while wearing this armor.']
...
class armor_2():
    ...
    variants = []
    variant = True
    desc = ['Armor (light, medium, or heavy), very rare', 'You have a +2 bonus to AC while wearing this armor.']
...
class armor_3():
    ...
    variants = []
    variant = True
    desc = ['Armor (light, medium, or heavy), legendary', 'You have a +3 bonus to AC while wearing this armor.']
    url = '/api/magic-items/armor-3'
class armor_of_invulnerability():
    ...
    variants = []
    variant = False
    desc = ['Armor (plate), legendary (requires attunement)', "You have resistance to nonmagical damage while you wear this armor. Additionally, you can use an action to make yourself immune to nonmagical damage for 10 minutes or until you are no longer wearing the armor. Once this special action is used, it can't be used again until the next dawn."]
    url = '/api/magic-items/armor-of-invulnerability'
class armor_of_resistance():
...
class armor():
    ...
    equipment_category = {'index': 'armor', 'name': 'Armor', 'url': '/api/equipment-categories/armor'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'armor-1', 'name': 'Armor, +1', 'url': '/api/magic-items/armor-1'}, {'index': 'armor-2', 'name': 'Armor, +2', 'url': '/api/magic-items/armor-2'}, {'index': 'armor-3', 'name': 'Armor, +3', 'url': '/api/magic-items/armor-3'}]
    variant = False
    desc = ['Armor (light, medium, or heavy), rare (+1), very rare (+2), or legendary (+3)', 'You have a bonus to AC while wearing this armor. The bonus is determined by its rarity.']
    url = '/api/magic-items/armor'
class arrow_catching_shield():
    ...
    variants = []
    variant = False
    desc = ['Armor (shield), rare (requires attunement)', "You gain a +2 bonus to AC against ranged attacks while you wield this shield. This bonus is in addition to the shield's normal bonus to AC. In addition, whenever an attacker makes a ranged attack against a target within 5 feet of you, you can use your reaction to become the target of the attack instead."]
    url = '/api/magic-items/arrow-catching-shield'
class arrow_of_slaying():
...
class bag_of_tricks_rust():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, uncommon', 'This ordinary bag, made from rust cloth, appears empty. Reaching inside the bag, however, reveals the presence of a small, fuzzy object. The bag weighs 1/2 pound.', "You can use an action to pull the fuzzy object from the bag and throw it up to 20 feet. When the object lands, it transforms into a creature you determine by rolling a d8 and consulting the table that corresponds to the bag's color. The creature vanishes at the next dawn or when it is reduced to 0 Hit Points.", 'The creature is friendly to you and your companions, and it acts on Your Turn. You can use a Bonus Action to Command how the creature moves and what action it takes on its next turn, or to give it general orders, such as to Attack your enemies. In the absence of such orders, the creature acts in a fashion appropriate to its Nature.', "Once three fuzzy Objects have been pulled from the bag, the bag can't be used again until the next dawn.", 'Rust Bag:', '| d8 | Creature |', '|---|---|', '| 01 | Rat |', '| 02 | Owl |', '| 03 | Mastiff |', '| 04 | Goat |', '| 05 | Giant Goat |', '| 06 | Giant Boar |', '| 07 | Lion |', '| 08 | Brown Bear |']
    url = '/api/magic-items/bag-of-tricks-rust'
class bag_of_tricks_tan():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, uncommon', 'This ordinary bag, made from tan cloth, appears empty. Reaching inside the bag, however, reveals the presence of a small, fuzzy object. The bag weighs 1/2 pound.', "You can use an action to pull the fuzzy object from the bag and throw it up to 20 feet. When the object lands, it transforms into a creature you determine by rolling a d8 and consulting the table that corresponds to the bag's color. The creature vanishes at the next dawn or when it is reduced to 0 Hit Points.", 'The creature is friendly to you and your companions, and it acts on Your Turn. You can use a Bonus Action to Command how the creature moves and what action it takes on its next turn, or to give it general orders, such as to Attack your enemies. In the absence of such orders, the creature acts in a fashion appropriate to its Nature.', "Once three fuzzy Objects have been pulled from the bag, the bag can't be used again until the next dawn.", 'Tan Bag:', '| d8 | Creature |', '|---|---|', '| 01 | Jackal |', '| 02 | Ape |', '| 03 | Baboon |', '| 04 | Axe Beak |', '| 05 | Black Bear |', '| 06 | Giant Weasel |', '| 07 | Giant Hyena |', '| 08 | Tiger |']
...
class bag_of_tricks():
    ...
    equipment_category = {'index': 'wondrous-items', 'name': 'Wondrous Items', 'url': '/api/equipment-categories/wondrous-items'}
    rarity = {'name': 'Uncommon'}
    variants = [{'index': 'bag-of-tricks-gray', 'name': 'Gray Bag of Tricks', 'url': '/api/magic-items/bag-of-tricks-gray'}, {'index': 'bag-of-tricks-rust', 'name': 'Rust Bag of Tricks', 'url': '/api/magic-items/bag-of-tricks-rust'}, {'index': 'bag-of-tricks-tan', 'name': 'Tan Bag of Tricks', 'url': '/api/magic-items/bag-of-tricks-tan'}]
    variant = False
    desc = ['Wondrous item, uncommon', 'This ordinary bag, made from gray, rust, or tan cloth, appears empty. Reaching inside the bag, however, reveals the presence of a small, fuzzy object. The bag weighs 1/2 pound.', "You can use an action to pull the fuzzy object from the bag and throw it up to 20 feet. When the object lands, it transforms into a creature you determine by rolling a d8 and consulting the table that corresponds to the bag's color. The creature vanishes at the next dawn or when it is reduced to 0 hit points.", 'The creature is friendly to you and your companions, and it acts on Your Turn. You can use a Bonus Action to Command how the creature moves and what action it takes on its next turn, or to give it general orders, such as to Attack your enemies. In the absence of such orders, the creature acts in a fashion appropriate to its Nature.', "Once three fuzzy Objects have been pulled from the bag, the bag can't be used again until the next dawn.", 'Gray Bag:', '| d8 | Creature |', '|---|---|', '| 01 | Weasel |', '| 02 | Giant Rat |', '| 03 | Badger |', '| 04 | Boar |', '| 05 | Panther |', '| 06 | Giant Badger |', '| 07 | Dire Wolf |', '| 08 | Giant Elk |', 'Rust Bag:', '| d8 | Creature |', '|---|---|', '| 01 | Rat |', '| 02 | Owl |', '| 03 | Mastiff |', '| 04 | Goat |', '| 05 | Giant Goat |', '| 06 | Giant Boar |', '| 07 | Lion |', '| 08 | Brown Bear |', 'Tan Bag:', '| d8 | Creature |', '|---|---|', '| 01 | Jackal |', '| 02 | Ape |', '| 03 | Baboon |', '| 04 | Axe Beak |', '| 05 | Black Bear |', '| 06 | Giant Weasel |', '| 07 | Giant Hyena |', '| 08 | Tiger |']
...
class belt_of_giant_strength_cloud():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, legendary (requires attunement)', "While wearing this belt, your Strength score changes to 27. If your Strength is already equal to or greater than the belt's score, the item has no Effect on you."]
    url = '/api/magic-items/belt-of-giant-strength-cloud'
class belt_of_giant_strength_fire():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, very rare (requires attunement)', "While wearing this belt, your Strength score changes to 25. If your Strength is already equal to or greater than the belt's score, the item has no Effect on you."]
    url = '/api/magic-items/belt-of-giant-strength-fire'
class belt_of_giant_strength_frost():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, very rare (requires attunement)', "While wearing this belt, your Strength score changes to 23. If your Strength is already equal to or greater than the belt's score, the item has no Effect on you."]
    url = '/api/magic-items/belt-of-giant-strength-frost'
class belt_of_giant_strength_hill():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, rare (requires attunement)', "While wearing this belt, your Strength score changes to a 21. If your Strength is already equal to or greater than the belt's score, the item has no Effect on you."]
    url = '/api/magic-items/belt-of-giant-strength-hill'
class belt_of_giant_strength_stone():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, very rare (requires attunement)', "While wearing this belt, your Strength score changes to a 23. If your Strength is already equal to or greater than the belt's score, the item has no Effect on you."]
    url = '/api/magic-items/belt-of-giant-strength-stone'
class belt_of_giant_strength_storm():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, legendary (requires attunement)', "While wearing this belt, your Strength score changes to 29. If your Strength is already equal to or greater than the belt's score, the item has no Effect on you."]
    url = '/api/magic-items/belt-of-giant-strength-storm'
class belt_of_giant_strength():
    index = 'belt-of-giant-strength'
    name = 'Belt of Giant Strength'
    equipment_category = {'index': 'wondrous-items', 'name': 'Wondrous Items', 'url': '/api/equipment-categories/wondrous-items'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'belt-of-giant-strength-hill', 'name': 'Belt of Hill Giant Strength', 'url': '/api/magic-items/belt-of-giant-strength-hill'}, {'index': 'belt-of-giant-strength-stone', 'name': 'Belt of Stone Giant Strength', 'url': '/api/magic-items/belt-of-giant-strength-stone'}, {'index': 'belt-of-giant-strength-frost', 'name': 'Belt of Frost Giant Strength', 'url': '/api/magic-items/belt-of-giant-strength-frost'}, {'index': 'belt-of-giant-strength-fire', 'name': 'Belt of Fire Giant Strength', 'url': '/api/magic-items/belt-of-giant-strength-fire'}, {'index': 'belt-of-giant-strength-cloud', 'name': 'Belt of Cloud Giant Strength', 'url': '/api/magic-items/belt-of-giant-strength-cloud'}, {'index': 'belt-of-giant-strength-storm', 'name': 'Belt of Storm Giant Strength', 'url': '/api/magic-items/belt-of-giant-strength-storm'}]
    variant = False
    desc = ['Wondrous item, rarity varies (requires attunement)', "While wearing this belt, your Strength score changes to a score granted by the belt. If your Strength is already equal to or greater than the belt's score, the item has no Effect on you.", 'Six varieties of this belt exist, corresponding with and having rarity according to The Six kinds of true Giants. The belt of Stone Giant Strength and the belt of Frost Giant Strength look different, but they have the same Effect.', '| Type | Strength | Rarity |', '|---|---|---|', '| Hill Giant | 21 | Rare |', '| Stone Giant / Frost Giant | 23 | Very Rare |', '| Fire Giant | 25 | Very Rare |', '| Cloud Giant | 27 | Legendary |', '| Storm Giant | 29 | Legendary |']
...
class boots_of_elvenkind():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'While you wear these boots, your steps make no sound, regardless of the surface you are moving across. You also have advantage on Dexterity (Stealth) checks that rely on moving silently.']
    url = '/api/magic-items/boots-of-elvenkind'
class boots_of_levitation():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare (requires attunement)', 'While you wear these boots, you can use an action to cast the levitate spell on yourself at will.']
    url = '/api/magic-items/boots-of-levitation'
class boots_of_speed():
...
class boots_of_striding_and_springing():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', "While you wear these boots, your walking speed becomes 30 feet, unless your walking speed is higher, and your speed isn't reduced if you are encumbered or wearing heavy armor. In addition, you can jump three times the normal distance, though you can't jump farther than your remaining movement would allow."]
    url = '/api/magic-items/boots-of-striding-and-springing'
class boots_of_the_winterlands():
...
class bracers_of_archery():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'While wearing these bracers, you have proficiency with the longbow and shortbow, and you gain a +2 bonus to damage rolls on ranged attacks made with such weapons.']
    url = '/api/magic-items/bracers-of-archery'
class bracers_of_defense():
    ...
    variants = []
    variant = False
    desc = ['Wondous item, rare (requires attunement)', 'While wearing these bracers, you gain a +2 bonus to AC if you are wearing no armor and using no shield.']
    url = '/api/magic-items/bracers-of-defense'
class brazier_of_commanding_fire_elementals():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', "While a fire burns in this brass brazier, you can use an action to speak the brazier's command word and summon a fire elemental, as if you had cast the conjure elemental spell. The brazier can't be used this way again until the next dawn.", 'The brazier weighs 5 pounds.']
    url = '/api/magic-items/brazier-of-commanding-fire-elementals'
class brooch_of_shielding():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'While wearing this brooch, you have resistance to force damage, and you have immunity to damage from the magic missile spell.']
    url = '/api/magic-items/brooch-of-shielding'
class broom_of_flying():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'This wooden broom, which weighs 3 pounds, functions like a mundane broom until you stand astride it and speak its command word. It then hovers beneath you and can be ridden in the air. It has a flying speed of 50 feet. It can carry up to 400 pounds, but its flying speed becomes 30 feet while carrying over 200 pounds. The broom stops hovering when you land.', 'You can send the broom to travel alone to a destination within 1 mile of you if you speak the command word, name the location, and are familiar with that place. The broom comes back to you when you speak another command word, provided that the broom is still within 1 mile of you.']
    url = '/api/magic-items/broom-of-flying'
class candle_of_invocation():
...
class cape_of_the_mountebank():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', "This cape smells faintly of brimstone. While wearing it, you can use it to cast the dimension door spell as an action. This property of the cape can't be used again until the next dawn.", 'When you disappear, you leave behind a cloud of smoke, and you appear in a similar cloud of smoke at your destination. The smoke lightly obscures the space you left and the space you appear in, and it dissipates at the end of your next turn. A light or stronger wind disperses the smoke.']
    url = '/api/magic-items/cape-of-the-mountebank'
class carpet_of_flying_3x5():
...
class carpet_of_flying():
    index = 'carpet-of-flying'
    name = 'Carpet of Flying'
    equipment_category = {'index': 'wondrous-items', 'name': 'Wondrous Items', 'url': '/api/equipment-categories/wondrous-items'}
    rarity = {'name': 'Very Rare'}
    variants = [{'index': 'carpet-of-flying-3x5', 'name': 'Carpet of Flying (3 ft. × 5 ft.)', 'url': '/api/magic-items/carpet-of-flying-3x5'}, {'index': 'carpet-of-flying-4x6', 'name': 'Carpet of Flying (4 ft. × 6 ft.)', 'url': '/api/magic-items/carpet-of-flying-4x6'}, {'index': 'carpet-of-flying-5x7', 'name': 'Carpet of Flying (5 ft. × 7 ft.)', 'url': '/api/magic-items/carpet-of-flying-5x7'}, {'index': 'carpet-of-flying-6x9', 'name': 'Carpet of Flying (6 ft. × 9 ft.)', 'url': '/api/magic-items/carpet-of-flying-6x9'}]
    variant = False
...
class censer_of_controlling_air_elementals():
...
class chime_of_opening():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', "This hollow metal tube measures about 1 foot long and weighs 1 pound. You can strike it as an action, pointing it at an object within 120 feet of you that can be opened, such as a door, lid, or lock. The chime issues a clear tone, and one lock or latch on the object opens unless the sound can't reach the object. If no locks or latches remain, the object itself opens.", 'The chime can be used ten times. After the tenth time, it cracks and becomes useless.']
    url = '/api/magic-items/chime-of-opening'
class circlet_of_blasting():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', "While wearing this circlet, you can use an action to cast the scorching ray spell with it. When you make the spell's attacks, you do so with an attack bonus of +5. The circlet can't be used this way again until the next dawn."]
    url = '/api/magic-items/circlet-of-blasting'
class cloak_of_arachnida():
...
class cloak_of_elvenkind():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', "While you wear this cloak with its hood up, Wisdom (Perception) checks made to see you have disadvantage, and you have advantage on Dexterity (Stealth) checks made to hide, as the cloak's color shifts to camouflage you. Pulling the hood up or down requires an action."]
    url = '/api/magic-items/cloak-of-elvenkind'
class cloak_of_protection():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'You gain a +1 bonus to AC and saving throws while you wear this cloak.']
    url = '/api/magic-items/cloak-of-protection'
class cloak_of_the_bat():
...
class cloak_of_the_manta_ray():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'While wearing this cloak with its hood up, you can breathe underwater, and you have a swimming speed of 60 feet. Pulling the hood up or down requires an action.']
    url = '/api/magic-items/cloak-of-the-manta-ray'
class crystal_ball_of_mind_reading():
...
class crystal_ball_of_true_seeing():
...
class dancing_sword():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any sword), very rare (requires attunement)', 'You can use a bonus action to toss this magic sword into the air and speak the command word. When you do so, the sword begins to hover, flies up to 30 feet, and attacks one creature of your choice within 5 feet of it. The sword uses your attack roll and ability score modifier to damage rolls.', 'While the sword hovers, you can use a bonus action to cause it to fly up to 30 feet to another spot within 30 feet of you. As part of the same bonus action, you can cause the sword to attack one creature within 5 feet of it.', 'After the hovering sword attacks for the fourth time, it flies up to 30 feet and tries to return to your hand. If you have no hand free, it falls to the ground at your feet. If the sword has no unobstructed path to you, it moves as close to you as it can and then falls to the ground. It also ceases to hover if you grasp it or move more than 30 feet away from it.']
    url = '/api/magic-items/dancing-sword'
class decanter_of_endless_water():
...
class defender():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any sword), legendary (requires attunement)', 'You gain a +3 bonus to attack and damage rolls made with this magic weapon.', "The first time you attack with the sword on each of your turns, you can transfer some or all of the sword's bonus to your Armor Class, instead of using the bonus on any attacks that turn. For example, you could reduce the bonus to your attack and damage rolls to +1 and gain a +2 bonus to AC. The adjusted bonuses remain in effect until the start of your next turn, although you must hold the sword to gain a bonus to AC from it."]
...
class dimensional_shackles():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', "You can use an action to place these shackles on an incapacitated creature. The shackles adjust to fit a creature of Small to Large size. In addition to serving as mundane manacles, the shackles prevent a creature bound by them from using any method of extradimensional movement, including teleportation or travel to a different plane of existence. They don't prevent the creature from passing through an interdimensional portal.", 'You and any creature you designate when you use the shackles can use an action to remove them. Once every 30 days, the bound creature can make a DC 30 Strength (Athletics) check. On a success, the creature breaks free and destroys the shackles.']
    url = '/api/magic-items/dimensional-shackles'
class dragon_scale_mail_black():
...
class dragon_scale_mail_bronze():
...
class dragon_scale_mail_copper():
...
class dragon_scale_mail_silver():
...
class dragon_scale_mail():
    index = 'dragon-scale-mail'
    name = 'Dragon Scale Mail'
    equipment_category = {'index': 'armor', 'name': 'Armor', 'url': '/api/equipment-categories/armor'}
    rarity = {'name': 'Very Rare'}
    variants = [{'index': 'dragon-scale-mail-black', 'name': 'Black Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-black'}, {'index': 'dragon-scale-mail-blue', 'name': 'Blue Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-blue'}, {'index': 'dragon-scale-mail-brass', 'name': 'Brass Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-brass'}, {'index': 'dragon-scale-mail-bronze', 'name': 'Bronze Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-bronze'}, {'index': 'dragon-scale-mail-copper', 'name': 'Copper Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-copper'}, {'index': 'dragon-scale-mail-gold', 'name': 'Gold Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-gold'}, {'index': 'dragon-scale-mail-green', 'name': 'Green Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-green'}, {'index': 'dragon-scale-mail-red', 'name': 'Red Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-red'}, {'index': 'dragon-scale-mail-silver', 'name': 'Silver Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-silver'}, {'index': 'dragon-scale-mail-white', 'name': 'White Dragon Scale Mail', 'url': '/api/magic-items/dragon-scale-mail-white'}]
    variant = False
...
class dust_of_disappearance():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'Found in a small packet, this powder resembles very fine sand. There is enough of it for one use. When you use an action to throw the dust into the air, you and each creature and object within 10 feet of you become invisible for 2d4 minutes. The duration is the same for all subjects, and the dust is consumed when its magic takes effect. If a creature affected by the dust attacks or casts a spell, the invisibility ends for that creature.']
    url = '/api/magic-items/dust-of-disappearance'
class dust_of_dryness():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', "This small packet contains 1d6 + 4 pinches of dust. You can use an action to sprinkle a pinch of it over water. The dust turns a cube of water 15 feet on a side into one marble-sized pellet, which floats or rests near where the dust was sprinkled. The pellet's weight is negligible.", "Someone can use an action to smash the pellet against a hard surface, causing the pellet to shatter and release the water the dust absorbed. Doing so ends that pellet's magic.", 'An elemental composed mostly of water that is exposed to a pinch of the dust must make a DC 13 Constitution saving throw, taking 10d6 necrotic damage on a failed save, or half as much damage on a successful one.']
    url = '/api/magic-items/dust-of-dryness'
class dust_of_sneezing_and_choking():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'Found in a small container, this powder resembles very fine sand. It appears to be dust of disappearance, and an identify spell reveals it to be such. There is enough of it for one use.', 'When you use an action to throw a handful of the dust into the air, you and each creature that needs to breathe within 30 feet of you must succeed on a DC 15 Constitution saving throw or become unable to breathe, while sneezing uncontrollably. A creature affected in this way is incapacitated and suffocating. As long as it is conscious, a creature can repeat the saving throw at the end of each of its turns, ending the effect on it on a success. The lesser restoration spell can also end the effect on a creature.']
...
class dwarven_plate():
    ...
    variants = []
    variant = False
    desc = ['Armor (plate), very rare', 'While wearing this armor, you gain a +2 bonus to AC. In addition, if an effect moves you against your will along the ground, you can use your reaction to reduce the distance you are moved by up to 10 feet.']
    url = '/api/magic-items/dwarven-plate'
class dwarven_thrower():
...
class efficient_quiver():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', "Each of the quiver's three compartments connects to an extradimensional space that allows the quiver to hold numerous items while never weighing more than 2 pounds. The shortest compartment can hold up to sixty arrows, bolts, or similar objects. The midsize compartment holds up to eighteen javelins or similar objects. The longest compartment holds up to six long objects, such as bows, quarterstaffs, or spears.", 'You can draw any item the quiver contains as if doing so from a regular quiver or scabbard.']
    url = '/api/magic-items/efficient-quiver'
class efreeti_bottle():
...
class elemental_gem_air():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, uncommon', "This blue sapphire contains a mote of elemental energy. When you use an action to break the gem, an air elemental is summoned as if you had cast the conjure elemental spell, and the gem's magic is lost."]
    url = '/api/magic-items/elemental-gem-air'
class elemental_gem_earth():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, uncommon', "This yellow diamond contains a mote of elemental energy. When you use an action to break the gem, an earth elemental is summoned as if you had cast the conjure elemental spell, and the gem's magic is lost."]
    url = '/api/magic-items/elemental-gem-earth'
class elemental_gem_fire():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, uncommon', "This red corundum contains a mote of elemental energy. When you use an action to break the gem, a fire elemental is summoned as if you had cast the conjure elemental spell, and the gem's magic is lost."]
    url = '/api/magic-items/elemental-gem-fire'
class elemental_gem_water():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, uncommon', "This emerald contains a mote of elemental energy. When you use an action to break the gem, a water elemental is summoned as if you had cast the conjure elemental spell, and the gem's magic is lost."]
...
class elemental_gem():
    ...
    equipment_category = {'index': 'wondrous-items', 'name': 'Wondrous Items', 'url': '/api/equipment-categories/wondrous-items'}
    rarity = {'name': 'Uncommon'}
    variants = [{'index': 'elemental-gem-air', 'name': 'Air Elemental Gem', 'url': '/api/magic-items/elemental-gem-air'}, {'index': 'elemental-gem-earth', 'name': 'Earth Elemental Gem', 'url': '/api/magic-items/elemental-gem-earth'}, {'index': 'elemental-gem-fire', 'name': 'Fire Elemental Gem', 'url': '/api/magic-items/elemental-gem-fire'}, {'index': 'elemental-gem-water', 'name': 'Water Elemental Gem', 'url': '/api/magic-items/elemental-gem-water'}]
    variant = False
    desc = ['Wondrous item, uncommon', "This gem contains a mote of elemental energy. When you use an action to break the gem, an elemental is summoned as if you had cast the conjure elemental spell, and the gem's magic is lost. The type of gem determines the elemental summoned by the spell.", '| Gem | Summoned Elemental |', '|---|---|', '| Blue sapphire | Air elemental |', '| Yellow diamond | Earth elemental |', '| Red corundum | Fire elemental |', '| Emerald | Water elemental |']
...
class elven_chain():
    ...
    variants = []
    variant = False
    desc = ['Armor (chain shirt), rare', 'You gain a +1 bonus to AC while you wear this armor. You are considered proficient with this armor even if you lack proficiency with medium armor.']
    url = '/api/magic-items/elven-chain'
class eversmoking_bottle():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', "Smoke leaks from the lead-stoppered mouth of this brass bottle, which weighs 1 pound. When you use an action to remove the stopper, a cloud of thick smoke pours out in a 60-foot radius from the bottle. The cloud's area is heavily obscured. Each minute the bottle remains open and within the cloud, the radius increases by 10 feet until it reaches its maximum radius of 120 feet.", 'The cloud persists as long as the bottle is open. Closing the bottle requires you to speak its command word as an action. Once the bottle is closed, the cloud disperses after 10 minutes. A moderate wind (11 to 20 miles per hour) can also disperse the smoke after 1 minute, and a strong wind (21 or more miles per hour) can do so after 1 round.']
    url = '/api/magic-items/eversmoking-bottle'
class eyes_of_charming():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'These crystal lenses fit over the eyes. They have 3 charges. While wearing them, you can expend 1 charge as an action to cast the charm person spell (save DC 13) on a humanoid within 30 feet of you, provided that you and the target can see each other. The lenses regain all expended charges daily at dawn.']
    url = '/api/magic-items/eyes-of-charming'
class eyes_of_minute_seeing():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'These crystal lenses fit over the eyes. While wearing them, you can see much better than normal out to a range of 1 foot. You have advantage on Intelligence (Investigation) checks that rely on sight while searching an area or studying an object within that range.']
    url = '/api/magic-items/eyes-of-minute-seeing'
class eyes_of_the_eagle():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'These crystal lenses fit over the eyes. While wearing them, you have advantage on Wisdom (Perception) checks that rely on sight. In conditions of clear visibility, you can make out details of even extremely distant creatures and objects as small as 2 feet across.']
    url = '/api/magic-items/eyes-of-the-eagle'
class feather_token_anchor():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, rare', 'This tiny object looks like a feather.', "You can use an action to touch the token to a boat or ship. For the next 24 hours, the vessel can't be moved by any means. Touching the token to the vessel again ends the effect. When the effect ends, the token disappears."]
    url = '/api/magic-items/feather-token-anchor'
class feather_token_bird():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, rare', 'This tiny object looks like a feather.', "You can use an action to toss the token 5 feet into the air. The token disappears and an enormous, multicolored bird takes its place. The bird has the statistics of a roc, but it obeys your simple commands and can't attack. It can carry up to 500 pounds while flying at its maximum speed (16 miles an hour for a maximum of 144 miles per day, with a one-hour rest for every 3 hours of flying), or 1,000 pounds at half that speed. The bird disappears after flying its maximum distance for a day or if it drops to 0 hit points. You can dismiss the bird as an action."]
    url = '/api/magic-items/feather-token-bird'
class feather_token_fan():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, rare', 'This tiny object looks like a feather.', 'If you are on a boat or ship, you can use an action to toss the token up to 10 feet in the air. The token disappears, and a giant flapping fan takes its place. The fan floats and creates a wind strong enough to fill the sails of one ship, increasing its speed by 5 miles per hour for 8 hours. You can dismiss the fan as an action.']
    url = '/api/magic-items/feather-token-fan'
class feather_token_swan_boat():
...
class feather_token_tree():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, rare', 'This tiny object looks like a feather.', 'You must be outdoors to use this token. You can use an action to touch it to an unoccupied space on the ground. The token disappears, and in its place a nonmagical oak tree springs into existence. The tree is 60 feet tall and has a 5-foot-diameter trunk, and its branches at the top spread out in a 20-foot radius.']
    url = '/api/magic-items/feather-token-tree'
class feather_token_whip():
...
class figurine_of_wondrous_power_golden_lions():
...
class figurine_of_wondrous_power_ivory_goats():
...
class figurine_of_wondrous_power_marble_elephant():
...
class figurine_of_wondrous_power_obsidian_steed():
...
class figurine_of_wondrous_power_serpentine_owl():
...
class figurine_of_wondrous_power_silver_raven():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, uncommon', "A figurine of wondrous power is a statuette of a beast small enough to fit in a pocket. If you use an action to speak the command word and throw the figurine to a point on the ground within 60 feet of you, the figurine becomes a living creature. If the space where the creature would appear is occupied by other creatures or objects, or if there isn't enough space for the creature, the figurine doesn't become a creature.", 'The creature is friendly to you and your companions. It understands your languages and obeys your spoken commands. If you issue no commands, the creature defends itself but takes no other actions.', "The creature exists for a duration specific to each figurine. At the end of the duration, the creature reverts to its figurine form. It reverts to a figurine early if it drops to 0 hit points or if you use an action to speak the command word again while touching it. When the creature becomes a figurine again, its property can't be used again until a certain amount of time has passed, as specified in the figurine's description.", "***Silver Raven.*** This silver statuette of a raven can become a raven for up to 12 hours. Once it has been used, it can't be used again until 2 days have passed. While in raven form, the figurine allows you to cast the animal messenger spell on it at will."]
    url = '/api/magic-items/figurine-of-wondrous-power-silver-raven'
class figurine_of_wondrous_power():
    index = 'figurine-of-wondrous-power'
    name = 'Figurine of Wondrous Power'
    equipment_category = {'index': 'wondrous-items', 'name': 'Wondrous Items', 'url': '/api/equipment-categories/wondrous-items'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'figurine-of-wondrous-power-bronze-griffon', 'name': 'Bronze Griffon Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-bronze-griffon'}, {'index': 'figurine-of-wondrous-power-ebony-fly', 'name': 'Ebony Fly Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-ebony-fly'}, {'index': 'figurine-of-wondrous-power-golden-lions', 'name': 'Golden Lions Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-golden-lions'}, {'index': 'figurine-of-wondrous-power-ivory-goats', 'name': 'Ivory Goats Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-ivory-goats'}, {'index': 'figurine-of-wondrous-power-marble-elephant', 'name': 'Marble Elephant Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-marble-elephant'}, {'index': 'figurine-of-wondrous-power-obsidian-steed', 'name': 'Obsidian Steed Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-obsidian-steed'}, {'index': 'figurine-of-wondrous-power-onyx-dog', 'name': 'Onyx Dog Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-onyx-dog'}, {'index': 'figurine-of-wondrous-power-serpentine-owl', 'name': 'Serpentine Owl Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-serpentine-owl'}, {'index': 'figurine-of-wondrous-power-silver-raven', 'name': 'Silver Raven Figurine of Wondrous Power', 'url': '/api/magic-items/figurine-of-wondrous-power-silver-raven'}]
    variant = False
...
class flame_tongue():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any sword), rare (requires attunement)', "You can use a bonus action to speak this magic sword's command word, causing flames to erupt from the blade. These flames shed bright light in a 40-foot radius and dim light for an additional 40 feet. While the sword is ablaze, it deals an extra 2d6 fire damage to any target it hits. The flames last until you use a bonus action to speak the command word again or until you drop or sheathe the sword."]
...
class frost_brand():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any sword), very rare (requires attunement)', 'When you hit with an attack using this magic sword, the target takes an extra 1d6 cold damage. In addition, while you hold the sword, you have resistance to fire damage.', 'In freezing temperatures, the blade sheds bright light in a 10-foot radius and dim light for an additional 10 feet.', 'When you draw this weapon, you can extinguish all nonmagical flames within 30 feet of you. This property can be used no more than once per hour.']
    url = '/api/magic-items/frost-brand'
class gauntlets_of_ogre_power():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'Your Strength score is 19 while you wear these gauntlets. They have no effect on you if your Strength is already 19 or higher.']
    url = '/api/magic-items/gauntlets-of-ogre-power'
class gem_of_brightness():
...
class gem_of_seeing():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare (requires attunement)', "This gem has 3 charges. As an action, you can speak the gem's command word and expend 1 charge. For the next 10 minutes, you have truesight out to 120 feet when you peer through the gem.", 'The gem regains 1d3 expended charges daily at dawn.']
...
class gloves_of_missile_snaring():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', "These gloves seem to almost meld into your hands when you don them. When a ranged weapon attack hits you while you're wearing them, you can use your reaction to reduce the damage by 1d10 + your Dexterity modifier, provided that you have a free hand. If you reduce the damage to 0, you can catch the missile if it is small enough for you to hold in that hand."]
    url = '/api/magic-items/gloves-of-missile-snaring'
class gloves_of_swimming_and_climbing():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', "While wearing these gloves, climbing and swimming don't cost you extra movement, and you gain a +5 bonus to Strength (Athletics) checks made to climb or swim."]
    url = '/api/magic-items/gloves-of-swimming-and-climbing'
class goggles_of_night():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'While wearing these dark lenses, you have darkvision out to a range of 60 feet. If you already have darkvision, wearing the goggles increases its range by 60 feet.']
    url = '/api/magic-items/goggles-of-night'
class hammer_of_thunderbolts():
...
class hat_of_disguise():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'While wearing this hat, you can use an action to cast the disguise self spell from it at will. The spell ends if the hat is removed.']
    url = '/api/magic-items/hat-of-disguise'
class headband_of_intellect():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'Your Intelligence score is 19 while you wear this headband. It has no effect on you if your Intelligence is already 19 or higher.']
    url = '/api/magic-items/headband-of-intellect'
class helm_of_brilliance():
...
class helm_of_comprehending_languages():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'While wearing this helm, you can use an action to cast the comprehend languages spell from it at will.']
    url = '/api/magic-items/helm-of-comprehending-languages'
class helm_of_telepathy():
...
class helm_of_teleportation():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare (requires attunement)', 'This helm has 3 charges. While wearing it, you can use an action and expend 1 charge to cast the teleport spell from it. The helm regains 1d3', 'expended charges daily at dawn.']
...
class horn_of_blasting():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', "You can use an action to speak the horn's command word and then blow the horn, which emits a thunderous blast in a 30-foot cone that is audible 600 feet away. Each creature in the cone must make a DC 15 Constitution saving throw. On a failed save, a creature takes 5d6 thunder damage and is deafened for 1 minute. On a successful save, a creature takes half as much damage and isn't deafened. Creatures and objects made of glass or crystal have disadvantage on the saving throw and take 10d6 thunder damage instead of 5d6.", "Each use of the horn's magic has a 20 percent chance of causing the horn to explode. The explosion deals 10d6 fire damage to the blower and destroys the horn."]
    url = '/api/magic-items/horn-of-blasting'
class horn_of_valhalla_brass():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, rare', "You can use an action to blow this horn. In response, 3d4 + 3 warrior spirits from the Valhalla appear within 60 feet of you. They use the statistics of a berserker. They return to Valhalla after 1 hour or when they drop to 0 hit points. Once you use the horn, it can't be used again until 7 days have passed.", 'If you blow the horn without having proficiency with all simple weapons, the summoned berserkers attack you. If you meet the requirement, they are friendly to you and your companions and follow your commands.']
    url = '/api/magic-items/horn-of-valhalla-brass'
class horn_of_valhalla_bronze():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, very rare', "You can use an action to blow this horn. In response, 4d4 + 4 warrior spirits from the Valhalla appear within 60 feet of you. They use the statistics of a berserker. They return to Valhalla after 1 hour or when they drop to 0 hit points. Once you use the horn, it can't be used again until 7 days have passed.", 'If you blow the horn without having proficiency with all medium armor, the summoned berserkers attack you. If you meet the requirement, they are friendly to you and your companions and follow your commands.']
    url = '/api/magic-items/horn-of-valhalla-bronze'
class horn_of_valhalla_iron():
...
class horseshoes_of_a_zephyr():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, very rare', 'These iron horseshoes come in a set of four. While all four shoes are affixed to the hooves of a horse or similar creature, they allow the creature to move normally while floating 4 inches above the ground. This effect means the creature can cross or stand above nonsolid or unstable surfaces, such as water or lava. The creature leaves no tracks and ignores difficult terrain. In addition, the creature can move at normal speed for up to 12 hours a day without suffering exhaustion from a forced march.']
    url = '/api/magic-items/horseshoes-of-a-zephyr'
class horseshoes_of_speed():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', "These iron horseshoes come in a set of four. While all four shoes are affixed to the hooves of a horse or similar creature, they increase the creature's walking speed by 30 feet."]
    url = '/api/magic-items/horseshoes-of-speed'
class immovable_rod():
    index = 'immovable-rod'
    name = 'Immovable Rod'
    equipment_category = {'index': 'rod', 'name': 'Rod', 'url': '/api/equipment-categories/rod'}
    rarity = {'name': 'Uncommon'}
    variants = []
    variant = False
    desc = ['Rod, uncommon', "This flat iron rod has a button on one end. You can use an action to press the button, which causes the rod to become magically fixed in place. Until you or another creature uses an action to push the button again, the rod doesn't move, even if it is defying gravity. The rod can hold up to 8,000 pounds of weight. More weight causes the rod to deactivate and fall. A creature can use an action to make a DC 30 Strength check, moving the fixed rod up to 10 feet on a success."]
    url = '/api/magic-items/immovable-rod'
class instant_fortress():
...
class ioun_stone_of_greater_absorption():
...
class ioun_stone_of_leadership():
...
class ioun_stone_of_protection():
...
class ioun_stone_of_regeneration():
...
class ioun_stone_of_sustenance():
...
class iron_bands_of_binding():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', 'This rusty iron sphere measures 3 inches in diameter and weighs 1 pound. You can use an action to speak the command word and throw the sphere at a Huge or smaller creature you can see within 60 feet of you. As the sphere moves through the air, it opens into a tangle of metal bands.', 'Make a ranged attack roll with an attack bonus equal to your Dexterity modifier plus your proficiency bonus. On a hit, the target is restrained until you take a bonus action to speak the command word again to release it. Doing so, or missing with the attack, causes the bands to contract and become a sphere once more.', 'A creature, including the one restrained, can use an action to make a DC 20 Strength check to break the iron bands. On a success, the item is destroyed, and the restrained creature is freed. If the check fails, any further attempts made by that creature automatically fail until 24 hours have elapsed.', "Once the bands are used, they can't be used again until the next dawn."]
...
class javelin_of_lightning():
    ...
    variants = []
    variant = False
    desc = ['Weapon (javelin), uncommon', 'This javelin is a magic weapon. When you hurl it and speak its command word, it transforms into a bolt of lightning, forming a line 5 feet wide that extends out from you to a target within 120 feet. Each creature in the line excluding you and the target must make a DC 13 Dexterity saving throw, taking 4d6 lightning damage on a failed save, and half as much damage on a successful one. The lightning bolt turns back into a javelin when it reaches the target. Make a ranged weapon attack against the target. On a hit, the target takes damage from the javelin plus 4d6 lightning damage.', "The javelin's property can't be used again until the next dawn. In the meantime, the javelin can still be used as a magic weapon."]
    url = '/api/magic-items/javelin-of-lightning'
class lantern_of_revealing():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', "While lit, this hooded lantern burns for 6 hours on 1 pint of oil, shedding bright light in a 30-foot radius and dim light for an additional 30 feet. Invisible creatures and objects are visible as long as they are in the lantern's bright light. You can use an action to lower the hood, reducing the light to dim light in a 5 foot radius."]
...
class mantle_of_spell_resistance():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare (requires attunement)', 'You have advantage on saving throws against spells while you wear this cloak.']
    url = '/api/magic-items/mantle-of-spell-resistance'
class manual_of_bodily_health():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, very rare', "This book contains health and diet tips, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Constitution score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century."]
    url = '/api/magic-items/manual-of-bodily-health'
class manual_of_gainful_exercise():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, very rare', "This book describes fitness exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Strength score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century."]
    url = '/api/magic-items/manual-of-gainful-exercise'
class manual_of_golems_clay():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, very rare', "This tome contains information and incantations necessary to make a clay golem. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can't use a manual of golems and attempts to read it takes 6d6 psychic damage.", 'To create a golem, you must spend 30 days, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay 65,000 gp to purchase supplies.', 'Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.']
    url = '/api/magic-items/manual-of-golems-clay'
class manual_of_golems_flesh():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, very rare', "This tome contains information and incantations necessary to make a flesh golem. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can't use a manual of golems and attempts to read it takes 6d6 psychic damage.", 'To create a golem, you must spend 60 days, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay 50,000 gp to purchase supplies.', 'Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.']
    url = '/api/magic-items/manual-of-golems-flesh'
class manual_of_golems_iron():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, very rare', "This tome contains information and incantations necessary to make an iron golem. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can't use a manual of golems and attempts to read it takes 6d6 psychic damage.", 'To create a golem, you must spend 120 days, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay 100,000 gp to purchase supplies.', 'Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.']
    url = '/api/magic-items/manual-of-golems-iron'
class manual_of_golems_stone():
    ...
    variants = []
    variant = True
    desc = ['Wondrous item, very rare', "This tome contains information and incantations necessary to make a stone golem. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can't use a manual of golems and attempts to read it takes 6d6 psychic damage.", 'To create a golem, you must spend 90 days, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay 80,000 gp to purchase supplies.', 'Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.']
    url = '/api/magic-items/manual-of-golems-stone'
class manual_of_golems():
    index = 'manual-of-golems'
    name = 'Manual of Golems'
    equipment_category = {'index': 'wondrous-items', 'name': 'Wondrous Items', 'url': '/api/equipment-categories/wondrous-items'}
    rarity = {'name': 'Very Rare'}
    variants = [{'index': 'manual-of-golems-clay', 'name': 'Manual of Clay Golems', 'url': '/api/magic-items/manual-of-golems-clay'}, {'index': 'manual-of-golems-flesh', 'name': 'Manual of Flesh Golems', 'url': '/api/magic-items/manual-of-golems-flesh'}, {'index': 'manual-of-golems-iron', 'name': 'Manual of Iron Golems', 'url': '/api/magic-items/manual-of-golems-iron'}, {'index': 'manual-of-golems-stone', 'name': 'Manual of Stone Golems', 'url': '/api/magic-items/manual-of-golems-stone'}]
    variant = False
    desc = ['Wondrous item, very rare', "This tome contains information and incantations necessary to make a particular type of golem. The GM chooses the type or determines it randomly. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can't use a manual of golems and attempts to read it takes 6d6 psychic damage.", '| d20 | Golem | Time | Cost |', '|---|---|---|---|', '| 1-5 | Clay | 30 days | 65,000 gp |', '| 6-17 | Flesh | 60 days | 50,000 gp |', '| 18 | Iron | 120 days | 100,000 gp |', '| 19-20 | Stone | 90 days | 80,000 gp |', 'To create a golem, you must spend the time shown on the table, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay the specified cost to purchase supplies.', 'Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.']
    url = '/api/magic-items/manual-of-golems'
class manual_of_quickness_of_action():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, very rare', "This book contains coordination and balance exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Dexterity score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century."]
    url = '/api/magic-items/manual-of-quickness-of-action'
class marvelous_pigments():
...
class medallion_of_thoughts():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'The medallion has 3 charges. While wearing it, you can use an action and expend 1 charge to cast the detect thoughts spell (save DC 13) from it. The medallion regains 1d3 expended charges daily at dawn.']
    url = '/api/magic-items/medallion-of-thoughts'
class mirror_of_life_trapping():
...
class mithral_armor():
    ...
    variants = []
    variant = False
    desc = ['Armor (medium or heavy), uncommon', "Mithral is a light, flexible metal. A mithral chain shirt or breastplate can be worn under normal clothes. If the armor normally imposes disadvantage on Dexterity (Stealth) checks or has a Strength requirement, the mithral version of the armor doesn't."]
    url = '/api/magic-items/mithral-armor'
class necklace_of_adaptation():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'While wearing this necklace, you can breathe normally in any environment, and you have advantage on saving throws made against harmful gases and vapors (such as cloudkill and stinking cloud effects, inhaled poisons, and the breath weapons of some dragons).']
    url = '/api/magic-items/necklace-of-adaptation'
class necklace_of_fireballs():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', 'This necklace has 1d6 + 3 beads hanging from it. You can use an action to detach a bead and throw it up to 60 feet away. When it reaches the end of its trajectory, the bead detonates as a 3rd-level fireball spell (save DC 15).', 'You can hurl multiple beads, or even the whole necklace, as one action. When you do so, increase the level of the fireball by 1 for each bead beyond the first.']
    url = '/api/magic-items/necklace-of-fireballs'
class necklace_of_prayer_beads():
...
class nine_lives_stealer():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any sword), very rare (requires attunement)', 'You gain a +2 bonus to attack and damage rolls made with this magic weapon.', 'The sword has 1d8 + 1 charges. If you score a critical hit against a creature that has fewer than 100 hit points, it must succeed on a DC 15 Constitution saving throw or be slain instantly as the sword tears its life force from its body (a construct or an undead is immune). The sword loses 1 charge if the creature is slain. When the sword has no charges remaining, it loses this property.']
...
class oil_of_etherealness():
    index = 'oil-of-etherealness'
    name = 'Oil of Etherealness'
    equipment_category = {'index': 'potion', 'name': 'Potion', 'url': '/api/equipment-categories/potion'}
    rarity = {'name': 'Rare'}
    variants = []
    variant = False
    desc = ['Potion, rare', "Beads of this cloudy gray oil form on the outside of its container and quickly evaporate. The oil can cover a Medium or smaller creature, along with the equipment it's wearing and carrying (one additional vial is required for each size category above Medium). Applying the oil takes 10 minutes. The affected creature then gains the effect of the etherealness spell for 1 hour."]
    url = '/api/magic-items/oil-of-etherealness'
class oil_of_sharpness():
...
class periapt_of_health():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'You are immune to contracting any disease while you wear this pendant. If you are already infected with a disease, the effects of the disease are suppressed you while you wear the pendant.']
    url = '/api/magic-items/periapt-of-health'
class periapt_of_proof_against_poison():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', 'This delicate silver chain has a brilliant-cut black gem pendant. While you wear it, poisons have no effect on you. You are immune to the poisoned condition and have immunity to poison damage.']
    url = '/api/magic-items/periapt-of-proof-against-poison'
class periapt_of_wound_closure():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'While you wear this pendant, you stabilize whenever you are dying at the start of your turn. In addition, whenever you roll a Hit Die to regain hit points, double the number of hit points it restores.']
    url = '/api/magic-items/periapt-of-wound-closure'
class philter_of_love():
...
class plate_armor_of_etherealness():
    ...
    variants = []
    variant = False
    desc = ['Armor (plate), legendary (requires attunement)', "While you're wearing this armor, you can speak its command word as an action to gain the effect of the etherealness spell, which last for 10 minutes or until you remove the armor or use an action to speak the command word again. This property of the armor can't be used again until the next dawn."]
...
class portable_hole():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', 'This fine black cloth, soft as silk, is folded up to the dimensions of a handkerchief. It unfolds into a circular sheet 6 feet in diameter.', "You can use an action to unfold a portable hole and place it on or against a solid surface, whereupon the portable hole creates an extradimensional hole 10 feet deep. The cylindrical space within the hole exists on a different plane, so it can't be used to create open passages. Any creature inside an open portable hole can exit the hole by climbing out of it.", "You can use an action to close a portable hole by taking hold of the edges of the cloth and folding it up. Folding the cloth closes the hole, and any creatures or objects within remain in the extradimensional space. No matter what's in it, the hole weighs next to nothing.", "If the hole is folded up, a creature within the hole's extradimensional space can use an action to make a DC 10 Strength check. On a successful check, the creature forces its way out and appears within 5 feet of the portable hole or the creature carrying it. A breathing creature within a closed portable hole can survive for up to 10 minutes, after which time it begins to suffocate.", "Placing a portable hole inside an extradimensional space created by a bag of holding, handy haversack, or similar item instantly destroys both items and opens a gate to the Astral Plane. The gate originates where the one item was placed inside the other. Any creature within 10 feet of the gate is sucked through it and deposited in a random location on the Astral Plane. The gate then closes. The gate is one-way only and can't be reopened."]
    url = '/api/magic-items/portable-hole'
class potion_of_animal_friendship():
    ...
    variants = []
    variant = False
    desc = ['Potion, uncommon', 'When you drink this potion, you can cast the animal friendship spell (save DC 13) for 1 hour at will. Agitating this muddy liquid brings little bits into view: a fish scale, a hummingbird tongue, a cat claw, or a squirrel hair.']
    url = '/api/magic-items/potion-of-animal-friendship'
class potion_of_clairvoyance():
    ...
    variants = []
    variant = False
    desc = ['Potion, rare', 'When you drink this potion, you gain the effect of the clairvoyance spell. An eyeball bobs in this yellowish liquid but vanishes when the potion is opened.']
    url = '/api/magic-items/potion-of-clairvoyance'
class potion_of_climbing():
    ...
    variants = []
    variant = False
    desc = ['Potion, common', 'When you drink this potion, you gain a climbing speed equal to your walking speed for 1 hour. During this time, you have advantage on Strength (Athletics) checks you make to climb. The potion is separated into brown, silver, and gray layers resembling bands of stone. Shaking the bottle fails to mix the colors.']
    url = '/api/magic-items/potion-of-climbing'
class potion_of_diminution():
    ...
    variants = []
    variant = False
    desc = ['Potion, rare', 'When you drink this potion, you gain the "reduce" effect of the enlarge/reduce spell for 1d4 hours (no concentration required). The red in the potion\'s liquid continuously contracts to a tiny bead and then expands to color the clear liquid around it. Shaking the bottle fails to interrupt this process.']
    url = '/api/magic-items/potion-of-diminution'
class potion_of_flying():
    ...
    variants = []
    variant = False
    desc = ['Potion, very rare', "When you drink this potion, you gain a flying speed equal to your walking speed for 1 hour and can hover. If you're in the air when the potion wears off, you fall unless you have some other means of staying aloft. This potion's clear liquid floats at the top of its container and has cloudy white impurities drifting in it."]
    url = '/api/magic-items/potion-of-flying'
class potion_of_gaseous_form():
    ...
    variants = []
    variant = False
    desc = ['Potion, rare', "When you drink this potion, you gain the effect of the gaseous form spell for 1 hour (no concentration required) or until you end the effect as a bonus action. This potion's container seems to hold fog that moves and pours like water."]
    url = '/api/magic-items/potion-of-gaseous-form'
class potion_of_giant_strength_cloud():
    ...
    variants = []
    variant = True
    desc = ['Potion, very rare', 'When you drink this potion, your Strength score changes to 27 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.', "This potion's transparent liquid has floating in it a sliver of fingernail from a cloud giant."]
    url = '/api/magic-items/potion-of-giant-strength-cloud'
class potion_of_giant_strength_fire():
    ...
    variants = []
    variant = True
    desc = ['Potion, rare', 'When you drink this potion, your Strength score changes to 25 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.', "This potion's transparent liquid has floating in it a sliver of fingernail from a fire giant."]
    url = '/api/magic-items/potion-of-giant-strength-fire'
class potion_of_giant_strength_frost():
    ...
    variants = []
    variant = True
    desc = ['Potion, rare', 'When you drink this potion, your Strength score changes to 23 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.', "This potion's transparent liquid has floating in it a sliver of fingernail from a frost giant."]
    url = '/api/magic-items/potion-of-giant-strength-frost'
class potion_of_giant_strength_hill():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, your Strength score changes to 21 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.', "This potion's transparent liquid has floating in it a sliver of fingernail from a hill giant."]
    url = '/api/magic-items/potion-of-giant-strength-hill'
class potion_of_giant_strength_stone():
    ...
    variants = []
    variant = True
    desc = ['Potion, rare', 'When you drink this potion, your Strength score changes to 23 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.', "This potion's transparent liquid has floating in it a sliver of fingernail from a stone giant."]
    url = '/api/magic-items/potion-of-giant-strength-stone'
class potion_of_giant_strength_storm():
    ...
    variants = []
    variant = True
    desc = ['Potion, legendary', 'When you drink this potion, your Strength score changes to 29 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.', "This potion's transparent liquid has floating in it a sliver of fingernail from a storm giant."]
    url = '/api/magic-items/potion-of-giant-strength-storm'
class potion_of_giant_strength():
    index = 'potion-of-giant-strength'
    name = 'Potion of Giant Strength'
    equipment_category = {'index': 'potion', 'name': 'Potion', 'url': '/api/equipment-categories/potion'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'potion-of-giant-strength-hill', 'name': 'Potion of Hill Giant Strength', 'url': '/api/magic-items/potion-of-giant-strength-hill'}, {'index': 'potion-of-giant-strength-frost', 'name': 'Potion of Frost Giant Strength', 'url': '/api/magic-items/potion-of-giant-strength-frost'}, {'index': 'potion-of-giant-strength-stone', 'name': 'Potion of Stone Giant Strength', 'url': '/api/magic-items/potion-of-giant-strength-stone'}, {'index': 'potion-of-giant-strength-fire', 'name': 'Potion of Fire Giant Strength', 'url': '/api/magic-items/potion-of-giant-strength-fire'}, {'index': 'potion-of-giant-strength-cloud', 'name': 'Potion of Cloud Giant Strength', 'url': '/api/magic-items/potion-of-giant-strength-cloud'}, {'index': 'potion-of-giant-strength-storm', 'name': 'Potion of Storm Giant Strength', 'url': '/api/magic-items/potion-of-giant-strength-storm'}]
    variant = False
    desc = ['Potion, varies', 'When you drink this potion, your Strength score changes for 1 hour. The type of giant determines the score (see the table below). The potion has no effect on you if your Strength is equal to or greater than that score.', "This potion's transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type. The potion of frost giant strength and the potion of stone giant strength have the same effect.", '| Type of Giant | Strength | Rarity |', '|---|---|---|', '| Hill giant | 21 | Uncommon |', '| Frost/stone giant | 23 | Rare |', '| Fire giant | 25 | Rare |', '| Cloud giant | 27 | Very rare |', '| Storm giant | 29 | Legendary |']
    url = '/api/magic-items/potion-of-giant-strength'
class potion_of_growth():
    ...
    variants = []
    variant = False
    desc = ['Potion, uncommon', 'When you drink this potion, you gain the "enlarge" effect of the enlarge/reduce spell for 1d4 hours (no concentration required). The red in the potion\'s liquid continuously expands from a tiny bead to color the clear liquid around it and then contracts. Shaking the bottle fails to interrupt this process.']
    url = '/api/magic-items/potion-of-growth'
class potion_of_healing_common():
    ...
    variants = []
    variant = True
    desc = ['Potion, common', "You regain 2d4 + 2 hit points when you drink this potion. The potion's red liquid glimmers when agitated."]
    url = '/api/magic-items/potion-of-healing-common'
class potion_of_healing_greater():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', "You regain 4d4 + 4 hit points when you drink this potion. The potion's red liquid glimmers when agitated."]
    url = '/api/magic-items/potion-of-healing-greater'
class potion_of_healing_superior():
    ...
    variants = []
    variant = True
    desc = ['Potion, rare', "You regain 8d4 + 8 hit points when you drink this potion. The potion's red liquid glimmers when agitated."]
    url = '/api/magic-items/potion-of-healing-superior'
class potion_of_healing_supreme():
    ...
    variants = []
    variant = True
    desc = ['Potion, very rare', "You regain 10d4 + 20 hit points when you drink this potion. The potion's red liquid glimmers when agitated."]
    url = '/api/magic-items/potion-of-healing-supreme'
class potion_of_healing():
    index = 'potion-of-healing'
    name = 'Potion of Healing'
    equipment_category = {'index': 'potion', 'name': 'Potion', 'url': '/api/equipment-categories/potion'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'potion-of-healing-common', 'name': 'Potion of Healing', 'url': '/api/magic-items/potion-of-healing-common'}, {'index': 'potion-of-healing-greater', 'name': 'Potion of Greater Healing', 'url': '/api/magic-items/potion-of-healing-greater'}, {'index': 'potion-of-healing-superior', 'name': 'Potion of Superior Healing', 'url': '/api/magic-items/potion-of-healing-superior'}, {'index': 'potion-of-healing-supreme', 'name': 'Potion of Supreme Healing', 'url': '/api/magic-items/potion-of-healing-supreme'}]
    variant = False
    desc = ['Potion, varies', "You regain hit points when you drink this potion. The number of hit points depends on the potion's rarity, as shown in the Potions of Healing table. Whatever its potency, the potion's red liquid glimmers when agitated.", 'Potions of Healing (table)', '| Potion of ... | Rarity | HP Regained |', '|---|---|---|', '| Healing | Common | 2d4 + 2 |', '| Greater healing | Uncommon | 4d4 + 4 |', '| Superior healing | Rare | 8d4 + 8 |', '| Supreme healing | Very rare | 10d4 + 20 |']
    url = '/api/magic-items/potion-of-healing'
class potion_of_heroism():
    ...
    variants = []
    variant = False
    desc = ['Potion, rare', 'For 1 hour after drinking it, you gain 10 temporary hit points that last for 1 hour. For the same duration, you are under the effect of the bless spell (no concentration required). This blue potion bubbles and steams as if boiling.']
    url = '/api/magic-items/potion-of-heroism'
class potion_of_invisibility():
    ...
    variants = []
    variant = False
    desc = ['Potion, very rare', "This potion's container looks empty but feels as though it holds liquid. When you drink it, you become invisible for 1 hour. Anything you wear or carry is invisible with you. The effect ends early if you attack or cast a spell."]
    url = '/api/magic-items/potion-of-invisibility'
class potion_of_mind_reading():
    ...
    variants = []
    variant = False
    desc = ['Potion, rare', "When you drink this potion, you gain the effect of the detect thoughts spell (save DC 13). The potion's dense, purple liquid has an ovoid cloud of pink floating in it."]
...
class potion_of_poison():
    ...
    variants = []
    variant = False
    desc = ['Potion, uncommon', 'This concoction looks, smells, and tastes like a potion of healing or other beneficial potion. However, it is actually poison masked by illusion magic. An identify spell reveals its true nature.', 'If you drink it, you take 3d6 poison damage, and you must succeed on a DC 13 Constitution saving throw or be poisoned. At the start of each of your turns while you are poisoned in this way, you take 3d6 poison damage. At the end of each of your turns, you can repeat the saving throw. On a successful save, the poison damage you take on your subsequent turns decreases by 1d6. The poison ends when the damage decreases to 0.']
    url = '/api/magic-items/potion-of-poison'
class potion_of_resistance_acid():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to acid damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-acid'
class potion_of_resistance_cold():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to cold damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-cold'
class potion_of_resistance_fire():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to fire damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-fire'
class potion_of_resistance_force():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to force damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-force'
class potion_of_resistance_lightning():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to lightning damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-lightning'
class potion_of_resistance_necrotic():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to necrotic damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-necrotic'
class potion_of_resistance_poison():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to poison damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-poison'
class potion_of_resistance_psychic():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to psychic damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-psychic'
class potion_of_resistance_radiant():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to radiant damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-radiant'
class potion_of_resistance_thunder():
    ...
    variants = []
    variant = True
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to thunder damage for 1 hour.']
    url = '/api/magic-items/potion-of-resistance-thunder'
class potion_of_resistance():
    index = 'potion-of-resistance'
    name = 'Potion of Resistance'
    equipment_category = {'index': 'potion', 'name': 'Potion', 'url': '/api/equipment-categories/potion'}
    rarity = {'name': 'Uncommon'}
    variants = [{'index': 'potion-of-resistance-acid', 'name': 'Potion of Acid Resistance', 'url': '/api/magic-items/potion-of-resistance-acid'}, {'index': 'potion-of-resistance-cold', 'name': 'Potion of Cold Resistance', 'url': '/api/magic-items/potion-of-resistance-cold'}, {'index': 'potion-of-resistance-fire', 'name': 'Potion of Fire Resistance', 'url': '/api/magic-items/potion-of-resistance-fire'}, {'index': 'potion-of-resistance-force', 'name': 'Potion of Force Resistance', 'url': '/api/magic-items/potion-of-resistance-force'}, {'index': 'potion-of-resistance-lightning', 'name': 'Potion of Lightning Resistance', 'url': '/api/magic-items/potion-of-resistance-lightning'}, {'index': 'potion-of-resistance-necrotic', 'name': 'Potion of Necrotic Resistance', 'url': '/api/magic-items/potion-of-resistance-necrotic'}, {'index': 'potion-of-resistance-poison', 'name': 'Potion of Poison Resistance', 'url': '/api/magic-items/potion-of-resistance-poison'}, {'index': 'potion-of-resistance-psychic', 'name': 'Potion of Psychic Resistance', 'url': '/api/magic-items/potion-of-resistance-psychic'}, {'index': 'potion-of-resistance-radiant', 'name': 'Potion of Radiant Resistance', 'url': '/api/magic-items/potion-of-resistance-radiant'}, {'index': 'potion-of-resistance-thunder', 'name': 'Potion of Thunder Resistance', 'url': '/api/magic-items/potion-of-resistance-thunder'}]
    variant = False
    desc = ['Potion, uncommon', 'When you drink this potion, you gain resistance to one type of damage for 1 hour. The GM chooses the type or determines it randomly from the options below.', '| d10 | Damage Type |', '|---|---|', '| 1 | Acid |', '| 2 | Cold |', '| 3 | Fire |', '| 4 | Force |', '| 5 | Lightning |', '| 6 | Necrotic |', '| 7 | Poison |', '| 8 | Psychic |', '| 9 | Radiant |', '| 10 | Thunder |']
    url = '/api/magic-items/potion-of-resistance'
class potion_of_speed():
    ...
    variants = []
    variant = False
    desc = ['Potion, very rare', "When you drink this potion, you gain the effect of the haste spell for 1 minute (no concentration required). The potion's yellow fluid is streaked with black and swirls on its own."]
    url = '/api/magic-items/potion-of-speed'
class potion_of_water_breathing():
    ...
    variants = []
    variant = False
    desc = ['Potion, uncommon', 'You can breathe underwater for 1 hour after drinking this potion. Its cloudy green fluid smells of the sea and has a jellyfish-like bubble floating in it.']
    url = '/api/magic-items/potion-of-water-breathing'
class restorative_ointment():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', 'This glass jar, 3 inches in diameter, contains 1d4 + 1 doses of a thick mixture that smells faintly of aloe. The jar and its contents weigh 1/2 pound.', 'As an action, one dose of the ointment can be swallowed or applied to the skin. The creature that receives it regains 2d8 + 2 hit points, ceases to be poisoned, and is cured of any disease.']
    url = '/api/magic-items/restorative-ointment'
class ring_of_animal_influence():
    index = 'ring-of-animal-influence'
    name = 'Ring of Animal Influence'
    equipment_category = {'index': 'ring', 'name': 'Ring', 'url': '/api/equipment-categories/ring'}
    rarity = {'name': 'Rare'}
    variants = []
    variant = False
    desc = ['Ring, rare', 'This ring has 3 charges, and it regains 1d3 expended charges daily at dawn. While wearing the ring, you can use an action to expend 1 of its charges to cast one of the following spells:', 'Animal friendship (save DC 13)', 'Fear (save DC 13), targeting only beasts that have an Intelligence of 3 or lower', 'Speak with animals']
    url = '/api/magic-items/ring-of-animal-influence'
class ring_of_djinni_summoning():
...
class ring_of_evasion():
    ...
    variants = []
    variant = False
    desc = ['Ring, rare (requires attunement)', 'This ring has 3 charges, and it regains 1d3 expended charges daily at dawn. When you fail a Dexterity saving throw while wearing it, you can use your reaction to expend 1 of its charges to succeed on that saving throw instead.']
    url = '/api/magic-items/ring-of-evasion'
class ring_of_feather_falling():
    ...
    variants = []
    variant = False
    desc = ['Ring, rare (requires attunement)', 'When you fall while wearing this ring, you descend 60 feet per round and take no damage from falling.']
    url = '/api/magic-items/ring-of-feather-falling'
class ring_of_free_action():
    ...
    variants = []
    variant = False
    desc = ['Ring, rare (requires attunement)', "While you wear this ring, difficult terrain doesn't cost you extra movement. In addition, magic can neither reduce your speed nor cause you to be paralyzed or restrained."]
    url = '/api/magic-items/ring-of-free-action'
class ring_of_invisibility():
    ...
    variants = []
    variant = False
    desc = ['Ring, legendary (requires attunement)', 'While wearing this ring, you can turn invisible as an action. Anything you are wearing or carrying is invisible with you. You remain invisible until the ring is removed, until you attack or cast a spell, or until you use a bonus action to become visible again.']
    url = '/api/magic-items/ring-of-invisibility'
class ring_of_jumping():
    ...
    variants = []
    variant = False
    desc = ['Ring, uncommon (requires attunement)', 'While wearing this ring, you can cast the jump spell from it as a bonus action at will, but can target only yourself when you do so.']
    url = '/api/magic-items/ring-of-jumping'
class ring_of_mind_shielding():
    ...
    variants = []
    variant = False
    desc = ['Ring, uncommon (requires attunement)', 'While wearing this ring, you are immune to magic that allows other creatures to read your thoughts, determine whether you are lying, know your alignment, or know your creature type. Creatures can telepathically communicate with you only if you allow it.', 'You can use an action to cause the ring to become invisible until you use another action to make it visible, until you remove the ring, or until you die.', "If you die while wearing the ring, your soul enters it, unless it already houses a soul. You can remain in the ring or depart for the afterlife. As long as your soul is in the ring, you can telepathically communicate with any creature wearing it. A wearer can't prevent this telepathic communication."]
    url = '/api/magic-items/ring-of-mind-shielding'
class ring_of_protection():
    ...
    variants = []
    variant = False
    desc = ['Ring, rare (requires attunement)', 'You gain a +1 bonus to AC and saving throws while wearing this ring.']
    url = '/api/magic-items/ring-of-protection'
class ring_of_regeneration():
    ...
    variants = []
    variant = False
    desc = ['Ring, very rare (requires attunement)', 'While wearing this ring, you regain 1d6 hit points every 10 minutes, provided that you have at least 1 hit point. If you lose a body part, the ring causes the missing part to regrow and return to full functionality after 1d6 + 1 days if you have at least 1 hit point the whole time.']
    url = '/api/magic-items/ring-of-regeneration'
class ring_of_resistance_acid():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to acid damage while wearing this pearl ring.']
    url = '/api/magic-items/ring-of-resistance-acid'
class ring_of_resistance_cold():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to cold damage while wearing this tourmaline ring.']
    url = '/api/magic-items/ring-of-resistance-cold'
class ring_of_resistance_fire():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to fire damage while wearing this garnet ring.']
    url = '/api/magic-items/ring-of-resistance-fire'
class ring_of_resistance_force():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to force damage while wearing this sapphire ring.']
    url = '/api/magic-items/ring-of-resistance-force'
class ring_of_resistance_lightning():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to lightning damage while wearing this citrine ring.']
    url = '/api/magic-items/ring-of-resistance-lightning'
class ring_of_resistance_necrotic():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to necrotic damage while wearing this jet ring.']
    url = '/api/magic-items/ring-of-resistance-necrotic'
class ring_of_resistance_poison():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to poison damage while wearing this amethyst ring.']
    url = '/api/magic-items/ring-of-resistance-poison'
class ring_of_resistance_psychic():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to psychic damage while wearing this jade ring.']
    url = '/api/magic-items/ring-of-resistance-psychic'
class ring_of_resistance_radiant():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to radiant damage while wearing this topaz ring.']
    url = '/api/magic-items/ring-of-resistance-radiant'
class ring_of_resistance_thunder():
    ...
    variants = []
    variant = True
    desc = ['Ring, rare (requires attunement)', 'You have resistance to thunder damage while wearing this spinel ring.']
    url = '/api/magic-items/ring-of-resistance-thunder'
class ring_of_resistance():
    index = 'ring-of-resistance'
    name = 'Ring of Resistance'
    equipment_category = {'index': 'ring', 'name': 'Ring', 'url': '/api/equipment-categories/ring'}
    rarity = {'name': 'Rare'}
    variants = [{'index': 'ring-of-resistance-acid', 'name': 'Ring of Acid Resistance', 'url': '/api/magic-items/ring-of-resistance-acid'}, {'index': 'ring-of-resistance-cold', 'name': 'Ring of Cold Resistance', 'url': '/api/magic-items/ring-of-resistance-cold'}, {'index': 'ring-of-resistance-fire', 'name': 'Ring of Fire Resistance', 'url': '/api/magic-items/ring-of-resistance-fire'}, {'index': 'ring-of-resistance-force', 'name': 'Ring of Force Resistance', 'url': '/api/magic-items/ring-of-resistance-force'}, {'index': 'ring-of-resistance-lightning', 'name': 'Ring of Lightning Resistance', 'url': '/api/magic-items/ring-of-resistance-lightning'}, {'index': 'ring-of-resistance-necrotic', 'name': 'Ring of Necrotic Resistance', 'url': '/api/magic-items/ring-of-resistance-necrotic'}, {'index': 'ring-of-resistance-poison', 'name': 'Ring of Poison Resistance', 'url': '/api/magic-items/ring-of-resistance-poison'}, {'index': 'ring-of-resistance-psychic', 'name': 'Ring of Psychic Resistance', 'url': '/api/magic-items/ring-of-resistance-psychic'}, {'index': 'ring-of-resistance-radiant', 'name': 'Ring of Radiant Resistance', 'url': '/api/magic-items/ring-of-resistance-radiant'}, {'index': 'ring-of-resistance-thunder', 'name': 'Ring of Thunder Resistance', 'url': '/api/magic-items/ring-of-resistance-thunder'}]
    variant = False
    desc = ['Ring, rare (requires attunement)', 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type, which the GM chooses or determines randomly.', '| d10 | Damage Type | Gem |', '|---|---|---|', '| 1 | Acid | Pearl |', '| 2 | Cold | Tourmaline |', '| 3 | Fire | Garnet |', '| 4 | Force | Sapphire |', '| 5 | Lightning | Citrine |', '| 6 | Necrotic | Jet |', '| 7 | Poison | Amethyst |', '| 8 | Psychic | Jade |', '| 9 | Radiant | Topaz |', '| 10 | Thunder | Spinel |']
    url = '/api/magic-items/ring-of-resistance'
class ring_of_shooting_stars():
...
class ring_of_spell_turning():
    ...
    variants = []
    variant = False
    desc = ['Ring, legendary (requires attunement)', 'While wearing this ring, you have advantage on saving throws against any spell that targets only you (not in an area of effect). In addition, if you roll a 20 for the save and the spell is 7th level or lower, the spell has no effect on you and instead targets the caster, using the slot level, spell save DC, attack bonus, and spellcasting ability of the caster.']
    url = '/api/magic-items/ring-of-spell-turning'
class ring_of_swimming():
...
class ring_of_telekinesis():
    ...
    variants = []
    variant = False
    desc = ['Ring, very rare (requires attunement)', "While wearing this ring, you can cast the telekinesis spell at will, but you can target only objects that aren't being worn or carried."]
    url = '/api/magic-items/ring-of-telekinesis'
class ring_of_the_ram():
...
class ring_of_three_wishes():
    ...
    variants = []
    variant = False
    desc = ['Ring, legendary', 'While wearing this ring, you can use an action to expend 1 of its 3 charges to cast the wish spell from it. The ring becomes nonmagical when you use the last charge.']
    url = '/api/magic-items/ring-of-three-wishes'
class ring_of_warmth():
    ...
    variants = []
    variant = False
    desc = ['Ring, uncommon (requires attunement)', 'While wearing this ring, you have resistance to cold damage. In addition, you and everything you wear and carry are unharmed by temperatures as low as -50 degrees Fahrenheit.']
    url = '/api/magic-items/ring-of-warmth'
class ring_of_water_walking():
    ...
    variants = []
    variant = False
    desc = ['Ring, uncommon', 'While wearing this ring, you can stand on and move across any liquid surface as if it were solid ground.']
    url = '/api/magic-items/ring-of-water-walking'
class ring_of_x_ray_vision():
...
class rod_of_rulership():
    ...
    variants = []
    variant = False
    desc = ['Rod, rare (requires attunement)', "You can use an action to present the rod and command obedience from each creature of your choice that you can see within 120 feet of you. Each target must succeed on a DC 15 Wisdom saving throw or be charmed by you for 8 hours. While charmed in this way, the creature regards you as its trusted leader. If harmed by you or your companions, or commanded to do something contrary to its nature, a target ceases to be charmed in this way. The rod can't be used again until the next dawn."]
    url = '/api/magic-items/rod-of-rulership'
class rod_of_security():
...
class scarab_of_protection():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, legendary (requires attunement)', 'If you hold this beetle-shaped medallion in your hand for 1 round, an inscription appears on its surface revealing its magical nature. It provides two benefits while it is on your person:', 'You have advantage on saving throws against spells.', 'The scarab has 12 charges. If you fail a saving throw against a necromancy spell or a harmful effect originating from an undead creature, you can use your reaction to expend 1 charge and turn the failed save into a successful one. The scarab crumbles into powder and is destroyed when its last charge is expended.']
    url = '/api/magic-items/scarab-of-protection'
class scimitar_of_speed():
    ...
    variants = []
    variant = False
    desc = ['Weapon (scimitar), very rare (requires attunement)', 'You gain a +2 bonus to attack and damage rolls made with this magic weapon. In addition, you can make one attack with it as a bonus action on each of your turns.']
    url = '/api/magic-items/scimitar-of-speed'
class shield_of_missile_attraction():
    ...
    variants = []
    variant = False
    desc = ['Armor (shield), rare (requires attunement)', 'While holding this shield, you have resistance to damage from ranged weapon attacks.', '***Curse.*** This shield is cursed. Attuning to it curses you until you are targeted by the remove curse spell or similar magic. Removing the shield fails to end the curse on you. Whenever a ranged weapon attack is made against a target within 10 feet of you, the curse causes you to become the target instead.']
    url = '/api/magic-items/shield-of-missile-attraction'
class slippers_of_spider_climbing():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', "While you wear these light shoes, you can move up, down, and across vertical surfaces and upside down along ceilings, while leaving your hands free. You have a climbing speed equal to your walking speed. However, the slippers don't allow you to move this way on a slippery surface, such as one covered by ice or oil."]
    url = '/api/magic-items/slippers-of-spider-climbing'
class sovereign_glue():
...
class spell_scroll():
    ...
    equipment_category = {'index': 'scroll', 'name': 'Scroll', 'url': '/api/equipment-categories/scroll'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'spell-scroll-cantrip', 'name': 'Spell Scroll (Cantrip)', 'url': '/api/magic-items/spell-scroll-cantrip'}, {'index': 'spell-scroll-1st', 'name': 'Spell Scroll (1st)', 'url': '/api/magic-items/spell-scroll-1st'}, {'index': 'spell-scroll-2nd', 'name': 'Spell Scroll (2nd)', 'url': '/api/magic-items/spell-scroll-2nd'}, {'index': 'spell-scroll-3rd', 'name': 'Spell Scroll (3rd)', 'url': '/api/magic-items/spell-scroll-3rd'}, {'index': 'spell-scroll-4th', 'name': 'Spell Scroll (4th)', 'url': '/api/magic-items/spell-scroll-4th'}, {'index': 'spell-scroll-5th', 'name': 'Spell Scroll (5th)', 'url': '/api/magic-items/spell-scroll-5th'}, {'index': 'spell-scroll-6th', 'name': 'Spell Scroll (6th)', 'url': '/api/magic-items/spell-scroll-6th'}, {'index': 'spell-scroll-7th', 'name': 'Spell Scroll (7th)', 'url': '/api/magic-items/spell-scroll-7th'}, {'index': 'spell-scroll-8th', 'name': 'Spell Scroll (8th)', 'url': '/api/magic-items/spell-scroll-8th'}, {'index': 'spell-scroll-9th', 'name': 'Spell Scroll (9th)', 'url': '/api/magic-items/spell-scroll-9th'}]
    variant = False
    desc = ['Scroll, varies', "A spell scroll bears the words of a single spell, written in a mystical cipher. If the spell is on your class's spell list, you can read the scroll and cast its spell without providing any material components. Otherwise, the scroll is unintelligible. Casting the spell by reading the scroll requires the spell's normal casting time. Once the spell is cast, the words on the scroll fade, and it crumbles to dust. If the casting is uninterrupted, the scroll is not lost.", "If the spell is on your class's spell list but of a higher level than you can normally cast, you must make an ability check using your spellcasting ability to determine whether you cast it successfully. The DC equals 10 + the spell's level. On a failed check, the spell disappears from the scroll with no other effect.", "The level of the spell on the scroll determines the spell's saving throw DC and attack bonus, as well as the scroll's rarity, as shown in the Spell Scroll table.", 'Spell Scroll (table)', '| Spell Level | Rarity | Save DC | Attack Bonus |', '|---|---|---|---|', '| Cantrip | Common | 13 | +5 |', '| 1st | Common | 13 | +5 |', '| 2nd | Uncommon | 13 | +5 |', '| 3rd | Uncommon | 15 | +7 |', '| 4th | Rare | 15 | +7 |', '| 5th | Rare | 17 | +9 |', '| 6th | Very rare | 17 | +9 |', '| 7th | Very rare | 18 | +10 |', '| 8th | Very rare | 18 | +10 |', '| 9th | Legendary | 19 | +11 |', "A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When a spell is copied from a spell scroll, the copier must succeed on an Intelligence (Arcana) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed."]
    url = '/api/magic-items/spell-scroll'
class spellguard_shield():
    ...
    variants = []
    variant = False
    desc = ['Armor (shield), very rare (requires attunement)', 'While holding this shield, you have advantage on saving throws against spells and other magical effects, and spell attacks have disadvantage against you.']
    url = '/api/magic-items/spellguard-shield'
class sphere_of_annihilation():
...
class staff_of_healing():
    ...
    variants = []
    variant = False
    desc = ['Staff, rare (requires attunement by a bard, cleric, or druid)', 'This staff has 10 charges. While holding it, you can use an action to expend 1 or more of its charges to cast one of the following spells from it, using your spell save DC and spellcasting ability modifier: cure wounds (1 charge per spell level, up to 4th), lesser restoration (2 charges), or mass cure wounds (5 charges).', 'The staff regains 1d6 + 4 expended charges daily at dawn. If you expend the last charge, roll a d20. On a 1, the staff vanishes in a flash of light, lost forever.']
    url = '/api/magic-items/staff-of-healing'
class staff_of_power():
...
class staff_of_striking():
    ...
    variants = []
    variant = False
    desc = ['Staff, very rare (requires attunement)', 'This staff can be wielded as a magic quarterstaff that grants a +3 bonus to attack and damage rolls made with it.', 'The staff has 10 charges. When you hit with a melee attack using it, you can expend up to 3 of its charges. For each charge you expend, the target takes an extra 1d6 force damage. The staff regains 1d6 + 4 expended charges daily at dawn. If you expend the last charge, roll a d20. On a 1, the staff becomes a nonmagical quarterstaff.']
    url = '/api/magic-items/staff-of-striking'
class staff_of_swarming_insects():
...
class staff_of_withering():
    ...
    variants = []
    variant = False
    desc = ['Staff, rare (requires attunement by a cleric, druid, or warlock)', 'This staff has 3 charges and regains 1d3 expended charges daily at dawn.', 'The staff can be wielded as a magic quarterstaff. On a hit, it deals damage as a normal quarterstaff, and you can expend 1 charge to deal an extra 2d10 necrotic damage to the target. In addition, the target must succeed on a DC 15 Constitution saving throw or have disadvantage for 1 hour on any ability check or saving throw that uses Strength or Constitution.']
    url = '/api/magic-items/staff-of-withering'
class stone_of_controlling_earth_elementals():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare', "If the stone is touching the ground, you can use an action to speak its command word and summon an earth elemental, as if you had cast the conjure elemental spell. The stone can't be used this way again until the next dawn. The stone weighs 5 pounds."]
    url = '/api/magic-items/stone-of-controlling-earth-elementals'
class stone_of_good_luck_luckstone():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon (requires attunement)', 'While this polished agate is on your person, you gain a +1 bonus to ability checks and saving throws.']
...
class sun_blade():
    ...
    variants = []
    variant = False
    desc = ['Weapon (longsword), rare (requires attunement)', 'This item appears to be a longsword hilt. While grasping the hilt, you can use a bonus action to cause a blade of pure radiance to spring into existence, or make the blade disappear. While the blade exists, this magic longsword has the finesse property. If you are proficient with shortswords or longswords, you are proficient with the sun blade.', 'You gain a +2 bonus to attack and damage rolls made with this weapon, which deals radiant damage instead of slashing damage. When you hit an undead with it, that target takes an extra 1d8 radiant damage.', "The sword's luminous blade emits bright light in a 15-foot radius and dim light for an additional 15 feet. The light is sunlight. While the blade persists, you can use an action to expand or reduce its radius of bright and dim light by 5 feet each, to a maximum of 30 feet each or a minimum of 10 feet each."]
    url = '/api/magic-items/sun-blade'
class sword_of_life_stealing():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any sword), rare (requires attunement)', "When you attack a creature with this magic weapon and roll a 20 on the attack roll, that target takes an extra 3d6 necrotic damage, provided that the target isn't a construct or an undead. You gain temporary hit points equal to the extra damage dealt."]
    url = '/api/magic-items/sword-of-life-stealing'
class sword_of_sharpness():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any sword that deals slashing damage), very rare (requires attunement)', 'When you attack an object with this magic sword and hit, maximize your weapon damage dice against the target.', "When you attack a creature with this weapon and roll a 20 on the attack roll, that target takes an extra 4d6 slashing damage. Then roll another d20. If you roll a 20, you lop off one of the target's limbs, with the effect of such loss determined by the GM. If the creature has no limb to sever, you lop off a portion of its body instead.", "In addition, you can speak the sword's command word to cause the blade to shed bright light in a 10 foot radius and dim light for an additional 10 feet. Speaking the command word again or sheathing the sword puts out the light."]
    url = '/api/magic-items/sword-of-sharpness'
class sword_of_wounding():
...
class talisman_of_the_sphere():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, legendary (requires attunement)', 'When you make an Intelligence (Arcana) check to control a sphere of annihilation while you are holding this talisman, you double your proficiency bonus on the check. In addition, when you start your turn with control over a sphere of annihilation, you can use an action to levitate it 10 feet plus a number of additional feet equal to 10 × your Intelligence modifier.']
    url = '/api/magic-items/talisman-of-the-sphere'
class talisman_of_ultimate_evil():
...
class tome_of_clear_thought():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, very rare', "This book contains memory and logic exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Intelligence score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century."]
    url = '/api/magic-items/tome-of-clear-thought'
class tome_of_leadership_and_influence():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, very rare', "This book contains guidelines for influencing and charming others, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Charisma score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century."]
    url = '/api/magic-items/tome-of-leadership-and-influence'
class tome_of_understanding():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, very rare', "This book contains intuition and insight exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Wisdom score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century."]
    url = '/api/magic-items/tome-of-understanding'
class trident_of_fish_command():
    ...
    variants = []
    variant = False
    desc = ['Weapon (trident), uncommon (requires attunement)', 'This trident is a magic weapon. It has 3 charges. While you carry it, you can use an action and expend 1 charge to cast dominate beast (save DC 15) from it on a beast that has an innate swimming speed. The trident regains 1d3 expended charges daily at dawn.']
    url = '/api/magic-items/trident-of-fish-command'
class universal_solvent():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, legendary', 'This tube holds milky liquid with a strong alcohol smell. You can use an action to pour the contents of the tube onto a surface within reach. The liquid instantly dissolves up to 1 square foot of adhesive it touches, including sovereign glue.']
    url = '/api/magic-items/universal-solvent'
class vicious_weapon():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any), rare', "When you roll a 20 on your attack roll with this magic weapon, your critical hit deals an extra 2d6 damage of the weapon's type."]
...
class vorpal_sword():
    ...
    variants = []
    variant = False
    desc = ['Weapon (any sword that deals slashing damage), legendary (requires attunement)', 'You gain a +3 bonus to attack and damage rolls made with this magic weapon. In addition, the weapon ignores resistance to slashing damage.', "When you attack a creature that has at least one head with this weapon and roll a 20 on the attack roll, you cut off one of the creature's heads. The creature dies if it can't survive without the lost head. A creature is immune to this effect if it is immune to slashing damage, doesn't have or need a head, has legendary actions, or the GM decides that the creature is too big for its head to be cut off with this weapon. Such a creature instead takes an extra 6d8 slashing damage from the hit."]
    url = '/api/magic-items/vorpal-sword'
class wand_of_binding():
    index = 'wand-of-binding'
    name = 'Wand of Binding'
    equipment_category = {'index': 'wand', 'name': 'Wand', 'url': '/api/equipment-categories/wand'}
    rarity = {'name': 'Rare'}
    variants = []
    variant = False
    desc = ['Wand, rare (requires attunement by a spellcaster)', "This wand has 7 charges for the following properties. It regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed.", '***Spells.*** While holding the wand, you can use an action to expend some of its charges to cast one of the following spells (save DC 17): hold monster (5 charges) or hold person (2 charges).', '***Assisted Escape.*** While holding the wand, you can use your reaction to expend 1 charge and gain advantage on a saving throw you make to avoid being paralyzed or restrained, or you can expend 1 charge and gain advantage on any check you make to escape a grapple.']
    url = '/api/magic-items/wand-of-binding'
class wand_of_enemy_detection():
...
class wand_of_fireballs():
    ...
    variants = []
    variant = False
    desc = ['Wand, rare (requires attunement by a spellcaster)', 'This wand has 7 charges. While holding it, you can use an action to expend 1 or more of its charges to cast the fireball spell (save DC 15) from it. For 1 charge, you cast the 3rd-level version of the spell. You can increase the spell slot level by one for each additional charge you expend.', "The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed."]
    url = '/api/magic-items/wand-of-fireballs'
class wand_of_lightning_bolts():
    ...
    variants = []
    variant = False
    desc = ['Wand, rare (requires attunement by a spellcaster)', 'This wand has 7 charges. While holding it, you can use an action to expend 1 or more of its charges to cast the lightning bolt spell (save DC 15) from it. For 1 charge, you cast the 3rd-level version of the spell. You can increase the spell slot level by one for each additional charge you expend.', "The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed."]
    url = '/api/magic-items/wand-of-lightning-bolts'
class wand_of_magic_detection():
    ...
    variants = []
    variant = False
    desc = ['Wand, uncommon', 'This wand has 3 charges. While holding it, you can expend 1 charge as an action to cast the detect magic spell from it. The wand regains 1d3 expended charges daily at dawn.']
    url = '/api/magic-items/wand-of-magic-detection'
class wand_of_magic_missiles():
    ...
    variants = []
    variant = False
    desc = ['Wand, uncommon', 'This wand has 7 charges. While holding it, you can use an action to expend 1 or more of its charges to cast the magic missile spell from it. For 1 charge, you cast the 1st-level version of the spell. You can increase the spell slot level by one for each additional charge you expend.', "The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed."]
    url = '/api/magic-items/wand-of-magic-missiles'
class wand_of_paralysis():
    ...
    variants = []
    variant = False
    desc = ['Wand, rare (requires attunement by a spellcaster)', "This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cause a thin blue ray to streak from the tip toward a creature you can see within 60 feet of you. The target must succeed on a DC 15 Constitution saving throw or be paralyzed for 1 minute. At the end of each of the target's turns, it can repeat the saving throw, ending the effect on itself on a success.", "The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed."]
    url = '/api/magic-items/wand-of-paralysis'
class wand_of_polymorph():
    ...
    variants = []
    variant = False
    desc = ['Wand, very rare (requires attunement by a spellcaster)', 'This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the polymorph spell (save DC 15) from it.', "The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed."]
    url = '/api/magic-items/wand-of-polymorph'
class wand_of_secrets():
    ...
    variants = []
    variant = False
    desc = ['Wand, uncommon', 'The wand has 3 charges. While holding it, you can use an action to expend 1 of its charges, and if a secret door or trap is within 30 feet of you, the wand pulses and points at the one nearest to you. The wand regains 1d3 expended charges daily at dawn.']
    url = '/api/magic-items/wand-of-secrets'
class wand_of_the_war_mage_1():
    ...
    variants = []
    variant = True
    desc = ['Wand, uncommon (requires attunement by a spellcaster)', 'While holding this wand, you gain a +1 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.']
    url = '/api/magic-items/wand-of-the-war-mage-1'
class wand_of_the_war_mage_2():
    ...
    variants = []
    variant = True
    desc = ['Wand, rare (requires attunement by a spellcaster)', 'While holding this wand, you gain a +2 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.']
    url = '/api/magic-items/wand-of-the-war-mage-2'
class wand_of_the_war_mage_3():
    ...
    variants = []
    variant = True
    desc = ['Wand, very rare (requires attunement by a spellcaster)', 'While holding this wand, you gain a +3 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.']
    url = '/api/magic-items/wand-of-the-war-mage-3'
class wand_of_the_war_mage():
    index = 'wand-of-the-war-mage'
    name = 'Wand of the War Mage, +1, +2, or +3'
    equipment_category = {'index': 'wand', 'name': 'Wand', 'url': '/api/equipment-categories/wand'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'wand-of-the-war-mage-1', 'name': 'Wand of the War Mage, +1', 'url': '/api/magic-items/wand-of-the-war-mage-1'}, {'index': 'wand-of-the-war-mage-2', 'name': 'Wand of the War Mage, +2', 'url': '/api/magic-items/wand-of-the-war-mage-2'}, {'index': 'wand-of-the-war-mage-3', 'name': 'Wand of the War Mage, +3', 'url': '/api/magic-items/wand-of-the-war-mage-3'}]
    variant = False
    desc = ['Wand, uncommon (+1), rare (+2), or very rare (+3) (requires attunement by a spellcaster)', "While holding this wand, you gain a bonus to spell attack rolls determined by the wand's rarity. In addition, you ignore half cover when making a spell attack."]
...
class wand_of_web():
    ...
    variants = []
    variant = False
    desc = ['Wand, uncommon (requires attunement by a spellcaster)', 'This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the web spell (save DC 15) from it.', "The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed."]
    url = '/api/magic-items/wand-of-web'
class wand_of_wonder():
...
class weapon_1():
    ...
    variants = []
    variant = True
    desc = ['Weapon (any), uncommon', 'You have a +1 bonus to attack and damage rolls made with this magic weapon.']
...
class weapon_2():
    ...
    variants = []
    variant = True
    desc = ['Weapon (any), rare', 'You have a +2 bonus to attack and damage rolls made with this magic weapon.']
...
class weapon_3():
    ...
    variants = []
    variant = True
    desc = ['Weapon (any), very rare', 'You have a +3 bonus to attack and damage rolls made with this magic weapon.']
...
class weapon():
    ...
    equipment_category = {'index': 'weapon', 'name': 'Weapon', 'url': '/api/equipment-categories/weapon'}
    rarity = {'name': 'Varies'}
    variants = [{'index': 'weapon-1', 'name': 'Weapon, +1', 'url': '/api/magic-items/weapon-1'}, {'index': 'weapon-2', 'name': 'Weapon, +2', 'url': '/api/magic-items/weapon-2'}, {'index': 'weapon-3', 'name': 'Weapon, +3', 'url': '/api/magic-items/weapon-3'}]
    variant = False
    desc = ['Weapon (any), uncommon (+1), rare (+2), or very rare (+3)', "You have a bonus to attack and damage rolls made with this magic weapon. The bonus is determined by the weapon's rarity."]
    url = '/api/magic-items/weapon'
class well_of_many_worlds():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, legendary', 'This fine black cloth, soft as silk, is folded up to the dimensions of a handkerchief. It unfolds into a circular sheet 6 feet in diameter.', "You can use an action to unfold and place the well of many worlds on a solid surface, whereupon it creates a two-way portal to another world or plane of existence. Each time the item opens a portal, the GM decides where it leads. You can use an action to close an open portal by taking hold of the edges of the cloth and folding it up. Once well of many worlds has opened a portal, it can't do so again for 1d8 hours."]
...
class wind_fan():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, uncommon', "While holding this fan, you can use an action to cast the gust of wind spell (save DC 13) from it. Once used, the fan shouldn't be used again until the next dawn. Each time it is used again before then, it has a cumulative 20 percent chance of not working and tearing into useless, nonmagical tatters."]
...
class wings_of_flying():
    ...
    variants = []
    variant = False
    desc = ['Wondrous item, rare (requires attunement)', "While wearing this cloak, you can use an action to speak its command word. This turns the cloak into a pair of bat wings or bird wings on your back for 1 hour or until you repeat the command word as an action. The wings give you a flying speed of 60 feet. When they disappear, you can't use them again for 1d12 hours."]
